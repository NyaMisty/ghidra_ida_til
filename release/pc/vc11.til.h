#define GHIDRA
#ifndef INCLUDE_GUARD_vc11_til
#define INCLUDE_GUARD_vc11_til
...
enum MACRO_INT_FAST16 {INT_FAST16_MIN = -2147483648,INT_FAST32_MIN = -2147483648,INT_FAST64_MIN = -9223372036854775808,INT_FAST16_MAX = 2147483647,INT_FAST32_MAX = 2147483647,INT_FAST64_MAX = 9223372036854775807,};
...
enum MACRO_ULONG {ULONG_MAX = 0xFFFFFFFFFFFFFFFF,LLONG_MAX = 0x7FFFFFFFFFFFFFFF,};
...
enum MACRO__UI64 {_UI64_MAX = 0xFFFFFFFFFFFFFFFF,RSIZE_MAX = 0x7FFFFFFFFFFFFFFF,};
...
enum MACRO_INT {INT_LEAST32_MIN = -2147483648,INT_LEAST64_MIN = -9223372036854775808,INT_LEAST32_MAX = 2147483647,INT_LEAST64_MAX = 9223372036854775807,};
enum MACRO_MAX {INT32_MAX = 2147483647,INT64_MAX = 9223372036854775807,UINT32_MAX = -1,UINT64_MAX = -1,};
enum MACRO_MCW {MCW_EM = 524319,};
enum MACRO_MIN {INT32_MIN = -2147483648,INT64_MIN = -9223372036854775808,};
