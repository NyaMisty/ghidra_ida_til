#define GHIDRA
#ifndef INCLUDE_GUARD_bcb4win_til
#define INCLUDE_GUARD_bcb4win_til
...
struct tagVARIANT_______tagVARIANT___8CBA3EFFFCF6218F3F43B45A8ED6FC2D____tagBRECORD;
...
union _MEMORY_BASIC_INFORMATION_VLM___199B4FE6F20B709B42D974D5EBADF5DA;
union _MEMORY_BASIC_INFORMATION_VLM___367D50FA44A4E18B63B07CC3F3BD13BF;
union tagVARIANT_______tagVARIANT___8CBA3EFFFCF6218F3F43B45A8ED6FC2D;
...
struct _IMAGE_CRUNTIME_FUNCTION_ENTRY;
...
typedef struct _IMAGE_CRUNTIME_FUNCTION_ENTRY *PIMAGE_CRUNTIME_FUNCTION_ENTRY;
...
struct _IMAGE_CRUNTIME_FUNCTION_ENTRY {unsigned __int32 FuncStart : 32;unsigned __int32 PrologLen : 8;unsigned __int32 FuncLen : 23;unsigned __int32 ExceptionFlag : 1;};
...
typedef struct _IMAGE_CRUNTIME_FUNCTION_ENTRY IMAGE_CRUNTIME_FUNCTION_ENTRY;
...
enum MACRO_SECURITY_DESCRIPTOR {SECURITY_DESCRIPTOR_REVISION = 1,SECURITY_DESCRIPTOR_REVISION1 = 1,SECURITY_DESCRIPTOR_MIN_LENGTH = 20,};
enum MACRO_TRUST_E_NOSIGNATURE {TRUST_E_NOSIGNATURE = 0x800B0100,};
enum MACRO_VARIANT_NOVALUEPROP {VARIANT_NOVALUEPROP = 0x1,VARIANT_ALPHABOOL = 0x2,VARIANT_NOUSEROVERRIDE = 0x4,VARIANT_LOCALBOOL = 0x8,};
...
enum _TOKEN_INFORMATION_CLASS {TokenUser = 0x1,TokenGroups = 0x2,TokenPrivileges = 0x3,TokenOwner = 0x4,TokenPrimaryGroup = 0x5,TokenDefaultDacl = 0x6,TokenSource = 0x7,TokenType = 0x8,TokenImpersonationLevel = 0x9,TokenStatistics = 0xA,TokenRestrictedSids = 0xB,};
...
enum MACRO_CRYPT_MODE_CBC {CRYPT_MODE_CBC = 1,CRYPT_MODE_ECB = 2,CRYPT_MODE_OFB = 3,CRYPT_MODE_CFB = 4,CRYPT_MODE_CTS = 5,CRYPT_ENCRYPT = 1,CRYPT_DECRYPT = 2,CRYPT_EXPORT = 4,CRYPT_READ = 8,CRYPT_WRITE = 16,CRYPT_MAC = 32,CRYPT_EXPORT_KEY = 64,CRYPT_IMPORT_KEY = 128,};
...
typedef struct _POWER_DEVICE_TIMEOUTS POWER_DEVICE_TIMOUTS;
...
enum _JOBOBJECTINFOCLASS {JobObjectBasicAccountingInformation = 0x1,JobObjectBasicLimitInformation = 0x2,JobObjectBasicProcessIdList = 0x3,JobObjectBasicUIRestrictions = 0x4,JobObjectSecurityLimitInformation = 0x5,MaxJobObjectInfoClass = 0x6,};
...
enum MACRO_DISP_CHANGE {DISP_CHANGE_SUCCESSFUL = 0,DISP_CHANGE_RESTART = 1,DISP_CHANGE_FAILED = -1,DISP_CHANGE_BADMODE = -2,DISP_CHANGE_NOTUPDATED = -3,DISP_CHANGE_BADFLAGS = -4,DISP_CHANGE_BADPARAM = -5,};
...
enum MACRO_RPC_C_AUTHZ {RPC_C_AUTHZ_NONE = 0,RPC_C_AUTHZ_NAME = 1,RPC_C_AUTHZ_DCE = 2,};
...
enum MACRO_WAIT_FAILED {WAIT_FAILED = 0xFFFFFFFF,WAIT_OBJECT_0 = 0x0,WAIT_ABANDONED = 0x80,WAIT_ABANDONED_0 = 0x80,WAIT_TIMEOUT = 0x102,WAIT_IO_COMPLETION = 0xC0,};
...
enum MACRO_JOB_OBJECT {JOB_OBJECT_LIMIT_WORKINGSET = 0x1,JOB_OBJECT_LIMIT_PROCESS_TIME = 0x2,JOB_OBJECT_LIMIT_JOB_TIME = 0x4,JOB_OBJECT_LIMIT_ACTIVE_PROCESS = 0x8,JOB_OBJECT_LIMIT_AFFINITY = 0x10,JOB_OBJECT_LIMIT_PRIORITY_CLASS = 0x20,JOB_OBJECT_LIMIT_PRESERVE_JOB_TIME = 0x40,JOB_OBJECT_LIMIT_VALID_FLAGS = 0x7F,JOB_OBJECT_UILIMIT_NONE = 0x0,JOB_OBJECT_UILIMIT_HANDLES = 0x1,JOB_OBJECT_UILIMIT_READCLIPBOARD = 0x2,JOB_OBJECT_UILIMIT_WRITECLIPBOARD = 0x4,JOB_OBJECT_UILIMIT_EXITWINDOWS = 0x8,JOB_OBJECT_UILIMIT_SYSTEMPARAMTERS = 0x10,JOB_OBJECT_UILIMIT_ALL = 0x1F,JOB_OBJECT_UI_VALID_FLAGS = 0x1F,JOB_OBJECT_SECURITY_NO_ADMIN = 0x1,JOB_OBJECT_SECURITY_RESTRICTED_TOKEN = 0x2,JOB_OBJECT_SECURITY_ONLY_TOKEN = 0x4,JOB_OBJECT_SECURITY_FILTER_TOKENS = 0x8,JOB_OBJECT_SECURITY_VALID_FLAGS = 0xF,};
...
enum MACRO_VAR_FORMAT {VAR_FORMAT_NOSUBSTITUTE = 0x10,};
...
enum MACRO_PROCESSOR {PROCESSOR_INTEL_386 = 386,PROCESSOR_INTEL_486 = 486,PROCESSOR_INTEL_PENTIUM = 586,PROCESSOR_INTEL_860 = 860,PROCESSOR_MIPS_R2000 = 2000,PROCESSOR_MIPS_R3000 = 3000,PROCESSOR_MIPS_R4000 = 4000,PROCESSOR_ALPHA_21064 = 21064,PROCESSOR_PPC_601 = 601,PROCESSOR_PPC_603 = 603,PROCESSOR_PPC_604 = 604,PROCESSOR_PPC_620 = 620,PROCESSOR_HITACHI_SH3 = 10003,PROCESSOR_HITACHI_SH3E = 10004,PROCESSOR_HITACHI_SH4 = 10005,PROCESSOR_MOTOROLA_821 = 821,PROCESSOR_SHx_SH3 = 103,PROCESSOR_SHx_SH4 = 104,PROCESSOR_STRONGARM = 2577,PROCESSOR_ARM720 = 1824,PROCESSOR_ARM820 = 2080,PROCESSOR_ARM920 = 2336,PROCESSOR_ARM_7TDMI = 70001,PROCESSOR_ARCHITECTURE_INTEL = 0,PROCESSOR_ARCHITECTURE_MIPS = 1,PROCESSOR_ARCHITECTURE_ALPHA = 2,PROCESSOR_ARCHITECTURE_PPC = 3,PROCESSOR_ARCHITECTURE_SHX = 4,PROCESSOR_ARCHITECTURE_ARM = 5,PROCESSOR_ARCHITECTURE_UNKNOWN = 65535,};
...
enum MACRO_FACILITY {FACILITY_WINDOWS = 8,FACILITY_STORAGE = 3,FACILITY_SSPI = 9,FACILITY_SETUPAPI = 15,FACILITY_RPC = 1,FACILITY_WIN32 = 7,FACILITY_CONTROL = 10,FACILITY_NULL = 0,FACILITY_MSMQ = 14,FACILITY_MEDIASERVER = 13,FACILITY_INTERNET = 12,FACILITY_ITF = 4,FACILITY_DISPATCH = 2,FACILITY_CERT = 11,};
...
enum MACRO_CERTSRV {CERTSRV_E_BAD_REQUESTSUBJECT = 0x80094001,CERTSRV_E_NO_REQUEST = 0x80094002,CERTSRV_E_BAD_REQUESTSTATUS = 0x80094003,CERTSRV_E_PROPERTY_EMPTY = 0x80094004,};
...
enum MACRO_PROCESS {PROCESS_TERMINATE = 0x1,PROCESS_CREATE_THREAD = 0x2,PROCESS_VM_OPERATION = 0x8,PROCESS_VM_READ = 0x10,PROCESS_VM_WRITE = 0x20,PROCESS_DUP_HANDLE = 0x40,PROCESS_CREATE_PROCESS = 0x80,PROCESS_SET_QUOTA = 0x100,PROCESS_SET_INFORMATION = 0x200,PROCESS_QUERY_INFORMATION = 0x400,PROCESS_ALL_ACCESS = 0x1F0FFF,};
...
enum MACRO_UNICODE {UNICODE_NULL = 0,};
...
enum MACRO_CERTDB {CERTDB_E_JET_ERROR = 0x80095000,TRUST_E_SYSTEM_ERROR = 0x80096001,};
...
enum MACRO_DOMAIN {DOMAIN_USER_RID_ADMIN = 0x1F4,DOMAIN_USER_RID_GUEST = 0x1F5,DOMAIN_USER_RID_KRBTGT = 0x1F6,DOMAIN_GROUP_RID_ADMINS = 0x200,DOMAIN_GROUP_RID_USERS = 0x201,DOMAIN_GROUP_RID_GUESTS = 0x202,DOMAIN_ALIAS_RID_ADMINS = 0x220,DOMAIN_ALIAS_RID_USERS = 0x221,DOMAIN_ALIAS_RID_GUESTS = 0x222,DOMAIN_ALIAS_RID_POWER_USERS = 0x223,DOMAIN_ALIAS_RID_ACCOUNT_OPS = 0x224,DOMAIN_ALIAS_RID_SYSTEM_OPS = 0x225,DOMAIN_ALIAS_RID_PRINT_OPS = 0x226,DOMAIN_ALIAS_RID_BACKUP_OPS = 0x227,DOMAIN_ALIAS_RID_REPLICATOR = 0x228,};
...
enum MACRO_REGDB {REGDB_E_FIRST = 0x80040150,REGDB_E_LAST = 0x8004015F,REGDB_S_FIRST = 0x40150,REGDB_S_LAST = 0x4015F,REGDB_E_READREGDB = 0x80040150,REGDB_E_WRITEREGDB = 0x80040151,REGDB_E_KEYMISSING = 0x80040152,REGDB_E_INVALIDVALUE = 0x80040153,REGDB_E_CLASSNOTREG = 0x80040154,REGDB_E_IIDNOTREG = 0x80040155,};
...
enum MACRO_TOKEN {TOKEN_ASSIGN_PRIMARY = 0x1,TOKEN_DUPLICATE = 0x2,TOKEN_IMPERSONATE = 0x4,TOKEN_QUERY = 0x8,TOKEN_QUERY_SOURCE = 0x10,TOKEN_ADJUST_PRIVILEGES = 0x20,TOKEN_ADJUST_GROUPS = 0x40,TOKEN_ADJUST_DEFAULT = 0x80,TOKEN_ALL_ACCESS = 0xF00FF,TOKEN_READ = 0x20008,TOKEN_WRITE = 0x200E0,TOKEN_EXECUTE = 0x20000,TOKEN_SOURCE_LENGTH = 0x8,};
enum MACRO_TRUST {TRUST_E_NO_SIGNER_CERT = 0x80096002,TRUST_E_COUNTER_SIGNER = 0x80096003,TRUST_E_CERT_SIGNATURE = 0x80096004,TRUST_E_TIME_STAMP = 0x80096005,TRUST_E_BAD_DIGEST = 0x80096010,TRUST_E_BASIC_CONSTRAINTS = 0x80096019,TRUST_E_FINANCIAL_CRITERIA = 0x8009601E,};
...
enum MACRO_INET {INET_E_INVALID_URL = 0x800C0002,INET_E_NO_SESSION = 0x800C0003,INET_E_CANNOT_CONNECT = 0x800C0004,INET_E_RESOURCE_NOT_FOUND = 0x800C0005,INET_E_OBJECT_NOT_FOUND = 0x800C0006,INET_E_DATA_NOT_AVAILABLE = 0x800C0007,INET_E_DOWNLOAD_FAILURE = 0x800C0008,INET_E_AUTHENTICATION_REQUIRED = 0x800C0009,INET_E_NO_VALID_MEDIA = 0x800C000A,INET_E_CONNECTION_TIMEOUT = 0x800C000B,INET_E_INVALID_REQUEST = 0x800C000C,INET_E_UNKNOWN_PROTOCOL = 0x800C000D,INET_E_SECURITY_PROBLEM = 0x800C000E,INET_E_CANNOT_LOAD_DATA = 0x800C000F,INET_E_CANNOT_INSTANTIATE_OBJECT = 0x800C0010,INET_E_REDIRECT_FAILED = 0x800C0014,INET_E_REDIRECT_TO_DIR = 0x800C0015,INET_E_CANNOT_LOCK_REQUEST = 0x800C0016,INET_E_ERROR_FIRST = 0x800C0002,INET_E_ERROR_LAST = 0x800C0015,};
enum MACRO_LANG {LANG_NEUTRAL = 0x0,LANG_AFRIKAANS = 0x36,LANG_ALBANIAN = 0x1C,LANG_ARABIC = 0x1,LANG_BASQUE = 0x2D,LANG_BELARUSIAN = 0x23,LANG_BULGARIAN = 0x2,LANG_CATALAN = 0x3,LANG_CHINESE = 0x4,LANG_CROATIAN = 0x1A,LANG_CZECH = 0x5,LANG_DANISH = 0x6,LANG_DUTCH = 0x13,LANG_ENGLISH = 0x9,LANG_ESTONIAN = 0x25,LANG_FAEROESE = 0x38,LANG_FARSI = 0x29,LANG_FINNISH = 0xB,LANG_FRENCH = 0xC,LANG_GERMAN = 0x7,LANG_GREEK = 0x8,LANG_HEBREW = 0xD,LANG_HINDI = 0x39,LANG_HUNGARIAN = 0xE,LANG_ICELANDIC = 0xF,LANG_INDONESIAN = 0x21,LANG_ITALIAN = 0x10,LANG_JAPANESE = 0x11,LANG_KOREAN = 0x12,LANG_LATVIAN = 0x26,LANG_LITHUANIAN = 0x27,LANG_MACEDONIAN = 0x2F,LANG_MALAY = 0x3E,LANG_NORWEGIAN = 0x14,LANG_POLISH = 0x15,LANG_PORTUGUESE = 0x16,LANG_ROMANIAN = 0x18,LANG_RUSSIAN = 0x19,LANG_SERBIAN = 0x1A,LANG_SLOVAK = 0x1B,LANG_SLOVENIAN = 0x24,LANG_SPANISH = 0xA,LANG_SWAHILI = 0x41,LANG_SWEDISH = 0x1D,LANG_THAI = 0x1E,LANG_TURKISH = 0x1F,LANG_UKRAINIAN = 0x22,LANG_VIETNAMESE = 0x2A,};
...
enum MACRO_PAGE {PAGE_NOACCESS = 0x1,PAGE_READONLY = 0x2,PAGE_READWRITE = 0x4,PAGE_WRITECOPY = 0x8,PAGE_EXECUTE = 0x10,PAGE_EXECUTE_READ = 0x20,PAGE_EXECUTE_READWRITE = 0x40,PAGE_EXECUTE_WRITECOPY = 0x80,PAGE_GUARD = 0x100,PAGE_NOCACHE = 0x200,};
...
enum MACRO_SORT {SORT_DEFAULT = 0x0,SORT_JAPANESE_XJIS = 0x0,SORT_JAPANESE_UNICODE = 0x1,SORT_CHINESE_BIG5 = 0x0,SORT_CHINESE_PRCP = 0x0,SORT_CHINESE_UNICODE = 0x1,SORT_CHINESE_PRC = 0x2,SORT_KOREAN_KSC = 0x0,SORT_KOREAN_UNICODE = 0x1,SORT_GERMAN_PHONE_BOOK = 0x1,};
...
enum MACRO_BDR {BDR_RAISEDOUTER = 0x1,BDR_SUNKENOUTER = 0x2,BDR_RAISEDINNER = 0x4,BDR_SUNKENINNER = 0x8,};
...
enum MACRO_ILL {ILL_EXECUTION = 20,ILL_EXPLICITGEN = 21,ILL_PRIVILEGED = 22,};
...
enum MACRO_RPC {RPC_E_CALL_REJECTED = 0x80010001,RPC_E_CALL_CANCELED = 0x80010002,RPC_E_CANTPOST_INSENDCALL = 0x80010003,RPC_E_CANTCALLOUT_INASYNCCALL = 0x80010004,RPC_E_CANTCALLOUT_INEXTERNALCALL = 0x80010005,RPC_E_CONNECTION_TERMINATED = 0x80010006,RPC_E_SERVER_DIED = 0x80010007,RPC_E_CLIENT_DIED = 0x80010008,RPC_E_INVALID_DATAPACKET = 0x80010009,RPC_E_CANTTRANSMIT_CALL = 0x8001000A,RPC_E_CLIENT_CANTMARSHAL_DATA = 0x8001000B,RPC_E_CLIENT_CANTUNMARSHAL_DATA = 0x8001000C,RPC_E_SERVER_CANTMARSHAL_DATA = 0x8001000D,RPC_E_SERVER_CANTUNMARSHAL_DATA = 0x8001000E,RPC_E_INVALID_DATA = 0x8001000F,RPC_E_INVALID_PARAMETER = 0x80010010,RPC_E_CANTCALLOUT_AGAIN = 0x80010011,RPC_E_SERVER_DIED_DNE = 0x80010012,RPC_E_SYS_CALL_FAILED = 0x80010100,RPC_E_OUT_OF_RESOURCES = 0x80010101,RPC_E_ATTEMPTED_MULTITHREAD = 0x80010102,RPC_E_NOT_REGISTERED = 0x80010103,RPC_E_FAULT = 0x80010104,RPC_E_SERVERFAULT = 0x80010105,RPC_E_CHANGED_MODE = 0x80010106,RPC_E_INVALIDMETHOD = 0x80010107,RPC_E_DISCONNECTED = 0x80010108,RPC_E_RETRY = 0x80010109,RPC_E_SERVERCALL_RETRYLATER = 0x8001010A,RPC_E_SERVERCALL_REJECTED = 0x8001010B,RPC_E_INVALID_CALLDATA = 0x8001010C,RPC_E_CANTCALLOUT_ININPUTSYNCCALL = 0x8001010D,RPC_E_WRONG_THREAD = 0x8001010E,RPC_E_THREAD_NOT_INIT = 0x8001010F,RPC_E_VERSION_MISMATCH = 0x80010110,RPC_E_INVALID_HEADER = 0x80010111,RPC_E_INVALID_EXTENSION = 0x80010112,RPC_E_INVALID_IPID = 0x80010113,RPC_E_INVALID_OBJECT = 0x80010114,RPC_S_CALLPENDING = 0x80010115,RPC_S_WAITONTIMER = 0x80010116,RPC_E_CALL_COMPLETE = 0x80010117,RPC_E_UNSECURE_CALL = 0x80010118,RPC_E_TOO_LATE = 0x80010119,RPC_E_NO_GOOD_SECURITY_PACKAGES = 0x8001011A,RPC_E_ACCESS_DENIED = 0x8001011B,RPC_E_REMOTE_DISABLED = 0x8001011C,RPC_E_INVALID_OBJREF = 0x8001011D,RPC_E_NO_CONTEXT = 0x8001011E,RPC_E_TIMEOUT = 0x8001011F,RPC_E_NO_SYNC = 0x80010120,RPC_E_UNEXPECTED = 0x8001FFFF,};
...
enum MACRO_VAR {VAR_TIMEVALUEONLY = 0x1,VAR_DATEVALUEONLY = 0x2,VAR_LOCALBOOL = 0x10,};
...
enum MACRO_PF {PF_FLOATING_POINT_PRECISION_ERRATA = 0,PF_FLOATING_POINT_EMULATED = 1,PF_COMPARE_EXCHANGE_DOUBLE = 2,PF_MMX_INSTRUCTIONS_AVAILABLE = 3,PF_PPC_MOVEMEM_64BIT_OK = 4,PF_ALPHA_BYTE_INSTRUCTIONS = 5,};
...
struct tagVARIANT_______tagVARIANT___8CBA3EFFFCF6218F3F43B45A8ED6FC2D____tagBRECORD {PVOID pvRecord;IRecordInfo *pRecInfo;};
...
struct _JOBOBJECT_BASIC_PROCESS_ID_LIST {DWORD NumberOfAssignedProcesses;DWORD NumberOfProcessIdsInList;DWORD ProcessIdList[1];};
...
typedef void (__stdcall *PAPCFUNC)(DWORD dwParam);
...
union _MEMORY_BASIC_INFORMATION_VLM___199B4FE6F20B709B42D974D5EBADF5DA {PVOID64 AllocationBase;DWORDLONG AllocationBaseAsUlongLong;};
union _MEMORY_BASIC_INFORMATION_VLM___367D50FA44A4E18B63B07CC3F3BD13BF {PVOID64 BaseAddress;DWORDLONG BaseAddressAsUlongLong;};
...
union _FILE_SEGMENT_ELEMENT {PVOID64 Buffer;DWORDLONG Alignment;};
...
union _ULARGE_INTEGER {_ULARGE_INTEGER___0354AA9C204208F00D0965D07BBE7FAC __anonymous0;struct _ULARGE_INTEGER___0354AA9C204208F00D0965D07BBE7FAC u;DWORDLONG QuadPart;};
...
struct _QUOTA_LIMITS {DWORD PagedPoolLimit;DWORD NonPagedPoolLimit;DWORD MinimumWorkingSetSize;DWORD MaximumWorkingSetSize;DWORD PagefileLimit;LARGE_INTEGER TimeLimit;};
...
typedef void (__stdcall *LPFN_GETACCEPTEXSOCKADDRS)(PVOID lpOutputBuffer, DWORD dwReceiveDataLength, DWORD dwLocalAddressLength, DWORD dwRemoteAddressLength, struct sockaddr **LocalSockaddr, LPINT LocalSockaddrLength, struct sockaddr **RemoteSockaddr, LPINT RemoteSockaddrLength);
...
struct _IMAGE_IMPORT_DESCRIPTOR {_IMAGE_IMPORT_DESCRIPTOR___CCDB7E5AE55A3EBF5ADB4AABA889E6CB __anonymous0;DWORD TimeDateStamp;DWORD ForwarderChain;DWORD Name;PIMAGE_THUNK_DATA FirstThunk;};
...
struct _RPC_CLIENT_INTERFACE {unsigned int Length;RPC_SYNTAX_IDENTIFIER InterfaceId;RPC_SYNTAX_IDENTIFIER TransferSyntax;PRPC_DISPATCH_TABLE DispatchTable;unsigned int RpcProtseqEndpointCount;PRPC_PROTSEQ_ENDPOINT RpcProtseqEndpoint;unsigned int Reserved;const void *InterpreterInfo;unsigned int Flags;};
...
struct _MEMORY_BASIC_INFORMATION_VLM {_MEMORY_BASIC_INFORMATION_VLM___367D50FA44A4E18B63B07CC3F3BD13BF __anonymous0;_MEMORY_BASIC_INFORMATION_VLM___199B4FE6F20B709B42D974D5EBADF5DA __anonymous1;DWORDLONG RegionSize;DWORD AllocationProtect;DWORD State;DWORD Protect;DWORD Type;};
...
struct ISynchronizeEventVtbl {HRESULT (__stdcall *QueryInterface)(ISynchronizeEvent *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(ISynchronizeEvent *This);ULONG (__stdcall *Release)(ISynchronizeEvent *This);HRESULT (__stdcall *GetEvent)(ISynchronizeEvent *This, HANDLE *pEvent);};
struct ISynchronizeMutexVtbl {HRESULT (__stdcall *QueryInterface)(ISynchronizeMutex *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(ISynchronizeMutex *This);ULONG (__stdcall *Release)(ISynchronizeMutex *This);HRESULT (__stdcall *Wait)(ISynchronizeMutex *This, DWORD dwMilliseconds);HRESULT (__stdcall *Signal)(ISynchronizeMutex *This);HRESULT (__stdcall *Reset)(ISynchronizeMutex *This);HRESULT (__stdcall *ReleaseMutex)(ISynchronizeMutex *This);};
...
struct IEnumPackageVtbl {HRESULT (__stdcall *QueryInterface)(IEnumPackage *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(IEnumPackage *This);ULONG (__stdcall *Release)(IEnumPackage *This);HRESULT (__stdcall *Next)(IEnumPackage *This, ULONG celt, PACKAGEDETAIL *rgelt, ULONG *pceltFetched);HRESULT (__stdcall *Skip)(IEnumPackage *This, ULONG celt);HRESULT (__stdcall *Reset)(IEnumPackage *This);HRESULT (__stdcall *Clone)(IEnumPackage *This, IEnumPackage **ppenum);};
...
struct ISynchronizeVtbl {HRESULT (__stdcall *QueryInterface)(ISynchronize *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(ISynchronize *This);ULONG (__stdcall *Release)(ISynchronize *This);HRESULT (__stdcall *Wait)(ISynchronize *This, DWORD dwMilliseconds);HRESULT (__stdcall *Signal)(ISynchronize *This);HRESULT (__stdcall *Reset)(ISynchronize *This);};
...
struct IAsyncSetupVtbl {HRESULT (__stdcall *QueryInterface)(IAsyncSetup *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(IAsyncSetup *This);ULONG (__stdcall *Release)(IAsyncSetup *This);HRESULT (__stdcall *GetAsyncManager)(IAsyncSetup *This, const IID *const riid, IUnknown *pOuter, DWORD dwFlags, IUnknown **ppInner, IAsyncManager **ppAsyncMgr);};
struct IRpcOptionsVtbl {HRESULT (__stdcall *QueryInterface)(IRpcOptions *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(IRpcOptions *This);ULONG (__stdcall *Release)(IRpcOptions *This);HRESULT (__stdcall *Set)(IRpcOptions *This, IUnknown *pPrx, DWORD dwProperty, DWORD dwValue);HRESULT (__stdcall *Query)(IRpcOptions *This, IUnknown *pPrx, DWORD dwProperty, DWORD *pdwValue);HRESULT (__stdcall *CopyProxy)(IRpcOptions *This, IUnknown *punkProxy, IUnknown **ppunkCopy);};
typedef int (__stdcall *LPCONDITIONPROC)(LPWSABUF lpCallerId, LPWSABUF lpCallerData, LPQOS lpSQOS, LPQOS lpGQOS, LPWSABUF lpCalleeId, LPWSABUF lpCalleeData, GROUP *g, DWORD dwCallbackData);
...
struct IEnumClassVtbl {HRESULT (__stdcall *QueryInterface)(IEnumClass *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(IEnumClass *This);ULONG (__stdcall *Release)(IEnumClass *This);HRESULT (__stdcall *Next)(IEnumClass *This, ULONG celt, CLASSDETAIL *rgelt, ULONG *pceltFetched);HRESULT (__stdcall *Skip)(IEnumClass *This, ULONG celt);HRESULT (__stdcall *Reset)(IEnumClass *This);HRESULT (__stdcall *Clone)(IEnumClass *This, IEnumClass **ppenum);};
...
typedef HDDEDATA (__stdcall *PFNCALLBACK)(UINT wType, UINT wFmt, HCONV hConv, HSZ hsz1, HSZ hsz2, HDDEDATA hData, DWORD dwData1, DWORD dwData2);
...
typedef HDDEDATA __stdcall FNCALLBACK(UINT wType, UINT wFmt, HCONV hConv, HSZ hsz1, HSZ hsz2, HDDEDATA hData, DWORD dwData1, DWORD dwData2);
...
struct IClassActivatorVtbl {HRESULT (__stdcall *QueryInterface)(IClassActivator *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(IClassActivator *This);ULONG (__stdcall *Release)(IClassActivator *This);HRESULT (__stdcall *GetClassObject)(IClassActivator *This, const CLSID *const rclsid, DWORD dwClassContext, LCID locale, const IID *const riid, void **ppv);};
...
typedef BOOL (__stdcall *LPFN_TRANSMITFILE)(SOCKET hSocket, HANDLE hFile, DWORD nNumberOfBytesToWrite, DWORD nNumberOfBytesPerSend, LPOVERLAPPED lpOverlapped, LPTRANSMIT_FILE_BUFFERS lpTransmitBuffers, DWORD dwReserved);
...
typedef BOOL (__stdcall *LPFN_ACCEPTEX)(SOCKET sListenSocket, SOCKET sAcceptSocket, PVOID lpOutputBuffer, DWORD dwReceiveDataLength, DWORD dwLocalAddressLength, DWORD dwRemoteAddressLength, LPDWORD lpdwBytesReceived, LPOVERLAPPED lpOverlapped);
...
struct _MIDL_STUB_MESSAGE {PRPC_MESSAGE RpcMsg;unsigned __int8 *Buffer;unsigned __int8 *BufferStart;unsigned __int8 *BufferEnd;unsigned __int8 *BufferMark;unsigned int BufferLength;unsigned int MemorySize;unsigned __int8 *Memory;int IsClient;int ReuseBuffer;unsigned __int8 *AllocAllNodesMemory;unsigned __int8 *AllocAllNodesMemoryEnd;int IgnoreEmbeddedPointers;unsigned __int8 *PointerBufferMark;unsigned __int8 fBufferValid;unsigned __int8 Unused;unsigned int MaxCount;unsigned int Offset;unsigned int ActualCount;void *(__stdcall *pfnAllocate)(size_t);void (__stdcall *pfnFree)(void *);unsigned __int8 *StackTop;unsigned __int8 *pPresentedType;unsigned __int8 *pTransmitType;handle_t SavedHandle;const struct _MIDL_STUB_DESC *StubDesc;struct _FULL_PTR_XLAT_TABLES *FullPtrXlatTables;unsigned int FullPtrRefId;int fCheckBounds;__int32 fInDontFree : 1;__int32 fDontCallFreeInst : 1;__int32 fInOnlyParam : 1;__int32 fHasReturn : 1;unsigned int dwDestContext;void *pvDestContext;NDR_SCONTEXT *SavedContextHandles;int ParamNumber;struct IRpcChannelBuffer *pRpcChannelBuffer;PARRAY_INFO pArrayInfo;unsigned int *SizePtrCountArray;unsigned int *SizePtrOffsetArray;unsigned int *SizePtrLengthArray;void *pArgQueue;unsigned int dwStubPhase;PNDR_PIPE_DESC pPipeDesc;PNDR_ASYNC_MESSAGE pAsyncMsg;unsigned int Reserved[3];};
struct IClassRefreshVtbl {HRESULT (__stdcall *QueryInterface)(IClassRefresh *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(IClassRefresh *This);ULONG (__stdcall *Release)(IClassRefresh *This);HRESULT (__stdcall *GetUpgrades)(IClassRefresh *This, ULONG cClasses, CLSID *pClassList, CSPLATFORM Platform, LCID Locale, PACKAGEINFOLIST *pPackageInfoList);HRESULT (__stdcall *CommitUpgrades)(IClassRefresh *This);};
...
struct IClassAccessVtbl {HRESULT (__stdcall *QueryInterface)(IClassAccess *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(IClassAccess *This);ULONG (__stdcall *Release)(IClassAccess *This);HRESULT (__stdcall *GetClassInfoA)(IClassAccess *This, const CLSID *const clsid, QUERYCONTEXT QryContext, PACKAGEINFO *pPackageInfo);HRESULT (__stdcall *GetClassSpecInfo)(IClassAccess *This, uCLSSPEC *pClassSpec, QUERYCONTEXT QryContext, PACKAGEINFO *pPackageInfo);HRESULT (__stdcall *GetInstallablePackages)(IClassAccess *This, DWORD Count, PUBLISHEDINFOLIST *pInfoList);};
struct _MIDL_STUB_DESC {void *RpcInterfaceInformation;void *(__stdcall *pfnAllocate)(size_t);void (__stdcall *pfnFree)(void *);union _MIDL_STUB_DESC___5BCB627D3738D8B5DEACC268C24AE672 IMPLICIT_HANDLE_INFO;const NDR_RUNDOWN *apfnNdrRundownRoutines;const GENERIC_BINDING_ROUTINE_PAIR *aGenericBindingRoutinePairs;const EXPR_EVAL *apfnExprEval;const XMIT_ROUTINE_QUINTUPLE *aXmitQuintuple;const unsigned __int8 *pFormatTypes;int fCheckBounds;unsigned int Version;MALLOC_FREE_STRUCT *pMallocFreeStruct;int MIDLVersion;const COMM_FAULT_OFFSETS *CommFaultOffsets;const USER_MARSHAL_ROUTINE_QUADRUPLE *aUserMarshalQuadruple;int Reserved1;int Reserved2;int Reserved3;int Reserved4;int Reserved5;};
...
struct tagVARIANT___F060C15D409704AFCEB2B499364615C4____tagVARIANT {VARTYPE vt;WORD wReserved1;WORD wReserved2;WORD wReserved3;union tagVARIANT_______tagVARIANT___8CBA3EFFFCF6218F3F43B45A8ED6FC2D n3;};
...
struct IComBindingVtbl {HRESULT (__stdcall *QueryInterface)(IComBinding *This, const IID *const riid, void **ppvObject);ULONG (__stdcall *AddRef)(IComBinding *This);ULONG (__stdcall *Release)(IComBinding *This);HRESULT (__stdcall *InitBinding)(IComBinding *This, DWORD dwEndpointFlags, DWORD dwNICFlags, DWORD mbzReserved1, DWORD mbzReserved2, LPOLESTR pszBinding);HRESULT (__stdcall *QueryBinding)(IComBinding *This, LPDWORD pdwEndpointFlags, LPDWORD pdwNICFlags, LPDWORD mbzReserved1, LPDWORD mbzReserved2, LPOLESTR *ppszBinding);};
