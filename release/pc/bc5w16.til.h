#define GHIDRA
#ifndef INCLUDE_GUARD_bc5w16_til
#define INCLUDE_GUARD_bc5w16_til
...
struct tMIXERCONTROL___A559D66DCD7A1BA00AE602A0A7AC983C___D5AE507983131F2A7D73786D6C61051F {__int32 lMinimum;__int32 lMaximum;};
...
struct ISupportErrorInfoVtbl {HRESULT (*QueryInterface)(ISupportErrorInfo *This, const IID *const riid, void * *ppvObj);unsigned __int32 (*AddRef)(ISupportErrorInfo *This);unsigned __int32 (*Release)(ISupportErrorInfo *This);HRESULT (*InterfaceSupportsErrorInfo)(ISupportErrorInfo *This, const IID *const riid);};
...
typedef void __pascal TIMECALLBACK(UINT uTimerID, UINT uMsg, DWORD dwUser, DWORD dw1, DWORD dw2);
...
typedef BOOL (__pascal *LPFNEDITRES)(LPSTR szType, LPSTR szId);
...
struct ICreateErrorInfoVtbl {HRESULT (*QueryInterface)(ICreateErrorInfo *This, const IID *const riid, void * *ppvObj);unsigned __int32 (*AddRef)(ICreateErrorInfo *This);unsigned __int32 (*Release)(ICreateErrorInfo *This);HRESULT (*SetGUID)(ICreateErrorInfo *This, const GUID *const rguid);HRESULT (*SetSource)(ICreateErrorInfo *This, LPSTR szSource);HRESULT (*SetDescription)(ICreateErrorInfo *This, LPSTR szDescription);HRESULT (*SetHelpFile)(ICreateErrorInfo *This, LPSTR szHelpFile);HRESULT (*SetHelpContext)(ICreateErrorInfo *This, unsigned __int32 dwHelpContext);};
...
struct IErrorInfoVtbl {HRESULT (*QueryInterface)(IErrorInfo *This, const IID *const riid, void * *ppvObj);unsigned __int32 (*AddRef)(IErrorInfo *This);unsigned __int32 (*Release)(IErrorInfo *This);HRESULT (*GetGUID)(IErrorInfo *This, GUID *pguid);HRESULT (*GetSource)(IErrorInfo *This, BSTR *pbstrSource);HRESULT (*GetDescription)(IErrorInfo *This, BSTR *pbstrDescription);HRESULT (*GetHelpFile)(IErrorInfo *This, BSTR *pbstrHelpFile);HRESULT (*GetHelpContext)(IErrorInfo *This, unsigned __int32 *pdwHelpContext);};
...
typedef void __pascal DRVCALLBACK(HDRVR hdrvr, UINT uMsg, DWORD dwUser, DWORD dw1, DWORD dw2);
...
typedef UINT (__pascal *LPFNFLAGS)(DWORD dwStyle, LPSTR lpBuff, UINT wBuffLength);
typedef UINT (__pascal *YIELDPROC)(MCIDEVICEID mciId, DWORD dwYieldData);
...
struct ICreateTypeLibVtbl {HRESULT (*QueryInterface)(ICreateTypeLib *This, const IID *const riid, void * *ppvObj);unsigned __int32 (*AddRef)(ICreateTypeLib *This);unsigned __int32 (*Release)(ICreateTypeLib *This);HRESULT (*CreateTypeInfo)(ICreateTypeLib *This, char *szName, TYPEKIND tkind, ICreateTypeInfo * *lplpictinfo);HRESULT (*SetName)(ICreateTypeLib *This, char *szName);HRESULT (*SetVersion)(ICreateTypeLib *This, unsigned int wMajorVerNum, unsigned int wMinorVerNum);HRESULT (*SetGuid)(ICreateTypeLib *This, const GUID *const guid);HRESULT (*SetDocString)(ICreateTypeLib *This, char *szDoc);HRESULT (*SetHelpFileName)(ICreateTypeLib *This, char *szHelpFileName);HRESULT (*SetHelpContext)(ICreateTypeLib *This, unsigned __int32 dwHelpContext);HRESULT (*SetLcid)(ICreateTypeLib *This, LCID lcid);HRESULT (*SetLibFlags)(ICreateTypeLib *This, unsigned int uLibFlags);HRESULT (*SaveAllChanges)(ICreateTypeLib *This);};
...
struct ITypeCompVtbl {HRESULT (*QueryInterface)(ITypeComp *This, const IID *const riid, void * *ppvObj);unsigned __int32 (*AddRef)(ITypeComp *This);unsigned __int32 (*Release)(ITypeComp *This);HRESULT (*Bind)(ITypeComp *This, char *szName, unsigned __int32 lHashVal, unsigned int wflags, ITypeInfo * *pptinfo, DESCKIND *pdesckind, BINDPTR *pbindptr);HRESULT (*BindType)(ITypeComp *This, char *szName, unsigned __int32 lHashVal, ITypeInfo * *pptinfo, ITypeComp * *pptcomp);};
...
typedef LRESULT __pascal MMIOPROC(LPSTR lpmmioinfo, UINT uMsg, LPARAM lParam1, LPARAM lParam2);
...
struct tagTYPEATTR {GUID guid;LCID lcid;unsigned __int32 dwReserved;MEMBERID memidConstructor;MEMBERID memidDestructor;char *lpstrSchema;unsigned __int32 cbSizeInstance;TYPEKIND typekind;unsigned int cFuncs;unsigned int cVars;unsigned int cImplTypes;unsigned int cbSizeVft;unsigned int cbAlignment;unsigned int wTypeFlags;unsigned int wMajorVerNum;unsigned int wMinorVerNum;TYPEDESC tdescAlias;IDLDESC idldescType;};
struct tagMSG {HWND hwnd;UINT message;WPARAM wParam;LPARAM lParam;DWORD time;POINT pt;};
union tagVARIANT___97E52095E85F5E8E7D59138FFD8EEF88 {unsigned __int8 bVal;int iVal;__int32 lVal;float fltVal;double dblVal;VARIANT_BOOL _bool;SCODE scode;CY cyVal;DATE date;BSTR bstrVal;IUnknown *punkVal;IDispatch *pdispVal;SAFEARRAY *parray;unsigned __int8 *pbVal;int *piVal;__int32 *plVal;float *pfltVal;double *pdblVal;VARIANT_BOOL *pbool;SCODE *pscode;CY *pcyVal;DATE *pdate;BSTR *pbstrVal;IUnknown * *ppunkVal;IDispatch * *ppdispVal;SAFEARRAY * *pparray;VARIANT *pvarVal;void *byref;};
...
struct ITypeInfoVtbl {HRESULT (*QueryInterface)(ITypeInfo *This, const IID *const riid, void * *ppvObj);unsigned __int32 (*AddRef)(ITypeInfo *This);unsigned __int32 (*Release)(ITypeInfo *This);HRESULT (*GetTypeAttr)(ITypeInfo *This, TYPEATTR * *pptypeattr);HRESULT (*GetTypeComp)(ITypeInfo *This, ITypeComp * *pptcomp);HRESULT (*GetFuncDesc)(ITypeInfo *This, unsigned int index, FUNCDESC * *ppfuncdesc);HRESULT (*GetVarDesc)(ITypeInfo *This, unsigned int index, VARDESC * *ppvardesc);HRESULT (*GetNames)(ITypeInfo *This, MEMBERID memid, BSTR *rgbstrNames, unsigned int cMaxNames, unsigned int *pcNames);HRESULT (*GetRefTypeOfImplType)(ITypeInfo *This, unsigned int index, HREFTYPE *phreftype);HRESULT (*GetImplTypeFlags)(ITypeInfo *This, unsigned int index, int *pimpltypeflags);HRESULT (*GetIDsOfNames)(ITypeInfo *This, char * *rgszNames, unsigned int cNames, MEMBERID *rgmemid);HRESULT (*Invoke)(ITypeInfo *This, void *pvInstance, MEMBERID memid, unsigned int wFlags, DISPPARAMS *pdispparams, VARIANT *pvarResult, EXCEPINFO *pexcepinfo, unsigned int *puArgErr);HRESULT (*GetDocumentation)(ITypeInfo *This, MEMBERID memid, BSTR *pbstrName, BSTR *pbstrDocString, unsigned __int32 *pdwHelpContext, BSTR *pbstrHelpFile);HRESULT (*GetDllEntry)(ITypeInfo *This, MEMBERID memid, INVOKEKIND invkind, BSTR *pbstrDllName, BSTR *pbstrName, unsigned int *pwOrdinal);HRESULT (*GetRefTypeInfo)(ITypeInfo *This, HREFTYPE hreftype, ITypeInfo * *pptinfo);HRESULT (*AddressOfMember)(ITypeInfo *This, MEMBERID memid, INVOKEKIND invkind, void * *ppv);HRESULT (*CreateInstance)(ITypeInfo *This, IUnknown *punkOuter, const IID *const riid, void * *ppvObj);HRESULT (*GetMops)(ITypeInfo *This, MEMBERID memid, BSTR *pbstrMops);HRESULT (*GetContainingTypeLib)(ITypeInfo *This, ITypeLib * *pptlib, unsigned int *pindex);void (*ReleaseTypeAttr)(ITypeInfo *This, TYPEATTR *ptypeattr);void (*ReleaseFuncDesc)(ITypeInfo *This, FUNCDESC *pfuncdesc);void (*ReleaseVarDesc)(ITypeInfo *This, VARDESC *pvardesc);};
...
typedef HKEY *PHKEY;
typedef HGLOBAL (__pascal *LPFNLOADRES)(LPSTR szType, LPSTR szId);
...
typedef BOOL (__pascal *LPFNSTYLE)(HWND hWnd, HGLOBAL hCntlStyle, LPFNSTRTOID lpfnSID, LPFNIDTOSTR lpfnIDS);
typedef HGLOBAL (__pascal *LPFNLIST)(LPCSTR szAppName, UINT wVersion, LPFNLOADRES fnLoad, LPFNEDITRES fnEdit);
...
typedef HGLOBAL (__pascal *LPFNINFO)();
