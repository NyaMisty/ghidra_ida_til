#define GHIDRA
#ifndef INCLUDE_GUARD_ntapi64_xp_til
#define INCLUDE_GUARD_ntapi64_xp_til
...
union _INITIAL_PEB___DF260F62E8B3AA6DC83748CE4B477B40;
...
typedef struct _Wx86ThreadState *PWx86ThreadState;
...
enum MACRO__WIN32_IE {_WIN32_IE = 1536,};
...
typedef struct _Wx86ThreadState Wx86ThreadState;
...
enum _KTHREAD_STATE {Initialized = 0x0,Ready = 0x1,Running = 0x2,Standby = 0x3,Terminated = 0x4,Waiting = 0x5,Transition = 0x6,DeferredReady = 0x7,};
...
enum MACRO_NUM_CM {NUM_CM_PROB_V1 = 0x25,NUM_CM_PROB_V2 = 0x32,NUM_CM_PROB_V3 = 0x33,NUM_CM_PROB_V4 = 0x34,NUM_CM_PROB_V5 = 0x35,NUM_CM_PROB = 0x32,};
...
union _INITIAL_PEB___DF260F62E8B3AA6DC83748CE4B477B40 {BOOLEAN BitField;BOOLEAN SpareBool;};
...
struct _ACTIVATION_CONTEXT_STACK {ULONG Flags;ULONG NextCookieSequenceNumber;struct _RTL_ACTIVATION_CONTEXT_STACK_FRAME *ActiveFrame;LIST_ENTRY FrameListCache;};
...
struct _INITIAL_PEB {BOOLEAN InheritedAddressSpace;BOOLEAN ReadImageFileExecOptions;BOOLEAN BeingDebugged;_INITIAL_PEB___DF260F62E8B3AA6DC83748CE4B477B40 __anonymous0;HANDLE Mutant;};
...
struct _Wx86ThreadState {PULONG CallBx86Eip;PVOID DeallocationCpu;BOOLEAN UseKnownWx86Dll;CHAR OleStubInvoked;};
