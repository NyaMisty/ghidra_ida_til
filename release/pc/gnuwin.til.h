#define GHIDRA
#ifndef INCLUDE_GUARD_gnuwin_til
#define INCLUDE_GUARD_gnuwin_til
...
struct _IMAGE_RESOURCE_DIRECTORY_ENTRY___2D36EF4657A2B130C0422CAF150A0160___B2E03ED94C06E2E681F8D03FF7FF5CB3 {unsigned __int32 OffsetToDirectory : 31;unsigned __int32 DataIsDirectory : 1;};
struct _IMAGE_RESOURCE_DIRECTORY_ENTRY___444826C0724C63C16186AAF04EE0E133___6E35CCFC02D81E31BD4C6BEDD77CB20A {unsigned __int32 NameOffset : 31;unsigned __int32 NameIsString : 1;};
...
struct _MIDL_FORMAT_STRING {__int16 Pad;unsigned __int8 Format[1];};
...
struct tagCStdStubBuffer {const struct IRpcStubBufferVtbl *lpVtbl;int RefCount;struct IUnknown *pvServerObject;};
...
typedef unsigned __int8 byte;
struct rdop {__int16 rd_op;unsigned int rd_parm;};
typedef unsigned int uint;
...
typedef void (*RPC_AUTH_KEY_RETRIEVAL_FN)(void *, unsigned __int16 *, unsigned int, void **, RPC_STATUS *);
...
struct tagCStdPSFactoryBuffer {const IPSFactoryBufferVtbl *lpVtbl;int RefCount;const ProxyFileInfo **pProxyFileList;int Filler1;};
...
struct _RPC_TRANSFER_SYNTAX {GUID Uuid;unsigned __int16 VersMajor;unsigned __int16 VersMinor;};
...
struct tagCAUB {ULONG cElems;unsigned __int8 *pElems;};
...
struct tagCAI {ULONG cElems;__int16 *pElems;};
...
struct _MIDL_STUBLESS_PROXY_INFO {PMIDL_STUB_DESC pStubDesc;PFORMAT_STRING ProcFormatString;const unsigned __int16 *FormatStringOffset;};
...
typedef int RPC_FORWARD_FUNCTION(GUID *, RPC_VERSION *, GUID *, unsigned __int8 *, void **);
...
struct _OLESTREAMVTBL {DWORD (*Get)(LPOLESTREAM, void *, DWORD);DWORD (*Put)(LPOLESTREAM, const void *, DWORD);};
...
typedef DWORD (*LPFN_WSAWAITFORMULTIPLEEVENTS)(DWORD, const HANDLE *, BOOL, DWORD, BOOL);
...
struct tagCInterfaceStubHeader {const IID *piid;const MIDL_SERVER_INFO *pServerInfo;unsigned int DispatchTableCount;const PRPC_STUB_FUNCTION *pDispatchTable;};
...
struct _RPC_CLIENT_INTERFACE {unsigned int Length;RPC_SYNTAX_IDENTIFIER InterfaceId;RPC_SYNTAX_IDENTIFIER TransferSyntax;PRPC_DISPATCH_TABLE DispatchTable;unsigned int RpcProtseqEndpointCount;PRPC_PROTSEQ_ENDPOINT RpcProtseqEndpoint;unsigned int Reserved;const void *InterpreterInfo;};
struct _RPC_SERVER_INTERFACE {unsigned int Length;RPC_SYNTAX_IDENTIFIER InterfaceId;RPC_SYNTAX_IDENTIFIER TransferSyntax;PRPC_DISPATCH_TABLE DispatchTable;unsigned int RpcProtseqEndpointCount;PRPC_PROTSEQ_ENDPOINT RpcProtseqEndpoint;void *DefaultManagerEpv;const void *InterpreterInfo;};
...
typedef int (*LPFN_WSACONNECT)(SOCKET, const struct sockaddr *, int, LPWSABUF, LPWSABUF, LPQOS, LPQOS);
...
struct _devicemodeW {WCHAR dmDeviceName[32];WORD dmSpecVersion;WORD dmDriverVersion;WORD dmSize;WORD dmDriverExtra;DWORD dmFields;__int16 dmOrientation;__int16 dmPaperSize;__int16 dmPaperLength;__int16 dmPaperWidth;__int16 dmScale;__int16 dmCopies;__int16 dmDefaultSource;__int16 dmPrintQuality;__int16 dmColor;__int16 dmDuplex;__int16 dmYResolution;__int16 dmTTOption;__int16 dmCollate;WCHAR dmFormName[32];WORD dmLogPixels;DWORD dmBitsPerPel;DWORD dmPelsWidth;DWORD dmPelsHeight;DWORD dmDisplayFlags;DWORD dmDisplayFrequency;DWORD dmICMMethod;DWORD dmICMIntent;DWORD dmMediaType;DWORD dmDitherType;DWORD dmICCManufacturer;DWORD dmICCModel;};
...
struct ISequentialStreamVtbl {HRESULT (*QueryInterface)(ISequentialStream *, const IID *const, PVOID *);ULONG (*AddRef)(ISequentialStream *);ULONG (*Release)(ISequentialStream *);HRESULT (*Read)(ISequentialStream *, void *, ULONG, ULONG *);HRESULT (*Write)(ISequentialStream *, const void *, ULONG, ULONG *);};
struct ISupportErrorInfoVtbl {HRESULT (*QueryInterface)(ISupportErrorInfo *, const IID *const, PVOID *);ULONG (*AddRef)(ISupportErrorInfo *);ULONG (*Release)(ISupportErrorInfo *);HRESULT (*InterfaceSupportsErrorInfo)(ISupportErrorInfo *, const IID *const);};
...
struct IRpcProxyBufferVtbl {HRESULT (*QueryInterface)(IRpcProxyBuffer *, const IID *const, PVOID *);ULONG (*AddRef)(IRpcProxyBuffer *);ULONG (*Release)(IRpcProxyBuffer *);HRESULT (*Connect)(IRpcProxyBuffer *, IRpcChannelBuffer *);void (*Disconnect)(IRpcProxyBuffer *);};
...
typedef HRESULT (*LPFNGETCLASSOBJECT)(const CLSID *const, const IID *const, PVOID *);
...
struct _MIDL_SERVER_INFO_ {PMIDL_STUB_DESC pStubDesc;const SERVER_ROUTINE *DispatchTable;PFORMAT_STRING ProcString;const unsigned __int16 *FmtStringOffset;const STUB_THUNK *ThunkTable;};
struct _MIDL_STUB_MESSAGE {PRPC_MESSAGE RpcMsg;unsigned __int8 *Buffer;unsigned __int8 *BufferStart;unsigned __int8 *BufferEnd;unsigned __int8 *BufferMark;unsigned int BufferLength;unsigned int MemorySize;unsigned __int8 *Memory;int IsClient;int ReuseBuffer;unsigned __int8 *AllocAllNodesMemory;unsigned __int8 *AllocAllNodesMemoryEnd;int IgnoreEmbeddedPointers;unsigned __int8 *PointerBufferMark;unsigned __int8 fBufferValid;unsigned __int8 Unused;unsigned int MaxCount;unsigned int Offset;unsigned int ActualCount;void *(*pfnAllocate)(unsigned int);void (*pfnFree)(void *);unsigned __int8 *StackTop;unsigned __int8 *pPresentedType;unsigned __int8 *pTransmitType;handle_t SavedHandle;const struct _MIDL_STUB_DESC *StubDesc;struct _FULL_PTR_XLAT_TABLES *FullPtrXlatTables;unsigned int FullPtrRefId;int fCheckBounds;__int32 fInDontFree : 1;__int32 fDontCallFreeInst : 1;__int32 fInOnlyParam : 1;__int32 fHasReturn : 1;unsigned int dwDestContext;void *pvDestContext;NDR_SCONTEXT *SavedContextHandles;int ParamNumber;struct IRpcChannelBuffer *pRpcChannelBuffer;PARRAY_INFO pArrayInfo;unsigned int *SizePtrCountArray;unsigned int *SizePtrOffsetArray;unsigned int *SizePtrLengthArray;void *pArgQueue;unsigned int dwStubPhase;unsigned int Reserved[5];};
...
struct IEnumMonikerVtbl {HRESULT (*QueryInterface)(IEnumMoniker *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumMoniker *);ULONG (*Release)(IEnumMoniker *);HRESULT (*Next)(IEnumMoniker *, ULONG, struct IMoniker *, ULONG *);HRESULT (*Skip)(IEnumMoniker *, ULONG);HRESULT (*Reset)(IEnumMoniker *);HRESULT (*Clone)(IEnumMoniker *, IEnumMoniker **);};
struct IEnumUnknownVtbl {HRESULT (*QueryInterface)(IEnumUnknown *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumUnknown *);ULONG (*Release)(IEnumUnknown *);HRESULT (*Next)(IEnumUnknown *, ULONG, IUnknown **, ULONG *);HRESULT (*Skip)(IEnumUnknown *, ULONG);HRESULT (*Reset)(IEnumUnknown *);HRESULT (*Clone)(IEnumUnknown *, IEnumUnknown **);};
typedef SOCKET (*LPFN_WSAJOINLEAF)(SOCKET, const struct sockaddr *, int, LPWSABUF, LPWSABUF, LPQOS, LPQOS, DWORD);
...
struct IUnknownVtbl {HRESULT (*QueryInterface)(IUnknown *, const IID *const, PVOID *);ULONG (*AddRef)(IUnknown *);ULONG (*Release)(IUnknown *);};
...
struct IMallocVtbl {HRESULT (*QueryInterface)(IMalloc *, const IID *const, PVOID *);ULONG (*AddRef)(IMalloc *);ULONG (*Release)(IMalloc *);void *(*Alloc)(IMalloc *, ULONG);void (*ReAlloc)(IMalloc *, void *);void *(*Free)(IMalloc *, void *);ULONG (*GetSize)(IMalloc *, void *);int (*DidAlloc)(IMalloc *, void *);void (*HeapMinimize)(IMalloc *);};
...
struct ISpecifyPropertyPagesVtbl {HRESULT (*QueryInterface)(ISpecifyPropertyPages *, const IID *const, PVOID *);ULONG (*AddRef)(ISpecifyPropertyPages *);ULONG (*Release)(ISpecifyPropertyPages *);HRESULT (*GetPages)(ISpecifyPropertyPages *, CAUUID *);};
typedef INT (*LPFN_WSASTRINGTOADDRESSA)(LPSTR, INT, LPWSAPROTOCOL_INFOA, LPSOCKADDR, LPINT);
struct IEnumSTATPROPSETSTGVtbl {HRESULT (*QueryInterface)(IEnumSTATPROPSETSTG *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumSTATPROPSETSTG *);ULONG (*Release)(IEnumSTATPROPSETSTG *);HRESULT (*Next)(IEnumSTATPROPSETSTG *, ULONG, STATPROPSETSTG *, ULONG *);HRESULT (*Skip)(IEnumSTATPROPSETSTG *, ULONG);HRESULT (*Reset)(IEnumSTATPROPSETSTG *);HRESULT (*Clone)(IEnumSTATPROPSETSTG *, IEnumSTATPROPSETSTG **);};
struct IPropertyNotifySinkVtbl {HRESULT (*QueryInterface)(IPropertyNotifySink *, const IID *const, PVOID *);ULONG (*AddRef)(IPropertyNotifySink *);ULONG (*Release)(IPropertyNotifySink *);HRESULT (*OnChanged)(IPropertyNotifySink *, DISPID);HRESULT (*OnRequestEdit)(IPropertyNotifySink *, DISPID);};
struct IShellExecuteHookAVtbl {HRESULT (*QueryInterface)(IShellExecuteHookA *, const IID *const, PVOID *);ULONG (*AddRef)(IShellExecuteHookA *);ULONG (*Release)(IShellExecuteHookA *);HRESULT (*Execute)(IShellExecuteHookA *, LPSHELLEXECUTEINFOA);};
struct IShellExecuteHookWVtbl {HRESULT (*QueryInterface)(IShellExecuteHookW *, const IID *const, PVOID *);ULONG (*AddRef)(IShellExecuteHookW *);ULONG (*Release)(IShellExecuteHookW *);HRESULT (*Execute)(IShellExecuteHookW *, LPSHELLEXECUTEINFOW);};
struct IProvideClassInfoVtbl {HRESULT (*QueryInterface)(IProvideClassInfo *, const IID *const, PVOID *);ULONG (*AddRef)(IProvideClassInfo *);ULONG (*Release)(IProvideClassInfo *);HRESULT (*GetClassInfoA)(IProvideClassInfo *, LPTYPEINFO *);};
struct IEnumSTATPROPSTGVtbl {HRESULT (*QueryInterface)(IEnumSTATPROPSTG *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumSTATPROPSTG *);ULONG (*Release)(IEnumSTATPROPSTG *);HRESULT (*Next)(IEnumSTATPROPSTG *, ULONG, STATPROPSTG *, ULONG *);HRESULT (*Skip)(IEnumSTATPROPSTG *, ULONG);HRESULT (*Reset)(IEnumSTATPROPSTG *);HRESULT (*Clone)(IEnumSTATPROPSTG *, IEnumSTATPROPSTG **);};
struct ICommDlgBrowserVtbl {HRESULT (*QueryInterface)(ICommDlgBrowser *, const IID *const, PVOID *);ULONG (*AddRef)(ICommDlgBrowser *);ULONG (*Release)(ICommDlgBrowser *);HRESULT (*OnDefaultCommand)(ICommDlgBrowser *);HRESULT (*OnStateChange)(ICommDlgBrowser *, ULONG);HRESULT (*IncludeObject)(ICommDlgBrowser *, LPCITEMIDLIST);};
struct IFileViewerSiteVtbl {HRESULT (*QueryInterface)(IFileViewerSite *, const IID *const, PVOID *);ULONG (*AddRef)(IFileViewerSite *);ULONG (*Release)(IFileViewerSite *);HRESULT (*SetPinnedWindow)(IFileViewerSite *, HWND);HRESULT (*GetPinnedWindow)(IFileViewerSite *, HWND *);};
...
struct IEnumFORMATETCVtbl {HRESULT (*QueryInterface)(IEnumFORMATETC *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumFORMATETC *);ULONG (*Release)(IEnumFORMATETC *);HRESULT (*Next)(IEnumFORMATETC *, ULONG, FORMATETC *, ULONG *);HRESULT (*Skip)(IEnumFORMATETC *, ULONG);HRESULT (*Reset)(IEnumFORMATETC *);HRESULT (*Clone)(IEnumFORMATETC *, IEnumFORMATETC **);};
struct IEnumSTATDATAVtbl {HRESULT (*QueryInterface)(IEnumSTATDATA *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumSTATDATA *);ULONG (*Release)(IEnumSTATDATA *);HRESULT (*Next)(IEnumSTATDATA *, ULONG, STATDATA *, ULONG *);HRESULT (*Skip)(IEnumSTATDATA *, ULONG);HRESULT (*Reset)(IEnumSTATDATA *);HRESULT (*Clone)(IEnumSTATDATA *, IEnumSTATDATA **);};
...
struct IEnumOLEVERBVtbl {HRESULT (*QueryInterface)(IEnumOLEVERB *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumOLEVERB *);ULONG (*Release)(IEnumOLEVERB *);HRESULT (*Next)(IEnumOLEVERB *, ULONG, OLEVERB *, ULONG *);HRESULT (*Skip)(IEnumOLEVERB *, ULONG);HRESULT (*Reset)(IEnumOLEVERB *);HRESULT (*Clone)(IEnumOLEVERB *, IEnumOLEVERB **);};
struct IEnumSTATSTGVtbl {HRESULT (*QueryInterface)(IEnumSTATSTG *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumSTATSTG *);ULONG (*Release)(IEnumSTATSTG *);HRESULT (*Next)(IEnumSTATSTG *, ULONG, STATSTG *, ULONG *);HRESULT (*Skip)(IEnumSTATSTG *, ULONG);HRESULT (*Reset)(IEnumSTATSTG *);HRESULT (*Clone)(IEnumSTATSTG *, IEnumSTATSTG **);};
struct IEnumVARIANTVtbl {HRESULT (*QueryInterface)(IEnumVARIANT *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumVARIANT *);ULONG (*Release)(IEnumVARIANT *);HRESULT (*Next)(IEnumVARIANT *, ULONG, VARIANT *, ULONG *);HRESULT (*Skip)(IEnumVARIANT *, ULONG);HRESULT (*Reset)(IEnumVARIANT *);HRESULT (*Clone)(IEnumVARIANT *, IEnumVARIANT **);};
...
struct IEnumHLITEMVtbl {HRESULT (*QueryInterface)(IEnumHLITEM *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumHLITEM *);ULONG (*Release)(IEnumHLITEM *);HRESULT (*Next)(IEnumHLITEM *, ULONG, HLITEM *, ULONG *);HRESULT (*Skip)(IEnumHLITEM *, ULONG);HRESULT (*Reset)(IEnumHLITEM *);HRESULT (*Clone)(IEnumHLITEM *, IEnumHLITEM **);};
struct IEnumIDListVtbl {HRESULT (*QueryInterface)(IEnumIDList *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumIDList *);ULONG (*Release)(IEnumIDList *);HRESULT (*Next)(IEnumIDList *, ULONG, LPITEMIDLIST *, ULONG *);HRESULT (*Skip)(IEnumIDList *, ULONG);HRESULT (*Reset)(IEnumIDList *);HRESULT (*Clone)(IEnumIDList *, IEnumIDList **);};
typedef BOOL (*PROPENUMPROCEXA)(HWND, LPSTR, HANDLE, DWORD);
struct _SV2CVW2_PARAMS {DWORD cbSize;IShellView *psvPrev;const FOLDERSETTINGS *pfs;IShellBrowser *psbOwner;RECT *prcView;const SHELLVIEWID *pvid;HWND hwndView;};
struct tagCWPRETSTRUCT {LRESULT lResult;LPARAM lParam;WPARAM wParam;DWORD message;HWND hwnd;};
struct IMallocSpyVtbl {HRESULT (*QueryInterface)(IMallocSpy *, const IID *const, PVOID *);ULONG (*AddRef)(IMallocSpy *);ULONG (*Release)(IMallocSpy *);ULONG (*PreAlloc)(IMallocSpy *, ULONG);void *(*PostAlloc)(IMallocSpy *, void *);void *(*PreFree)(IMallocSpy *, void *, BOOL);void (*PostFree)(IMallocSpy *, BOOL);ULONG (*PreRealloc)(IMallocSpy *, void *, ULONG, void *);void *(*PostRealloc)(IMallocSpy *, void *, BOOL);void *(*PreGetSize)(IMallocSpy *, void *, BOOL);ULONG (*PostGetSize)(IMallocSpy *, ULONG, BOOL);void *(*PreDidAlloc)(IMallocSpy *, void *, BOOL);int (*PostDidAlloc)(IMallocSpy *, void *, BOOL, int);void (*PreHeapMinimize)(IMallocSpy *);void (*PostHeapMinimize)(IMallocSpy *);};
...
struct IROTDataVtbl {HRESULT (*QueryInterface)(IROTData *, const IID *const, PVOID *);ULONG (*AddRef)(IROTData *);ULONG (*Release)(IROTData *);HRESULT (*GetComparisonData)(IROTData *, PVOID, ULONG, PULONG);};
...
struct IConnectionPointContainerVtbl {HRESULT (*QueryInterface)(IConnectionPointContainer *, const IID *const, PVOID *);ULONG (*AddRef)(IConnectionPointContainer *);ULONG (*Release)(IConnectionPointContainer *);HRESULT (*EnumConnectionPoints)(IConnectionPointContainer *, LPENUMCONNECTIONPOINTS *);HRESULT (*FindConnectionPoint)(IConnectionPointContainer *, const IID *const, LPCONNECTIONPOINT *);};
typedef BOOL (*PREAD_PROCESS_MEMORY_ROUTINE)(HANDLE, LPCVOID, LPVOID, DWORD, LPDWORD);
struct IEnumConnectionPointsVtbl {HRESULT (*QueryInterface)(IEnumConnectionPoints *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumConnectionPoints *);ULONG (*Release)(IEnumConnectionPoints *);HRESULT (*Next)(IEnumConnectionPoints *, ULONG, LPCONNECTIONPOINT *, ULONG *);HRESULT (*Skip)(IEnumConnectionPoints *, ULONG);HRESULT (*Reset)(IEnumConnectionPoints *);HRESULT (*Clone)(IEnumConnectionPoints *, LPENUMCONNECTIONPOINTS *);};
typedef INT (*LPFN_WSAADDRESSTOSTRINGA)(LPSOCKADDR, DWORD, LPWSAPROTOCOL_INFOA, LPSTR, LPDWORD);
struct IExternalConnectionVtbl {HRESULT (*QueryInterface)(IExternalConnection *, const IID *const, PVOID *);ULONG (*AddRef)(IExternalConnection *);ULONG (*Release)(IExternalConnection *);HRESULT (*AddConnection)(IExternalConnection *, DWORD, DWORD);HRESULT (*ReleaseConnection)(IExternalConnection *, DWORD, DWORD, BOOL);};
struct IProgressNotifyVtbl {HRESULT (*QueryInterface)(IProgressNotify *, const IID *const, PVOID *);ULONG (*AddRef)(IProgressNotify *);ULONG (*Release)(IProgressNotify *);HRESULT (*OnProgress)(IProgressNotify *, DWORD, DWORD, BOOL, BOOL);};
struct IStdMarshalInfoVtbl {HRESULT (*QueryInterface)(IStdMarshalInfo *, const IID *const, PVOID *);ULONG (*AddRef)(IStdMarshalInfo *);ULONG (*Release)(IStdMarshalInfo *);HRESULT (*GetClassForHandler)(IStdMarshalInfo *, DWORD, PVOID, CLSID *);};
struct IPersistFolderVtbl {HRESULT (*QueryInterface)(IPersistFolder *, const IID *const, PVOID *);ULONG (*AddRef)(IPersistFolder *);ULONG (*Release)(IPersistFolder *);HRESULT (*GetClassID)(IPersistFolder *, CLSID);HRESULT (*Initialize)(IPersistFolder *, LPCITEMIDLIST);};
...
struct IClassFactoryVtbl {HRESULT (*QueryInterface)(IClassFactory *, const IID *const, PVOID *);ULONG (*AddRef)(IClassFactory *);ULONG (*Release)(IClassFactory *);HRESULT (*CreateInstance)(IClassFactory *, LPUNKNOWN, const IID *const, PVOID *);HRESULT (*LockServer)(IClassFactory *, BOOL);};
...
struct IDropSourceVtbl {HRESULT (*QueryInterface)(IDropSource *, const IID *const, PVOID *);ULONG (*AddRef)(IDropSource *);ULONG (*Release)(IDropSource *);HRESULT (*QueryContinueDrag)(IDropSource *, BOOL, DWORD);HRESULT (*GiveFeedback)(IDropSource *, DWORD);};
...
struct IOleWindowVtbl {HRESULT (*QueryInterface)(IOleWindow *, const IID *const, PVOID *);ULONG (*AddRef)(IOleWindow *);ULONG (*Release)(IOleWindow *);HRESULT (*GetWindow)(IOleWindow *, HWND *);HRESULT (*ContextSensitiveHelp)(IOleWindow *, BOOL);};
typedef int (*LPFN_WSASENDTO)(SOCKET, LPWSABUF, DWORD, LPDWORD, DWORD, const struct sockaddr *, int, LPWSAOVERLAPPED, LPWSAOVERLAPPED_COMPLETION_ROUTINE);
...
struct IProvideClassInfo2Vtbl {HRESULT (*QueryInterface)(IProvideClassInfo2 *, const IID *const, PVOID *);ULONG (*AddRef)(IProvideClassInfo2 *);ULONG (*Release)(IProvideClassInfo2 *);HRESULT (*GetClassInfoA)(IProvideClassInfo2 *, LPTYPEINFO *);HRESULT (*GetGUID)(IProvideClassInfo2 *, DWORD, GUID *);};
struct IShellPropSheetExtVtbl {HRESULT (*QueryInterface)(IShellPropSheetExt *, const IID *const, PVOID *);ULONG (*AddRef)(IShellPropSheetExt *);ULONG (*Release)(IShellPropSheetExt *);HRESULT (*AddPages)(IShellPropSheetExt *, LPFNADDPROPSHEETPAGE, LPARAM);HRESULT (*ReplacePage)(IShellPropSheetExt *, UINT, LPFNADDPROPSHEETPAGE, LPARAM);};
struct IDataAdviseHolderVtbl {HRESULT (*QueryInterface)(IDataAdviseHolder *, const IID *const, PVOID *);ULONG (*AddRef)(IDataAdviseHolder *);ULONG (*Release)(IDataAdviseHolder *);HRESULT (*Advise)(IDataAdviseHolder *, IDataObject *, FORMATETC *, DWORD, IAdviseSink *, PDWORD);HRESULT (*Unadvise)(IDataAdviseHolder *, DWORD);HRESULT (*EnumAdvise)(IDataAdviseHolder *, IEnumSTATDATA **);HRESULT (*SendOnDataChange)(IDataAdviseHolder *, IDataObject *, DWORD, DWORD);};
struct IRpcChannelBufferVtbl {HRESULT (*QueryInterface)(IRpcChannelBuffer *, const IID *const, PVOID *);ULONG (*AddRef)(IRpcChannelBuffer *);ULONG (*Release)(IRpcChannelBuffer *);HRESULT (*GetBuffer)(IRpcChannelBuffer *, RPCOLEMESSAGE *, const IID *const);HRESULT (*SendReceive)(IRpcChannelBuffer *, RPCOLEMESSAGE *, PULONG);HRESULT (*FreeBuffer)(IRpcChannelBuffer *, RPCOLEMESSAGE *);HRESULT (*GetDestCtx)(IRpcChannelBuffer *, PDWORD, PVOID *);HRESULT (*IsConnected)(IRpcChannelBuffer *);};
struct IEnumConnectionsVtbl {HRESULT (*QueryInterface)(IEnumConnections *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumConnections *);ULONG (*Release)(IEnumConnections *);HRESULT (*Next)(IEnumConnections *, ULONG, LPCONNECTDATA, PULONG);HRESULT (*Skip)(IEnumConnections *, ULONG);HRESULT (*Reset)(IEnumConnections *);HRESULT (*Clone)(IEnumConnections *, LPENUMCONNECTIONS *);};
struct IPSFactoryBufferVtbl {HRESULT (*QueryInterface)(IPSFactoryBuffer *, const IID *const, PVOID *);ULONG (*AddRef)(IPSFactoryBuffer *);ULONG (*Release)(IPSFactoryBuffer *);HRESULT (*CreateProxy)(IPSFactoryBuffer *, LPUNKNOWN, const IID *const, LPRPCPROXYBUFFER *, PVOID *);HRESULT (*CreateStub)(IPSFactoryBuffer *, const IID *const, LPUNKNOWN, LPRPCSTUBBUFFER *);};
...
struct IClassActivatorVtbl {HRESULT (*QueryInterface)(IClassActivator *, const IID *const, PVOID *);ULONG (*AddRef)(IClassActivator *);ULONG (*Release)(IClassActivator *);HRESULT (*GetClassObject)(IClassActivator *, const CLSID *const, DWORD, LCID, const IID *const, PVOID *);};
struct IPersistStorageVtbl {HRESULT (*QueryInterface)(IPersistStorage *, const IID *const, PVOID *);ULONG (*AddRef)(IPersistStorage *);ULONG (*Release)(IPersistStorage *);HRESULT (*GetClassID)(IPersistStorage *, CLSID);HRESULT (*IsDirty)(IPersistStorage *);HRESULT (*InitNew)(IPersistStorage *, LPSTORAGE);HRESULT (*Load)(IPersistStorage *, LPSTORAGE);HRESULT (*Save)(IPersistStorage *, LPSTORAGE, BOOL);HRESULT (*SaveCompleted)(IPersistStorage *, LPSTORAGE);HRESULT (*HandsOffStorage)(IPersistStorage *);};
...
struct IFillLockBytesVtbl {HRESULT (*QueryInterface)(IFillLockBytes *, const IID *const, PVOID *);ULONG (*AddRef)(IFillLockBytes *);ULONG (*Release)(IFillLockBytes *);HRESULT (*FillAppend)(IFillLockBytes *, const void *, ULONG, PULONG);HRESULT (*FillAt)(IFillLockBytes *, ULARGE_INTEGER, const void *, ULONG, PULONG);HRESULT (*SetFillSize)(IFillLockBytes *, ULARGE_INTEGER);HRESULT (*Terminate)(IFillLockBytes *, BOOL);};
struct IMessageFilterVtbl {HRESULT (*QueryInterface)(IMessageFilter *, const IID *const, PVOID *);ULONG (*AddRef)(IMessageFilter *);ULONG (*Release)(IMessageFilter *);DWORD (*HandleInComingCall)(IMessageFilter *, DWORD, HTASK, DWORD, LPINTERFACEINFO);DWORD (*RetryRejectedCall)(IMessageFilter *, HTASK, DWORD, DWORD);DWORD (*MessagePending)(IMessageFilter *, HTASK, DWORD, DWORD);};
struct IPersistStreamVtbl {HRESULT (*QueryInterface)(IPersistStream *, const IID *const, PVOID *);ULONG (*AddRef)(IPersistStream *);ULONG (*Release)(IPersistStream *);HRESULT (*GetClassID)(IPersistStream *, CLSID *);HRESULT (*IsDirty)(IPersistStream *);HRESULT (*Load)(IPersistStream *, IStream *);HRESULT (*Save)(IPersistStream *, IStream *, BOOL);HRESULT (*GetSizeMax)(IPersistStream *, PULARGE_INTEGER);};
struct IRpcStubBufferVtbl {HRESULT (*QueryInterface)(IRpcStubBuffer *, const IID *const, PVOID *);ULONG (*AddRef)(IRpcStubBuffer *);ULONG (*Release)(IRpcStubBuffer *);HRESULT (*Connect)(IRpcStubBuffer *, LPUNKNOWN);void (*Disconnect)(IRpcStubBuffer *);HRESULT (*Invoke)(IRpcStubBuffer *, RPCOLEMESSAGE *, LPRPCSTUBBUFFER);LPRPCSTUBBUFFER (*IsIIDSupported)(IRpcStubBuffer *, const IID *const);ULONG (*CountRefs)(IRpcStubBuffer *);HRESULT (*DebugServerQueryInterface)(IRpcStubBuffer *, PVOID *);HRESULT (*DebugServerRelease)(IRpcStubBuffer *, PVOID);};
struct IShellExtInitVtbl {HRESULT (*QueryInterface)(IShellExtInit *, const IID *const, PVOID *);ULONG (*AddRef)(IShellExtInit *);ULONG (*Release)(IShellExtInit *);HRESULT (*Initialize)(IShellExtInit *, LPCITEMIDLIST, LPDATAOBJECT, HKEY);};
struct IChannelHookVtbl {HRESULT (*QueryInterface)(IChannelHook *, const IID *const, PVOID *);ULONG (*AddRef)(IChannelHook *);ULONG (*Release)(IChannelHook *);void (*ClientGetSize)(IChannelHook *, const GUID *const, const IID *const, PULONG);void (*ClientFillBuffer)(IChannelHook *, const GUID *const, const IID *const, PULONG, PVOID);void (*ClientNotify)(IChannelHook *, const GUID *const, const IID *const, ULONG, PVOID, DWORD, HRESULT);void (*ServerNotify)(IChannelHook *, const GUID *const, const IID *const, ULONG, PVOID, DWORD);void (*ServerGetSize)(IChannelHook *, const GUID *const, const IID *const, HRESULT, PULONG);void (*ServerFillBuffer)(IChannelHook *, const GUID *const, const IID *const, PULONG, PVOID, HRESULT);};
...
struct IMarshalVtbl {HRESULT (*QueryInterface)(IMarshal *, const IID *const, PVOID *);ULONG (*AddRef)(IMarshal *);ULONG (*Release)(IMarshal *);HRESULT (*GetUnmarshalClass)(IMarshal *, const IID *const, DWORD, PVOID, DWORD, CLSID);HRESULT (*GetMarshalSizeMax)(IMarshal *, const IID *const, DWORD, PVOID, DWORD, PDWORD);HRESULT (*MarshalInterface)(IMarshal *, const IID *const, DWORD, DWORD);HRESULT (*UnmarshalInterface)(IMarshal *, IStream *, void **);HRESULT (*ReleaseMarshalData)(IMarshal *, IStream *);HRESULT (*DisconnectObject)(IMarshal *, DWORD);};
...
struct IUniformResourceLocatorVtbl {HRESULT (*QueryInterface)(IUniformResourceLocator *, const IID *const, PVOID *);ULONG (*AddRef)(IUniformResourceLocator *);ULONG (*Release)(IUniformResourceLocator *);HRESULT (*SetURL)(IUniformResourceLocator *, PCSTR, DWORD);HRESULT (*GetURL)(IUniformResourceLocator *, PSTR *);HRESULT (*InvokeCommand)(IUniformResourceLocator *, PURLINVOKECOMMANDINFO);};
...
struct IAdviseSink2Vtbl {HRESULT (*QueryInterface)(IAdviseSink2 *, const IID *const, PVOID *);ULONG (*AddRef)(IAdviseSink2 *);ULONG (*Release)(IAdviseSink2 *);void (*OnDataChange)(IAdviseSink2 *, FORMATETC *, STGMEDIUM *);void (*OnViewChange)(IAdviseSink2 *, DWORD, LONG);void (*OnRename)(IAdviseSink2 *, IMoniker *);void (*OnSave)(IAdviseSink2 *);void (*OnClose)(IAdviseSink2 *);void (*OnLinkSrcChange)(IAdviseSink2 *, IMoniker *);};
struct IAdviseSinkVtbl {HRESULT (*QueryInterface)(IAdviseSink *, const IID *const, PVOID *);ULONG (*AddRef)(IAdviseSink *);ULONG (*Release)(IAdviseSink *);void (*OnDataChange)(IAdviseSink *, FORMATETC *, STGMEDIUM *);void (*OnViewChange)(IAdviseSink *, DWORD, LONG);void (*OnRename)(IAdviseSink *, IMoniker *);void (*OnSave)(IAdviseSink *);void (*OnClose)(IAdviseSink *);};
struct IDropTargetVtbl {HRESULT (*QueryInterface)(IDropTarget *, const IID *const, PVOID *);ULONG (*AddRef)(IDropTarget *);ULONG (*Release)(IDropTarget *);HRESULT (*DragEnter)(IDropTarget *, LPDATAOBJECT, DWORD, POINTL, PDWORD);HRESULT (*DragOver)(IDropTarget *, DWORD, POINTL, PDWORD);HRESULT (*DragLeave)(IDropTarget *);HRESULT (*Drop)(IDropTarget *, LPDATAOBJECT, DWORD, POINTL, PDWORD);};
struct IFileViewerVtbl {HRESULT (*QueryInterface)(IFileViewer *, const IID *const, PVOID *);ULONG (*AddRef)(IFileViewer *);ULONG (*Release)(IFileViewer *);HRESULT (*ShowInitialize)(IFileViewer *, LPFILEVIEWERSITE);HRESULT (*Show)(IFileViewer *, LPFVSHOWINFO);HRESULT (*PrintTo)(IFileViewer *, LPSTR, BOOL);};
struct IOleControlVtbl {HRESULT (*QueryInterface)(IOleControl *, const IID *const, PVOID *);ULONG (*AddRef)(IOleControl *);ULONG (*Release)(IOleControl *);HRESULT (*GetControlInfo)(IOleControl *, LPCONTROLINFO);HRESULT (*OnMnemonic)(IOleControl *, LPMSG);HRESULT (*OnAmbientPropertyChange)(IOleControl *, DISPID);HRESULT (*FreezeEvents)(IOleControl *, BOOL);};
struct ILockBytesVtbl {HRESULT (*QueryInterface)(ILockBytes *, const IID *const, PVOID *);ULONG (*AddRef)(ILockBytes *);ULONG (*Release)(ILockBytes *);HRESULT (*ReadAt)(ILockBytes *, ULARGE_INTEGER, PVOID, ULONG, ULONG *);HRESULT (*WriteAt)(ILockBytes *, ULARGE_INTEGER, PCVOID, ULONG, ULONG *);HRESULT (*Flush)(ILockBytes *);HRESULT (*SetSize)(ILockBytes *, ULARGE_INTEGER);HRESULT (*LockRegion)(ILockBytes *, ULARGE_INTEGER, ULARGE_INTEGER, DWORD);HRESULT (*UnlockRegion)(ILockBytes *, ULARGE_INTEGER, ULARGE_INTEGER, DWORD);HRESULT (*Stat)(ILockBytes *, STATSTG *, DWORD);};
struct ICopyHookVtbl {HRESULT (*QueryInterface)(ICopyHook *, const IID *const, PVOID *);ULONG (*AddRef)(ICopyHook *);ULONG (*Release)(ICopyHook *);UINT (*CopyCallback)(ICopyHook *, HWND, UINT, UINT, LPCSTR, DWORD, LPCSTR, DWORD);};
...
struct IStreamVtbl {HRESULT (*QueryInterface)(IStream *, const IID *const, PVOID *);ULONG (*AddRef)(IStream *);ULONG (*Release)(IStream *);HRESULT (*Read)(IStream *, void *, ULONG, ULONG *);HRESULT (*Write)(IStream *, const void *, ULONG, ULONG *);HRESULT (*Seek)(IStream *, LARGE_INTEGER, DWORD, ULARGE_INTEGER *);HRESULT (*SetSize)(IStream *, ULARGE_INTEGER);HRESULT (*CopyTo)(IStream *, IStream *, ULARGE_INTEGER, ULARGE_INTEGER *, ULARGE_INTEGER *);HRESULT (*Commit)(IStream *, DWORD);HRESULT (*Revert)(IStream *);HRESULT (*LockRegion)(IStream *, ULARGE_INTEGER, ULARGE_INTEGER, DWORD);HRESULT (*UnlockRegion)(IStream *, ULARGE_INTEGER, ULARGE_INTEGER, DWORD);HRESULT (*Stat)(IStream *, STATSTG *, DWORD);HRESULT (*Clone)(IStream *, LPSTREAM *);};
struct IOleControlSiteVtbl {HRESULT (*QueryInterface)(IOleControlSite *, const IID *const, PVOID *);ULONG (*AddRef)(IOleControlSite *);ULONG (*Release)(IOleControlSite *);HRESULT (*OnControlInfoChanged)(IOleControlSite *);HRESULT (*LockInPlaceActive)(IOleControlSite *, BOOL);HRESULT (*GetExtendedControl)(IOleControlSite *, LPDISPATCH *);HRESULT (*TransformCoords)(IOleControlSite *, POINTL *, POINTF *, DWORD);HRESULT (*TranslateAcceleratorA)(IOleControlSite *, LPMSG, DWORD);HRESULT (*OnFocus)(IOleControlSite *, BOOL);HRESULT (*ShowPropertyFrame)(IOleControlSite *);};
...
struct stat {__dev_t st_dev;unsigned __int16 __pad1;__ino_t st_ino;__mode_t st_mode;__nlink_t st_nlink;__uid_t st_uid;__gid_t st_gid;__dev_t st_rdev;unsigned __int16 __pad2;__off_t st_size;__blksize_t st_blksize;__blkcnt_t st_blocks;struct timespec st_atim;struct timespec st_mtim;struct timespec st_ctim;unsigned int __unused4;unsigned int __unused5;};
...
struct tagCInterfaceProxyHeader {const IID *piid;};
...
typedef int (*LPFN_WSAHTONS)(SOCKET, unsigned __int16, unsigned __int16 *);
typedef int (*LPFN_WSANTOHL)(SOCKET, unsigned int, unsigned int *);
typedef int (*LPFN_WSANTOHS)(SOCKET, unsigned __int16, unsigned __int16 *);
...
struct IPersistVtbl {HRESULT (*QueryInterface)(IPersist *, const IID *const, PVOID *);ULONG (*AddRef)(IPersist *);ULONG (*Release)(IPersist *);HRESULT (*GetClassID)(IPersist *, LPCLSID);};
...
struct IErrorInfoVtbl {HRESULT (*QueryInterface)(IErrorInfo *, const IID *const, PVOID *);ULONG (*AddRef)(IErrorInfo *);ULONG (*Release)(IErrorInfo *);HRESULT (*GetGUID)(IErrorInfo *, const IID *const);HRESULT (*GetSource)(IErrorInfo *, BSTR *);HRESULT (*GetDescription)(IErrorInfo *, BSTR *);HRESULT (*GetHelpContext)(IErrorInfo *, DWORD *);};
...
struct IPersistPropertyBagVtbl {HRESULT (*QueryInterface)(IPersistPropertyBag *, const IID *const, PVOID *);ULONG (*AddRef)(IPersistPropertyBag *);ULONG (*Release)(IPersistPropertyBag *);HRESULT (*GetClassID)(IPersistPropertyBag *, LPCLSID);HRESULT (*InitNew)(IPersistPropertyBag *);HRESULT (*Load)(IPersistPropertyBag *, LPPROPERTYBAG, LPERRORLOG);HRESULT (*Save)(IPersistPropertyBag *, LPPROPERTYBAG, BOOL, BOOL);};
struct IPropertySetStorageVtbl {HRESULT (*QueryInterface)(IPropertySetStorage *, const IID *const, PVOID *);ULONG (*AddRef)(IPropertySetStorage *);ULONG (*Release)(IPropertySetStorage *);HRESULT (*Create)(IPropertySetStorage *, REFFMTID, CLSID *, DWORD, DWORD, LPPROPERTYSTORAGE *);HRESULT (*Open)(IPropertySetStorage *, REFFMTID, DWORD, LPPROPERTYSTORAGE *);HRESULT (*Delete)(IPropertySetStorage *, REFFMTID);HRESULT (*Enum)(IPropertySetStorage *, IEnumSTATPROPSETSTG **);};
struct IPersistStreamInitVtbl {HRESULT (*QueryInterface)(IPersistStreamInit *, const IID *const, PVOID *);ULONG (*AddRef)(IPersistStreamInit *);ULONG (*Release)(IPersistStreamInit *);HRESULT (*GetClassID)(IPersistStreamInit *, LPCLSID);HRESULT (*IsDirty)(IPersistStreamInit *);HRESULT (*Load)(IPersistStreamInit *, LPSTREAM);HRESULT (*Save)(IPersistStreamInit *, LPSTREAM, BOOL);HRESULT (*GetSizeMax)(IPersistStreamInit *, PULARGE_INTEGER);HRESULT (*InitNew)(IPersistStreamInit *);};
...
struct IOleUILinkContainerWVtbl {HRESULT (*QueryInterface)(IOleUILinkContainerW *, const IID *const, PVOID *);ULONG (*AddRef)(IOleUILinkContainerW *);ULONG (*Release)(IOleUILinkContainerW *);DWORD (*GetNextLink)(IOleUILinkContainerW *, DWORD dwLink);HRESULT (*SetLinkUpdateOptions)(IOleUILinkContainerW *, DWORD, DWORD);HRESULT (*GetLinkUpdateOptions)(IOleUILinkContainerW *, DWORD, PDWORD);HRESULT (*SetLinkSource)(IOleUILinkContainerW *, DWORD, LPWSTR, ULONG, PULONG, BOOL);HRESULT (*GetLinkSource)(IOleUILinkContainerW *, DWORD, LPWSTR *, PULONG, LPWSTR *, LPWSTR *, BOOL *, BOOL *);HRESULT (*OpenLinkSource)(IOleUILinkContainerW *, DWORD);HRESULT (*UpdateLink)(IOleUILinkContainerW *, DWORD, BOOL, BOOL);HRESULT (*CancelLink)(IOleUILinkContainerW *, DWORD);};
struct IOleUILinkInfoWVtbl {HRESULT (*QueryInterface)(IOleUILinkInfoW *, const IID *const, PVOID *);ULONG (*AddRef)(IOleUILinkInfoW *);ULONG (*Release)(IOleUILinkInfoW *);DWORD (*GetNextLink)(IOleUILinkInfoW *, DWORD);HRESULT (*SetLinkUpdateOptions)(IOleUILinkInfoW *, DWORD, DWORD);HRESULT (*GetLinkUpdateOptions)(IOleUILinkInfoW *, DWORD, DWORD *);HRESULT (*SetLinkSource)(IOleUILinkInfoW *, DWORD, LPWSTR, ULONG, PULONG, BOOL);HRESULT (*GetLinkSource)(IOleUILinkInfoW *, DWORD, LPWSTR *, PULONG, LPWSTR *, LPWSTR *, BOOL *, BOOL *);HRESULT (*OpenLinkSource)(IOleUILinkInfoW *, DWORD);HRESULT (*UpdateLink)(IOleUILinkInfoW *, DWORD, BOOL, BOOL);HRESULT (*CancelLink)(IOleUILinkInfoW *, DWORD);HRESULT (*GetLastUpdate)(IOleUILinkInfoW *, DWORD, FILETIME *);};
struct IClassFactory2Vtbl {HRESULT (*QueryInterface)(IClassFactory2 *, const IID *const, PVOID *);ULONG (*AddRef)(IClassFactory2 *);ULONG (*Release)(IClassFactory2 *);HRESULT (*CreateInstance)(IClassFactory2 *, LPUNKNOWN, const IID *const, PVOID *);HRESULT (*LockServer)(IClassFactory2 *, BOOL);HRESULT (*GetLicInfo)(IClassFactory2 *, LPLICINFO);HRESULT (*RequestLicKey)(IClassFactory2 *, DWORD, BSTR *);HRESULT (*CreateInstanceLic)(IClassFactory2 *, LPUNKNOWN, LPUNKNOWN, const IID *const, BSTR, PVOID *);};
...
struct IStorageVtbl {HRESULT (*QueryInterface)(IStorage *, const IID *const, PVOID *);ULONG (*AddRef)(IStorage *);ULONG (*Release)(IStorage *);HRESULT (*CreateStream)(IStorage *, LPCWSTR, DWORD, DWORD, DWORD, IStream **);HRESULT (*OpenStream)(IStorage *, LPCWSTR, PVOID, DWORD, DWORD, IStream **);HRESULT (*CreateStorage)(IStorage *, LPCWSTR, DWORD, DWORD, DWORD, IStorage **);HRESULT (*OpenStorage)(IStorage *, LPCWSTR, IStorage *, DWORD, SNB, DWORD, IStorage **);HRESULT (*CopyTo)(IStorage *, DWORD, const IID *, SNB, IStorage *);HRESULT (*MoveElementTo)(IStorage *, LPCWSTR, IStorage *, LPCWSTR, DWORD);HRESULT (*Commit)(IStorage *, DWORD);HRESULT (*Revert)(IStorage *);HRESULT (*EnumElements)(IStorage *, DWORD, PVOID, DWORD, IEnumSTATSTG **);HRESULT (*DestroyElement)(IStorage *, LPCWSTR);HRESULT (*RenameElement)(IStorage *, LPCWSTR, LPCWSTR);HRESULT (*SetElementTimes)(IStorage *, LPCWSTR, const FILETIME *, const FILETIME *, const FILETIME *);HRESULT (*SetClass)(IStorage *, const CLSID *const);HRESULT (*SetStateBits)(IStorage *, DWORD, DWORD);HRESULT (*Stat)(IStorage *, STATSTG *, DWORD);};
struct IFontVtbl {HRESULT (*QueryInterface)(IFont *, const IID *const, PVOID *);ULONG (*AddRef)(IFont *);ULONG (*Release)(IFont *);HRESULT (*get_Name)(IFont *, BSTR *);HRESULT (*put_Name)(IFont *, BSTR);HRESULT (*get_Size)(IFont *, CY *);HRESULT (*put_Size)(IFont *, CY);HRESULT (*get_Bold)(IFont *, BOOL *);HRESULT (*put_Bold)(IFont *, BOOL);HRESULT (*get_Italic)(IFont *, BOOL *);HRESULT (*put_Italic)(IFont *, BOOL);HRESULT (*get_Underline)(IFont *, BOOL *);HRESULT (*put_Underline)(IFont *, BOOL);HRESULT (*get_Strikethrough)(IFont *, BOOL *);HRESULT (*put_Strikethrough)(IFont *, BOOL);HRESULT (*get_Weight)(IFont *, __int16 *);HRESULT (*put_Weight)(IFont *, __int16);HRESULT (*get_Charset)(IFont *, __int16 *);HRESULT (*put_Charset)(IFont *, __int16);HRESULT (*get_hFont)(IFont *, HFONT *);HRESULT (*Clone)(IFont *, IFont **);HRESULT (*IsEqual)(IFont *, IFont *);HRESULT (*SetRatio)(IFont *, int, int);HRESULT (*QueryTextMetrics)(IFont *, LPTEXTMETRICOLE);HRESULT (*AddRefHfont)(IFont *, HFONT);HRESULT (*ReleaseHfont)(IFont *, HFONT);HRESULT (*SetHdc)(IFont *, HDC);};
...
struct IPropertyStorageVtbl {HRESULT (*QueryInterface)(IPropertyStorage *, const IID *const, PVOID *);ULONG (*AddRef)(IPropertyStorage *);ULONG (*Release)(IPropertyStorage *);HRESULT (*ReadMultiple)(IPropertyStorage *, ULONG, const PROPSPEC *, PROPVARIANT *);HRESULT (*WriteMultiple)(IPropertyStorage *, ULONG, const PROPSPEC *, PROPVARIANT *, PROPID);HRESULT (*DeleteMultiple)(IPropertyStorage *, ULONG, const PROPSPEC *);HRESULT (*ReadPropertyNames)(IPropertyStorage *, ULONG, const PROPID *, LPWSTR *);HRESULT (*WritePropertyNames)(IPropertyStorage *, ULONG, const PROPID *, const LPWSTR *);HRESULT (*DeletePropertyNames)(IPropertyStorage *, ULONG, const PROPID *);HRESULT (*SetClass)(IPropertyStorage *, const CLSID *const);HRESULT (*Commit)(IPropertyStorage *, DWORD);HRESULT (*Revert)(IPropertyStorage *);HRESULT (*Enum)(IPropertyStorage *, IEnumSTATPROPSTG **);HRESULT (*Stat)(IPropertyStorage *, STATPROPSTG *);HRESULT (*SetTimes)(IPropertyStorage *, const FILETIME *, const FILETIME *, const FILETIME *);};
struct IOleUIObjInfoAVtbl {HRESULT (*QueryInterface)(IOleUIObjInfoA *, const IID *const, PVOID *);ULONG (*AddRef)(IOleUIObjInfoA *);ULONG (*Release)(IOleUIObjInfoA *);HRESULT (*GetObjectInfo)(IOleUIObjInfoA *, DWORD, PDWORD, LPSTR *, LPSTR *, LPSTR *, LPSTR *);HRESULT (*GetConvertInfo)(IOleUIObjInfoA *, DWORD, CLSID *, PWORD, CLSID *, LPCLSID *, UINT *);HRESULT (*ConvertObject)(IOleUIObjInfoA *, DWORD, const CLSID *const);HRESULT (*GetViewInfo)(IOleUIObjInfoA *, DWORD, HGLOBAL *, PDWORD, int *);HRESULT (*SetViewInfo)(IOleUIObjInfoA *, DWORD, HGLOBAL, DWORD, int, BOOL);};
struct IOleUIObjInfoWVtbl {HRESULT (*QueryInterface)(IOleUIObjInfoW *, const IID *const, PVOID *);ULONG (*AddRef)(IOleUIObjInfoW *);ULONG (*Release)(IOleUIObjInfoW *);HRESULT (*GetObjectInfo)(IOleUIObjInfoW *, DWORD, PDWORD, LPWSTR *, LPWSTR *, LPWSTR *, LPWSTR *);HRESULT (*GetConvertInfo)(IOleUIObjInfoW *, DWORD, CLSID *, PWORD, CLSID *, LPCLSID *, UINT *);HRESULT (*ConvertObject)(IOleUIObjInfoW *, DWORD, const CLSID *const);HRESULT (*GetViewInfo)(IOleUIObjInfoW *, DWORD, HGLOBAL *, PDWORD, int *);HRESULT (*SetViewInfo)(IOleUIObjInfoW *, DWORD, HGLOBAL, DWORD, int, BOOL);};
union tagVARIANT______8917340B7A8DB9BEA85031381048F94D___3FCBCE0E1D38ED64A5F05F924A43CE06 {int lVal;unsigned __int8 bVal;__int16 iVal;float fltVal;double dblVal;VARIANT_BOOL boolVal;SCODE scode;CY cyVal;DATE date;BSTR bstrVal;IUnknown *punkVal;LPDISPATCH pdispVal;SAFEARRAY *parray;unsigned __int8 *pbVal;__int16 *piVal;int *plVal;float *pfltVal;double *pdblVal;VARIANT_BOOL *pboolVal;SCODE *pscode;CY *pcyVal;DATE *pdate;BSTR *pbstrVal;IUnknown **ppunkVal;LPDISPATCH *ppdispVal;SAFEARRAY **pparray;struct tagVARIANT *pvarVal;void *byref;CHAR cVal;USHORT uiVal;ULONG ulVal;INT intVal;UINT uintVal;DECIMAL *pdecVal;CHAR *pcVal;USHORT *puiVal;ULONG *pulVal;INT *pintVal;UINT *puintVal;tagVARIANT_________3FCBCE0E1D38ED64A5F05F924A43CE06___3D6F035A95DCF735295BE71D0E642E57 __anonymous0;};
...
struct IParseDisplayNameVtbl {HRESULT (*QueryInterface)(IParseDisplayName *, const IID *const, PVOID *);ULONG (*AddRef)(IParseDisplayName *);ULONG (*Release)(IParseDisplayName *);HRESULT (*ParseDisplayName)(IParseDisplayName *, IBindCtx *, LPOLESTR, ULONG *, IMoniker **);};
struct IRootStorageVtbl {HRESULT (*QueryInterface)(IRootStorage *, const IID *const, PVOID *);ULONG (*AddRef)(IRootStorage *);ULONG (*Release)(IRootStorage *);HRESULT (*SwitchToFile)(IRootStorage *, LPOLESTR);};
struct IEnumStringVtbl {HRESULT (*QueryInterface)(IEnumString *, const IID *const, PVOID *);ULONG (*AddRef)(IEnumString *);ULONG (*Release)(IEnumString *);HRESULT (*Next)(IEnumString *, ULONG, LPOLESTR *, ULONG *);HRESULT (*Skip)(IEnumString *, ULONG);HRESULT (*Reset)(IEnumString *);HRESULT (*Clone)(IEnumString *, IEnumString **);};
...
struct IErrorLogVtbl {HRESULT (*QueryInterface)(IErrorLog *, const IID *const, PVOID *);ULONG (*AddRef)(IErrorLog *);ULONG (*Release)(IErrorLog *);HRESULT (*AddError)(IErrorLog *, LPCOLESTR, LPEXCEPINFO);};
...
struct IOleContainerVtbl {HRESULT (*QueryInterface)(IOleContainer *, const IID *const, PVOID *);ULONG (*AddRef)(IOleContainer *);ULONG (*Release)(IOleContainer *);HRESULT (*ParseDisplayName)(IOleContainer *, IBindCtx *, LPOLESTR, ULONG *, IMoniker **);HRESULT (*EnumObjects)(IOleContainer *, DWORD, IEnumUnknown **);HRESULT (*LockContainer)(IOleContainer *, BOOL);};
struct IPropertyBagVtbl {HRESULT (*QueryInterface)(IPropertyBag *, const IID *const, PVOID *);ULONG (*AddRef)(IPropertyBag *);ULONG (*Release)(IPropertyBag *);HRESULT (*Read)(IPropertyBag *, LPCOLESTR, LPVARIANT, LPERRORLOG);HRESULT (*Write)(IPropertyBag *, LPCOLESTR, LPVARIANT);};
...
struct IMonikerVtbl {HRESULT (*QueryInterface)(IMoniker *, const IID *const, PVOID *);ULONG (*AddRef)(IMoniker *);ULONG (*Release)(IMoniker *);HRESULT (*GetClassID)(IMoniker *, CLSID *);HRESULT (*IsDirty)(IMoniker *);HRESULT (*Load)(IMoniker *, IStream *);HRESULT (*Save)(IMoniker *, IStream *, BOOL);HRESULT (*GetSizeMax)(IMoniker *, PULARGE_INTEGER);HRESULT (*BindToObject)(IMoniker *, IBindCtx *, IMoniker *, const IID *const, PVOID *);HRESULT (*BindToStorage)(IMoniker *, IBindCtx *, IMoniker *, const IID *const, PVOID *);HRESULT (*Reduce)(IMoniker *, IBindCtx *, DWORD, IMoniker **, IMoniker **);HRESULT (*ComposeWith)(IMoniker *, IMoniker *, BOOL, IMoniker **);HRESULT (*Enum)(IMoniker *, BOOL, IEnumMoniker **);HRESULT (*IsEqual)(IMoniker *, IMoniker *);HRESULT (*Hash)(IMoniker *, PDWORD);HRESULT (*IsRunning)(IMoniker *, IBindCtx *, IMoniker *, IMoniker *);HRESULT (*GetTimeOfLastChange)(IMoniker *, IBindCtx *, IMoniker *, LPFILETIME);HRESULT (*Inverse)(IMoniker *, IMoniker **);HRESULT (*CommonPrefixWith)(IMoniker *, IMoniker *, IMoniker **);HRESULT (*RelativePathTo)(IMoniker *, IMoniker *, IMoniker **);HRESULT (*GetDisplayName)(IMoniker *, IBindCtx *, IMoniker *, LPOLESTR *);HRESULT (*ParseDisplayName)(IMoniker *, IBindCtx *, IMoniker *, LPOLESTR, ULONG *, IMoniker **);HRESULT (*IsSystemMoniker)(IMoniker *, PDWORD);};
struct IPropertyPageVtbl {HRESULT (*QueryInterface)(IPropertyPage *, const IID *const, PVOID *);ULONG (*AddRef)(IPropertyPage *);ULONG (*Release)(IPropertyPage *);HRESULT (*SetPageSite)(IPropertyPage *, LPPROPERTYPAGESITE);HRESULT (*Activate)(IPropertyPage *, HWND, LPCRECT, BOOL);HRESULT (*Deactivate)(IPropertyPage *);HRESULT (*GetPageInfo)(IPropertyPage *, LPPROPPAGEINFO);HRESULT (*SetObjects)(IPropertyPage *, ULONG, LPUNKNOWN *);HRESULT (*Show)(IPropertyPage *, UINT);HRESULT (*Move)(IPropertyPage *, LPCRECT);HRESULT (*IsPageDirty)(IPropertyPage *);HRESULT (*Apply)(IPropertyPage *);HRESULT (*Help)(IPropertyPage *, LPCOLESTR);HRESULT (*TranslateAcceleratorA)(IPropertyPage *, LPMSG);};
struct IPictureDispVtbl {HRESULT (*QueryInterface)(IPictureDisp *, const IID *const, PVOID *);ULONG (*AddRef)(IPictureDisp *);ULONG (*Release)(IPictureDisp *);HRESULT (*GetTypeInfoCount)(IPictureDisp *, UINT *);HRESULT (*GetTypeInfo)(IPictureDisp *, UINT, LCID, LPTYPEINFO *);HRESULT (*GetIDsOfNames)(IPictureDisp *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *);HRESULT (*Invoke)(IPictureDisp *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *);};
struct IDispatchVtbl {HRESULT (*QueryInterface)(IDispatch *, const IID *const, PVOID *);ULONG (*AddRef)(IDispatch *);ULONG (*Release)(IDispatch *);HRESULT (*GetTypeInfoCount)(IDispatch *, UINT *);HRESULT (*GetTypeInfo)(IDispatch *, UINT, LCID, LPTYPEINFO *);HRESULT (*GetIDsOfNames)(IDispatch *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *);HRESULT (*Invoke)(IDispatch *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *);};
struct IFontDispVtbl {HRESULT (*QueryInterface)(IFontDisp *, const IID *const, PVOID *);ULONG (*AddRef)(IFontDisp *);ULONG (*Release)(IFontDisp *);HRESULT (*GetTypeInfoCount)(IFontDisp *, UINT *);HRESULT (*GetTypeInfo)(IFontDisp *, UINT, LCID, LPTYPEINFO *);HRESULT (*GetIDsOfNames)(IFontDisp *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *);HRESULT (*Invoke)(IFontDisp *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *);};
struct IPropertyPage2Vtbl {HRESULT (*QueryInterface)(IPropertyPage2 *, const IID *const, PVOID *);ULONG (*AddRef)(IPropertyPage2 *);ULONG (*Release)(IPropertyPage2 *);HRESULT (*SetPageSite)(IPropertyPage2 *, LPPROPERTYPAGESITE);HRESULT (*Activate)(IPropertyPage2 *, HWND, LPCRECT, BOOL);HRESULT (*Deactivate)(IPropertyPage2 *);HRESULT (*GetPageInfo)(IPropertyPage2 *, LPPROPPAGEINFO);HRESULT (*SetObjects)(IPropertyPage2 *, ULONG, LPUNKNOWN *);HRESULT (*Show)(IPropertyPage2 *, UINT);HRESULT (*Move)(IPropertyPage2 *, LPCRECT);HRESULT (*IsPageDirty)(IPropertyPage2 *);HRESULT (*Apply)(IPropertyPage2 *);HRESULT (*Help)(IPropertyPage2 *, LPCOLESTR);HRESULT (*TranslateAcceleratorA)(IPropertyPage2 *, LPMSG);HRESULT (*EditProperty)(IPropertyPage2 *, DISPID);};
struct IOleInPlaceFrameVtbl {HRESULT (*QueryInterface)(IOleInPlaceFrame *, const IID *const, PVOID *);ULONG (*AddRef)(IOleInPlaceFrame *);ULONG (*Release)(IOleInPlaceFrame *);HRESULT (*GetWindow)(IOleInPlaceFrame *, HWND *);HRESULT (*ContextSensitiveHelp)(IOleInPlaceFrame *, BOOL);HRESULT (*GetBorder)(IOleInPlaceFrame *, LPRECT);HRESULT (*RequestBorderSpace)(IOleInPlaceFrame *, LPCBORDERWIDTHS);HRESULT (*SetBorderSpace)(IOleInPlaceFrame *, LPCBORDERWIDTHS);HRESULT (*SetActiveObject)(IOleInPlaceFrame *, LPOLEINPLACEACTIVEOBJECT, LPCOLESTR);HRESULT (*InsertMenus)(IOleInPlaceFrame *, HMENU, LPOLEMENUGROUPWIDTHS);HRESULT (*SetMenu)(IOleInPlaceFrame *, HMENU, HOLEMENU, HWND);HRESULT (*RemoveMenus)(IOleInPlaceFrame *, HMENU);HRESULT (*SetStatusText)(IOleInPlaceFrame *, LPCOLESTR);HRESULT (*EnableModeless)(IOleInPlaceFrame *, BOOL);HRESULT (*TranslateAcceleratorA)(IOleInPlaceFrame *, LPMSG, WORD);};
struct ITypeLibVtbl {HRESULT (*QueryInterface)(ITypeLib *, const IID *const, PVOID *);ULONG (*AddRef)(ITypeLib *);ULONG (*Release)(ITypeLib *);UINT (*GetTypeInfoCount)(ITypeLib *);HRESULT (*GetTypeInfo)(ITypeLib *, UINT, ITypeInfo **);HRESULT (*GetTypeInfoType)(ITypeLib *, UINT, TYPEKIND *);HRESULT (*GetTypeInfoOfGuid)(ITypeLib *, const GUID *const, ITypeInfo **);HRESULT (*GetLibAttr)(ITypeLib *, TLIBATTR **);HRESULT (*GetTypeComp)(ITypeLib *, ITypeComp *);HRESULT (*GetDocumentation)(ITypeLib *, INT, BSTR *, BSTR *, DWORD *, BSTR *);HRESULT (*IsName)(ITypeLib *, LPOLESTR, ULONG, BOOL *);HRESULT (*FindName)(ITypeLib *, LPOLESTR, ULONG, ITypeInfo **, MEMBERID *, USHORT *);void (*ReleaseTLibAttr)(ITypeLib *, TLIBATTR *);};
union tagVARIANT___752DA0FEA6ABD422DEEA1D52ECA193AD {struct {VARTYPE vt;WORD wReserved1;WORD wReserved2;WORD wReserved3;union {int lVal;unsigned __int8 bVal;__int16 iVal;float fltVal;double dblVal;VARIANT_BOOL boolVal;SCODE scode;CY cyVal;DATE date;BSTR bstrVal;IUnknown *punkVal;LPDISPATCH pdispVal;SAFEARRAY *parray;unsigned __int8 *pbVal;__int16 *piVal;int *plVal;float *pfltVal;double *pdblVal;VARIANT_BOOL *pboolVal;SCODE *pscode;CY *pcyVal;DATE *pdate;BSTR *pbstrVal;IUnknown **ppunkVal;LPDISPATCH *ppdispVal;SAFEARRAY **pparray;struct tagVARIANT *pvarVal;void *byref;CHAR cVal;USHORT uiVal;ULONG ulVal;INT intVal;UINT uintVal;DECIMAL *pdecVal;CHAR *pcVal;USHORT *puiVal;ULONG *pulVal;INT *pintVal;UINT *puintVal;tagVARIANT___752DA0FEA6ABD422DEEA1D52ECA193AD___8917340B7A8DB9BEA85031381048F94D __anonymous0;};};DECIMAL decVal;};
struct IShellFolderVtbl {HRESULT (*QueryInterface)(IShellFolder *, const IID *const, PVOID *);ULONG (*AddRef)(IShellFolder *);ULONG (*Release)(IShellFolder *);HRESULT (*ParseDisplayName)(IShellFolder *, HWND, LPBC, LPOLESTR, PULONG, LPITEMIDLIST *, PULONG);HRESULT (*EnumObjects)(IShellFolder *, HWND, DWORD, LPENUMIDLIST *);HRESULT (*BindToObject)(IShellFolder *, LPCITEMIDLIST, LPBC, const IID *const, PVOID *);HRESULT (*BindToStorage)(IShellFolder *, LPCITEMIDLIST, LPBC, const IID *const, PVOID *);HRESULT (*CompareIDs)(IShellFolder *, LPARAM, LPCITEMIDLIST, LPCITEMIDLIST);HRESULT (*CreateViewObject)(IShellFolder *, HWND, const IID *const, PVOID *);HRESULT (*GetAttributesOf)(IShellFolder *, UINT, LPCITEMIDLIST *, PULONG);HRESULT (*GetUIObjectOf)(IShellFolder *, HWND, UINT, LPCITEMIDLIST *, const IID *const, PUINT, PVOID *);HRESULT (*GetDisplayNameOf)(IShellFolder *, LPCITEMIDLIST, DWORD, LPSTRRET);HRESULT (*SetNameOf)(IShellFolder *, HWND, LPCITEMIDLIST, LPCOLESTR, DWORD, LPITEMIDLIST *);};
struct IShellBrowserVtbl {HRESULT (*QueryInterface)(IShellBrowser *, const IID *const, PVOID *);ULONG (*AddRef)(IShellBrowser *);ULONG (*Release)(IShellBrowser *);HRESULT (*GetWindow)(IShellBrowser *, HWND *);HRESULT (*ContextSensitiveHelp)(IShellBrowser *, BOOL);HRESULT (*InsertMenusSB)(IShellBrowser *, HMENU, LPOLEMENUGROUPWIDTHS);HRESULT (*SetMenuSB)(IShellBrowser *, HMENU, HOLEMENU, HWND);HRESULT (*RemoveMenusSB)(IShellBrowser *, HMENU);HRESULT (*SetStatusTextSB)(IShellBrowser *, LPCOLESTR);HRESULT (*EnableModelessSB)(IShellBrowser *, BOOL);HRESULT (*TranslateAcceleratorSB)(IShellBrowser *, LPMSG, WORD);HRESULT (*BrowseObject)(IShellBrowser *, LPCITEMIDLIST, UINT);HRESULT (*GetViewStateStream)(IShellBrowser *, DWORD, LPSTREAM *);HRESULT (*GetControlWindow)(IShellBrowser *, UINT, HWND *);HRESULT (*SendControlMsg)(IShellBrowser *, UINT, UINT, WPARAM, LPARAM, LRESULT *);HRESULT (*QueryActiveShellView)(IShellBrowser *, LPSHELLVIEW *);HRESULT (*OnViewWindowActive)(IShellBrowser *, LPSHELLVIEW);HRESULT (*SetToolbarItems)(IShellBrowser *, LPTBBUTTON, UINT, UINT);};
struct IOleObjectVtbl {HRESULT (*QueryInterface)(IOleObject *, const IID *const, PVOID *);ULONG (*AddRef)(IOleObject *);ULONG (*Release)(IOleObject *);HRESULT (*SetClientSite)(IOleObject *, LPOLECLIENTSITE);HRESULT (*GetClientSite)(IOleObject *, LPOLECLIENTSITE *);HRESULT (*SetHostNames)(IOleObject *, LPCOLESTR, LPCOLESTR);HRESULT (*Close)(IOleObject *, DWORD);HRESULT (*SetMoniker)(IOleObject *, DWORD, LPMONIKER);HRESULT (*GetMoniker)(IOleObject *, DWORD, DWORD, LPMONIKER *);HRESULT (*InitFromData)(IOleObject *, LPDATAOBJECT, BOOL, DWORD);HRESULT (*GetClipboardData)(IOleObject *, DWORD, LPDATAOBJECT *);HRESULT (*DoVerb)(IOleObject *, LONG, LPMSG, LPOLECLIENTSITE, LONG, HWND, LPCRECT);HRESULT (*EnumVerbs)(IOleObject *, LPENUMOLEVERB *);HRESULT (*Update)(IOleObject *);HRESULT (*IsUpToDate)(IOleObject *);HRESULT (*GetUserClassID)(IOleObject *, LPCLSID);HRESULT (*GetUserType)(IOleObject *, DWORD, LPOLESTR);HRESULT (*SetExtent)(IOleObject *, DWORD, SIZEL *);HRESULT (*GetExtent)(IOleObject *, DWORD, SIZEL *);HRESULT (*Advise)(IOleObject *, LPADVISESINK, PDWORD);HRESULT (*Unadvise)(IOleObject *, DWORD);HRESULT (*EnumAdvise)(IOleObject *, LPENUMSTATDATA *);HRESULT (*GetMiscStatus)(IOleObject *, DWORD, PDWORD);HRESULT (*SetColorScheme)(IOleObject *, LPLOGPALETTE);};
struct ITypeInfoVtbl {HRESULT (*QueryInterface)(ITypeInfo *, const IID *const, PVOID *);ULONG (*AddRef)(ITypeInfo *);ULONG (*Release)(ITypeInfo *);HRESULT (*GetTypeAttr)(ITypeInfo *, LPTYPEATTR *);HRESULT (*GetTypeComp)(ITypeInfo *, LPTYPECOMP *);HRESULT (*GetFuncDesc)(ITypeInfo *, UINT, LPFUNCDESC *);HRESULT (*GetVarDesc)(ITypeInfo *, UINT, LPVARDESC *);HRESULT (*GetNames)(ITypeInfo *, MEMBERID, BSTR *, UINT, UINT *);HRESULT (*GetRefTypeOfImplType)(ITypeInfo *, UINT, HREFTYPE *);HRESULT (*GetImplTypeFlags)(ITypeInfo *, UINT, INT *);HRESULT (*GetIDsOfNames)(ITypeInfo *, LPOLESTR *, UINT, MEMBERID *);HRESULT (*Invoke)(ITypeInfo *, PVOID, MEMBERID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *);HRESULT (*GetDocumentation)(ITypeInfo *, MEMBERID, BSTR *, BSTR *, DWORD *, BSTR *);HRESULT (*GetDllEntry)(ITypeInfo *, MEMBERID, INVOKEKIND, BSTR *, BSTR *, WORD *);HRESULT (*GetRefTypeInfo)(ITypeInfo *, HREFTYPE, LPTYPEINFO *);HRESULT (*AddressOfMember)(ITypeInfo *, MEMBERID, INVOKEKIND, PVOID *);HRESULT (*CreateInstance)(ITypeInfo *, LPUNKNOWN, const IID *const, PVOID *);HRESULT (*GetMops)(ITypeInfo *, MEMBERID, BSTR *);HRESULT (*GetContainingTypeLib)(ITypeInfo *, LPTYPELIB *, UINT *);void (*ReleaseTypeAttr)(ITypeInfo *, LPTYPEATTR);void (*ReleaseFuncDesc)(ITypeInfo *, LPFUNCDESC);void (*ReleaseVarDesc)(ITypeInfo *, LPVARDESC);};
