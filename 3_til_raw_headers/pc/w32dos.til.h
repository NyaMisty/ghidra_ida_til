struct $2318D13AC6C14E1B1A163A7382044EF8 {__int16 x1;__int16 y1;__int16 x2;__int16 y2;__int16 border;__int16 background;__int16 borderstyle;__int16 bordercolor;};
...
struct $2F544CEFF70A4BBF5B4ED4532717022C {__int16 charttype;__int16 chartstyle;windowtype chartwindow;windowtype datawindow;titletype maintitle;titletype subtitle;axistype xaxis;axistype yaxis;legendtype legend;};
enum $3B9604985F7797BDFAC080FFD41D1C2D {_PG_LEFT = 0x1,_PG_CENTER = 0x2,_PG_RIGHT = 0x3,_PG_BOTTOM = 0x4,_PG_OVERLAY = 0x5,};
struct $4188DC5C7F452A6CD9F04BE057F0566E {__int16 legend;__int16 place;__int16 textcolor;__int16 autosize;windowtype legendwindow;};
...
struct $8A14177921FB82ACCF9BC5393EE485B8 {unsigned __int16 color;unsigned __int16 style;fillmap fill;char plotchar;};
...
struct $9A7FB91356E8ED1DB5FED98020BB335D {char title[70];__int16 titlecolor;__int16 justify;};
...
struct $F4EE6D1908EDD315EB8057C9A48C8C2F {__int16 grid;__int16 gridstyle;titletype axistitle;__int16 axiscolor;__int16 labeled;__int16 rangetype;float logbase;__int16 autoscale;float scalemin;float scalemax;float scalefactor;titletype scaletitle;float ticinterval;__int16 ticformat;__int16 ticdecimals;};
...
typedef struct $F4EE6D1908EDD315EB8057C9A48C8C2F axistype;
typedef unsigned __int8 charmap[8];
typedef struct $2F544CEFF70A4BBF5B4ED4532717022C chartenv;
...
typedef struct $4188DC5C7F452A6CD9F04BE057F0566E legendtype;
typedef int off_t;
typedef void (*onexit_t)();
typedef struct $8A14177921FB82ACCF9BC5393EE485B8 paletteentry;
...
typedef struct $9A7FB91356E8ED1DB5FED98020BB335D titletype;
...
typedef struct $2318D13AC6C14E1B1A163A7382044EF8 windowtype;
...
int __p_overlay;
unsigned int __win_alloc_flags;
unsigned int __win_realloc_flags;
int _access(const char *path, int mode);
void *_alloca(size_t size);
unsigned int _amblksiz;
__int16 __far _arc(__int16, __int16, __int16, __int16, __int16, __int16, __int16, __int16);
__int16 __far _arc_w(double, double, double, double, double, double, double, double);
__int16 __far _arc_wxy(struct _wxycoord far *, struct _wxycoord far *, struct _wxycoord far *, struct _wxycoord far *);
...
unsigned __int16 _bios_disk(unsigned int cmd, struct _diskinfo_t *diskinfo);
unsigned __int16 _bios_equiplist(void);
unsigned __int16 _bios_keybrd(unsigned int cmd);
unsigned __int16 _bios_memsize(void);
unsigned __int16 _bios_printer(unsigned int cmd, unsigned int port, unsigned int data);
unsigned __int16 _bios_serialcom(unsigned int cmd, unsigned int port, unsigned int data);
unsigned __int16 _bios_timeofday(unsigned int cmd, int *timeval);
int _bprintf(char *buf, unsigned int bufsize, const char *fmt, ...);
void _chain_intr(void (__interrupt far *handler)());
unsigned int _clear87(void);
void __far _clearscreen(__int16);
char *_cmdname(char *name);
unsigned int _control87(unsigned int, unsigned int);
char *_ctime(const time_t *timer, char *buf);
void _disable(void);
__int16 __far _displaycursor(__int16);
unsigned int _dos_allocmem(unsigned int size, unsigned __int16 *seg);
...
unsigned int _dos_freemem(unsigned __int16 seg);
...
unsigned int _dos_getftime(int handle, unsigned __int16 *date, unsigned __int16 *time);
...
unsigned int _dos_setblock(unsigned int size, unsigned __int16 seg, unsigned int *maxsize);
...
unsigned int _dos_setftime(int handle, unsigned __int16 date, unsigned __int16 time);
...
__int16 __far _ellipse(__int16, __int16, __int16, __int16, __int16);
__int16 __far _ellipse_w(__int16, double, double, double, double);
__int16 __far _ellipse_wxy(__int16, struct _wxycoord far *, struct _wxycoord far *);
void _enable(void);
...
__int16 __far _floodfill(__int16, __int16, __int16);
__int16 __far _floodfill_w(double, double, __int16);
...
__int16 __far _getactivepage(void);
__int16 __far _getarcinfo(struct xycoord far *, struct xycoord far *, struct xycoord far *);
int __far _getbkcolor(void);
void __far _getcliprgn(__int16 far *, __int16 far *, __int16 far *, __int16 far *);
__int16 __far _getcolor(void);
...
__int16 __far _getfontinfo(struct _fontinfo far *);
__int16 __far _getgtextextent(char far *);
struct xycoord __far _getgtextvector(void);
void __far _getimage(__int16, __int16, __int16, __int16, char far *);
...
unsigned __int16 __far _getlinestyle(void);
int _getmbcp(void);
struct xycoord __far _getphyscoord(__int16, __int16);
__int16 __far _getpixel(__int16, __int16);
__int16 __far _getpixel_w(double, double);
__int16 __far _getplotaction(void);
__int16 __far _gettextcolor(void);
__int16 __far _gettextcursor(void);
void __far _gettextextent(__int16, __int16, char far *, struct xycoord far *, struct xycoord far *);
struct rccoord __far _gettextposition(void);
struct textsettings far *__far _gettextsettings(struct textsettings far *);
void __far _gettextwindow(__int16 far *, __int16 far *, __int16 far *, __int16 far *);
struct videoconfig far *__far _getvideoconfig(struct videoconfig far *);
struct xycoord __far _getviewcoord(__int16, __int16);
struct xycoord __far _getviewcoord_w(double, double);
struct xycoord __far _getviewcoord_wxy(struct _wxycoord far *);
__int16 __far _getvisualpage(void);
struct _wxycoord __far _getwindowcoord(__int16, __int16);
struct tm *_gmtime(const time_t *timer, struct tm *tmbuf);
int _grow_handles(int new_count);
__int16 __far _grstatus(void);
__int16 __far _grtext(__int16, __int16, char far *);
__int16 __far _grtext_w(double, double, char far *);
...
int __far _imagesize(__int16, __int16, __int16, __int16);
int __far _imagesize_w(double, double, double, double);
int __far _imagesize_wxy(struct _wxycoord far *, struct _wxycoord far *);
int _ismbbalnum(unsigned __int16);
int _ismbbalpha(unsigned __int16);
int _ismbbgraph(unsigned __int16);
int _ismbbkalpha(unsigned __int16);
int _ismbbkana(unsigned __int16);
int _ismbbkpunct(unsigned __int16);
int _ismbblead(unsigned __int16);
int _ismbbprint(unsigned __int16);
int _ismbbpunct(unsigned __int16);
int _ismbbtrail(unsigned __int16);
...
__int16 __far _lineto(__int16, __int16);
__int16 __far _lineto_w(double, double);
struct tm *_localtime(const time_t *timer, struct tm *tmbuf);
int _locking(int handle, int mode, unsigned int nbyte);
unsigned int _lrotl(unsigned int value, unsigned int shift);
unsigned int _lrotr(unsigned int value, unsigned int shift);
int _lseek(int handle, int offset, int origin);
char *_ltoa(int value, char *buf, int radix);
...
size_t _memmax(void);
struct xycoord __far _moveto(__int16, __int16);
...
void __far _outmem(unsigned __int8 far *, __int16);
void __far _outtext(char far *);
__int16 __far _pg_analyzechart(chartenv far *, char far * far *, float far *, __int16);
__int16 __far _pg_analyzechartms(chartenv far *, char far * far *, float far *, __int16, __int16, __int16, char far * far *);
__int16 __far _pg_analyzepie(chartenv far *, char far * far *, float far *, __int16 far *, __int16);
__int16 __far _pg_analyzescatter(chartenv far *, float far *, float far *, __int16);
__int16 __far _pg_analyzescatterms(chartenv far *, float far *, float far *, __int16, __int16, __int16, char far * far *);
__int16 __far _pg_chart(chartenv far *, char far * far *, float far *, __int16);
__int16 __far _pg_chartms(chartenv far *, char far * far *, float far *, __int16, __int16, __int16, char far * far *);
__int16 __far _pg_chartpie(chartenv far *, char far * far *, float far *, __int16 far *, __int16);
__int16 __far _pg_chartscatter(chartenv far *, float far *, float far *, __int16);
__int16 __far _pg_chartscatterms(chartenv far *, float far *, float far *, __int16, __int16, __int16, char far * far *);
__int16 __far _pg_defaultchart(chartenv far *, __int16, __int16);
__int16 __far _pg_getchardef(__int16, unsigned __int8 far *);
__int16 __far _pg_getpalette(paletteentry far *);
void __far _pg_getstyleset(unsigned __int16 far *);
__int16 __far _pg_hlabelchart(chartenv far *, __int16, __int16, __int16, char far *);
__int16 __far _pg_initchart(void);
__int16 __far _pg_resetpalette(void);
void __far _pg_resetstyleset(void);
__int16 __far _pg_setchardef(__int16, unsigned __int8 far *);
__int16 __far _pg_setpalette(paletteentry far *);
void __far _pg_setstyleset(unsigned __int16 far *);
__int16 __far _pg_vlabelchart(chartenv far *, __int16, __int16, __int16, char far *);
__int16 __far _pie(__int16, __int16, __int16, __int16, __int16, __int16, __int16, __int16, __int16);
__int16 __far _pie_w(__int16, double, double, double, double, double, double, double, double);
__int16 __far _pie_wxy(__int16, struct _wxycoord far *, struct _wxycoord far *, struct _wxycoord far *, struct _wxycoord far *);
__int16 __far _polygon(__int16, __int16, struct xycoord far *);
__int16 __far _polygon_w(__int16, __int16, double far *);
__int16 __far _polygon_wxy(__int16, __int16, struct _wxycoord far *);
unsigned int _psp;
void __far _putimage(__int16, __int16, char far *, __int16);
void __far _putimage_w(double, double, char far *, __int16);
__int16 __far _rectangle(__int16, __int16, __int16, __int16, __int16);
__int16 __far _rectangle_w(__int16, double, double, double, double);
__int16 __far _rectangle_wxy(__int16, struct _wxycoord far *, struct _wxycoord far *);
__int16 __far _registerfonts(char far *);
__int16 __far _remapallpalette(int far *);
int __far _remappalette(__int16, int);
unsigned int _rotl(unsigned int value, unsigned int shift);
unsigned int _rotr(unsigned int value, unsigned int shift);
void __far _scrolltextwindow(__int16);
void _searchenv(const char *name, const char *env_var, char *buf);
__int16 __far _selectpalette(__int16);
__int16 __far _setactivepage(__int16);
int __far _setbkcolor(int);
void __far _setcharsize(__int16, __int16);
void __far _setcharsize_w(double, double);
void __far _setcharspacing(__int16);
void __far _setcharspacing_w(double);
void __far _setcliprgn(__int16, __int16, __int16, __int16);
__int16 __far _setcolor(__int16);
void __far _setfillmask(unsigned __int8 far *);
__int16 __far _setfont(char far *);
struct xycoord __far _setgtextvector(__int16, __int16);
int _setjmp(jmp_buf env);
void __far _setlinestyle(unsigned __int16);
int _setmbcp(int);
__int16 __far _setpixel(__int16, __int16);
__int16 __far _setpixel_w(double, double);
__int16 __far _setplotaction(__int16);
void __far _settextalign(__int16, __int16);
__int16 __far _settextcolor(__int16);
__int16 __far _settextcursor(__int16);
void __far _settextorient(__int16, __int16);
void __far _settextpath(__int16);
struct rccoord __far _settextposition(__int16, __int16);
__int16 __far _settextrows(__int16);
void __far _settextwindow(__int16, __int16, __int16, __int16);
__int16 __far _setvideomode(__int16);
__int16 __far _setvideomoderows(__int16, __int16);
struct xycoord __far _setvieworg(__int16, __int16);
void __far _setviewport(__int16, __int16, __int16, __int16);
__int16 __far _setvisualpage(__int16);
__int16 __far _setwindow(__int16, double, double, double, double);
...
int chsize(int handle, int size);
int clearenv(void);
...
void far *halloc(int n, size_t size);
...
unsigned __int16 jistojms(unsigned __int16 c);
int jisupper(JMOJI c);
int jiszen(JMOJI c);
unsigned __int16 jmstojis(unsigned __int16 msc);
...
int lock(int handle, unsigned int offset, unsigned int nbytes);
int locking(int handle, int mode, unsigned int nbyte);
double log(double x);
...
char *ltoa(int value, char *buf, int radix);
...
char *tzname[2];
void tzset(void);
char *ultoa(unsigned int value, char *buf, int radix);
int umask(int permission);
int ungetc(int c, FILE *fp);
int ungetch(int c);
int unlink(const char *path);
int unlock(int handle, unsigned int offset, unsigned int nbytes);
