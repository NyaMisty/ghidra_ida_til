...
struct $12162CE22CDC56067DA0BB6E4AD54465 {LPFNINFO fnRWInfo;LPFNSTYLE fnRWStyle;LPFNFLAGS fnFlags;char szClass[20];};
enum $320585250961ABE9F4D068EEEC4E2CC6 {BIND_MAYBOTHERUSER = 0x1,BIND_JUSTTESTEXISTENCE = 0x2,};
struct $3CA0C319F87D2D6479A928EE1D6E454C {UINT wX;UINT wY;UINT wCx;UINT wCy;UINT wId;DWORD dwStyle;char szClass[20];char szTitle[94];BYTE CtlDataSize;BYTE CtlData[255];};
struct $548B30A8C808F6625678FF0EC6B59BB3 {int nClasses;RWCTLCLASS Classes[];};
struct $549C1D5CD1C453772D3DFDF07CAC3EA1 {UINT mtOption;UINT mtID;char mtString[1];};
struct $6EEFECD5A0D572B8077FDFCD6CCD86DE {UINT wVersion;UINT wCtlTypes;char szClass[20];char szTitle[94];char szReserved[10];RWCTLTYPE Type[12];};
...
struct $DFB5CCA608DB1B6F2D4767A059C3C570 {UINT wType;UINT wWidth;UINT wHeight;DWORD dwStyle;char szDescr[22];HBITMAP hToolBit;HCURSOR hDropCurs;};
...
typedef struct $548B30A8C808F6625678FF0EC6B59BB3 CTLCLASSLIST;
...
typedef void __pascal __far DRVCALLBACK(HDRVR hdrvr, UINT uMsg, DWORD dwUser, DWORD dw1, DWORD dw2);
...
struct IErrorInfo {struct IErrorInfoVtbl far *lpVtbl;};
struct IErrorInfoVtbl {HRESULT (__cdecl __far far *QueryInterface)(IErrorInfo far *This, const IID far *const riid, void far * far *ppvObj);unsigned __int32 (__cdecl __far far *AddRef)(IErrorInfo far *This);unsigned __int32 (__cdecl __far far *Release)(IErrorInfo far *This);HRESULT (__cdecl __far far *GetGUID)(IErrorInfo far *This, GUID far *pguid);HRESULT (__cdecl __far far *GetSource)(IErrorInfo far *This, BSTR far *pbstrSource);HRESULT (__cdecl __far far *GetDescription)(IErrorInfo far *This, BSTR far *pbstrDescription);HRESULT (__cdecl __far far *GetHelpFile)(IErrorInfo far *This, BSTR far *pbstrHelpFile);HRESULT (__cdecl __far far *GetHelpContext)(IErrorInfo far *This, unsigned __int32 far *pdwHelpContext);};
...
typedef struct auxcaps_tag far *LPAUXCAPS;
...
typedef struct channel_caps_tag far *LPCHANNEL_CAPS;
...
typedef struct $548B30A8C808F6625678FF0EC6B59BB3 far *LPCTLCLASSLIST;
...
typedef struct DRVCONFIGINFOEX far *LPDRVCONFIGINFOEX;
...
typedef BOOL (__pascal __far far *LPFNEDITRES)(LPSTR szType, LPSTR szId);
typedef UINT (__pascal __far far *LPFNFLAGS)(DWORD dwStyle, LPSTR lpBuff, UINT wBuffLength);
...
typedef HGLOBAL (__pascal __far far *LPFNINFO)();
typedef HGLOBAL (__pascal __far far *LPFNLIST)(LPCSTR szAppName, UINT wVersion, LPFNLOADRES fnLoad, LPFNEDITRES fnEdit);
typedef HGLOBAL (__pascal __far far *LPFNLOADRES)(LPSTR szType, LPSTR szId);
...
typedef BOOL (__pascal __far far *LPFNSTYLE)(HWND hWnd, HGLOBAL hCntlStyle, LPFNSTRTOID lpfnSID, LPFNIDTOSTR lpfnIDS);
...
typedef struct joycaps_tag far *LPJOYCAPS;
typedef struct joyinfo_tag far *LPJOYINFO;
...
typedef struct tagMCI_ANIM_OPEN_PARMS far *LPMCI_ANIM_OPEN_PARMS;
typedef struct tagMCI_ANIM_PLAY_PARMS far *LPMCI_ANIM_PLAY_PARMS;
typedef MCI_ANIM_RECT_PARMS far *LPMCI_ANIM_RECT_PARMS;
typedef struct tagMCI_ANIM_STEP_PARMS far *LPMCI_ANIM_STEP_PARMS;
typedef struct tagMCI_ANIM_UPDATE_PARMS far *LPMCI_ANIM_UPDATE_PARMS;
typedef struct tagMCI_ANIM_WINDOW_PARMS far *LPMCI_ANIM_WINDOW_PARMS;
typedef struct tagMCI_BREAK_PARMS far *LPMCI_BREAK_PARMS;
typedef struct tagMCI_GENERIC_PARMS far *LPMCI_GENERIC_PARMS;
typedef struct tagMCI_GETDEVCAPS_PARMS far *LPMCI_GETDEVCAPS_PARMS;
typedef struct tagMCI_INFO_PARMS far *LPMCI_INFO_PARMS;
typedef struct tagMCI_LOAD_PARMS far *LPMCI_LOAD_PARMS;
typedef struct tagMCI_OPEN_PARMS far *LPMCI_OPEN_PARMS;
typedef struct tagMCI_OVLY_LOAD_PARMS far *LPMCI_OVLY_LOAD_PARMS;
typedef struct tagMCI_OVLY_OPEN_PARMS far *LPMCI_OVLY_OPEN_PARMS;
typedef struct tagMCI_OVLY_RECT_PARMS far *LPMCI_OVLY_RECT_PARMS;
typedef struct tagMCI_OVLY_SAVE_PARMS far *LPMCI_OVLY_SAVE_PARMS;
typedef struct tagMCI_OVLY_WINDOW_PARMS far *LPMCI_OVLY_WINDOW_PARMS;
typedef struct tagMCI_PLAY_PARMS far *LPMCI_PLAY_PARMS;
typedef struct tagMCI_RECORD_PARMS far *LPMCI_RECORD_PARMS;
typedef struct tagMCI_SAVE_PARMS far *LPMCI_SAVE_PARMS;
typedef struct tagMCI_SEEK_PARMS far *LPMCI_SEEK_PARMS;
typedef struct tagMCI_SEQ_SET_PARMS far *LPMCI_SEQ_SET_PARMS;
typedef struct tagMCI_SET_PARMS far *LPMCI_SET_PARMS;
typedef struct tagMCI_STATUS_PARMS far *LPMCI_STATUS_PARMS;
typedef struct tagMCI_SYSINFO_PARMS far *LPMCI_SYSINFO_PARMS;
typedef struct tagMCI_VD_ESCAPE_PARMS far *LPMCI_VD_ESCAPE_PARMS;
typedef struct tagMCI_VD_PLAY_PARMS far *LPMCI_VD_PLAY_PARMS;
typedef struct tagMCI_VD_STEP_PARMS far *LPMCI_VD_STEP_PARMS;
typedef struct tagMCI_WAVE_DELETE_PARMS far *LPMCI_WAVE_DELETE_PARMS;
typedef struct tagMCI_WAVE_OPEN_PARMS far *LPMCI_WAVE_OPEN_PARMS;
typedef struct tagMCI_WAVE_SET_PARMS far *LPMCI_WAVE_SET_PARMS;
...
typedef struct midihdr_tag far *LPMIDIHDR;
typedef struct midiincaps_tag far *LPMIDIINCAPS;
typedef struct midioutcaps_tag far *LPMIDIOUTCAPS;
typedef struct tMIXERCAPS far *LPMIXERCAPS;
typedef struct tMIXERCONTROL far *LPMIXERCONTROL;
typedef struct tMIXERCONTROLDETAILS far *LPMIXERCONTROLDETAILS;
typedef struct tMIXERCONTROLDETAILS_BOOLEAN far *LPMIXERCONTROLDETAILS_BOOLEAN;
typedef struct tMIXERCONTROLDETAILS_LISTTEXT far *LPMIXERCONTROLDETAILS_LISTTEXT;
typedef struct tMIXERCONTROLDETAILS_SIGNED far *LPMIXERCONTROLDETAILS_SIGNED;
typedef struct tMIXERCONTROLDETAILS_UNSIGNED far *LPMIXERCONTROLDETAILS_UNSIGNED;
typedef struct tMIXERLINE far *LPMIXERLINE;
typedef struct tMIXERLINECONTROLS far *LPMIXERLINECONTROLS;
typedef struct _MMCKINFO far *LPMMCKINFO;
typedef struct _MMIOINFO far *LPMMIOINFO;
typedef MMIOPROC far *LPMMIOPROC;
typedef struct mmtime_tag far *LPMMTIME;
...
typedef struct pcmwaveformat_tag far *LPPCMWAVEFORMAT;
...
typedef struct $12162CE22CDC56067DA0BB6E4AD54465 far *LPRWCTLCLASS;
typedef RWCTLINFO far *LPRWCTLINFO;
typedef RWCTLSTYLE far *LPRWCTLSTYLE;
typedef struct $DFB5CCA608DB1B6F2D4767A059C3C570 far *LPRWCTLTYPE;
...
typedef struct sockaddr_nb far *LPSOCKADDR_NB;
typedef struct sockaddr_tp *LPSOCKADDR_TP;
typedef struct sockaddr_vns far *LPSOCKADDR_VNS;
...
typedef struct timecaps_tag far *LPTIMECAPS;
...
typedef struct videohdr_tag far *LPVIDEOHDR;
typedef IViewObject far *LPVIEWOBJECT;
typedef IViewObject2 far *LPVIEWOBJECT2;
typedef void far *LPVOID;
typedef WAVECALLBACK far *LPWAVECALLBACK;
typedef struct waveformat_tag far *LPWAVEFORMAT;
typedef struct tWAVEFORMATEX far *LPWAVEFORMATEX;
typedef struct wavehdr_tag far *LPWAVEHDR;
typedef struct waveincaps_tag far *LPWAVEINCAPS;
typedef struct waveoutcaps_tag far *LPWAVEOUTCAPS;
...
typedef LRESULT __pascal __far MMIOPROC(LPSTR lpmmioinfo, UINT uMsg, LPARAM lParam1, LPARAM lParam2);
...
typedef struct auxcaps_tag near *NPAUXCAPS;
typedef BITMAP near *NPBITMAP;
typedef DEVMODE near *NPDEVMODE;
typedef struct DRVCONFIGINFOEX near *NPDRVCONFIGINFOEX;
typedef EVENTMSG near *NPEVENTMSG;
typedef struct joycaps_tag near *NPJOYCAPS;
typedef struct joyinfo_tag near *NPJOYINFO;
typedef LOGBRUSH near *NPLOGBRUSH;
typedef LOGFONT near *NPLOGFONT;
typedef LOGPALETTE near *NPLOGPALETTE;
typedef LOGPEN near *NPLOGPEN;
typedef struct midihdr_tag near *NPMIDIHDR;
typedef struct midiincaps_tag near *NPMIDIINCAPS;
typedef struct midioutcaps_tag near *NPMIDIOUTCAPS;
typedef struct _MMCKINFO near *NPMMCKINFO;
typedef struct _MMIOINFO near *NPMMIOINFO;
typedef struct mmtime_tag near *NPMMTIME;
typedef MSG near *NPMSG;
typedef NEWTEXTMETRIC near *NPNEWTEXTMETRIC;
typedef OFSTRUCT near *NPOFSTRUCT;
typedef PAINTSTRUCT near *NPPAINTSTRUCT;
typedef PATTERN near *NPPATTERN;
typedef struct pcmwaveformat_tag near *NPPCMWAVEFORMAT;
typedef POINT near *NPPOINT;
typedef RECT near *NPRECT;
typedef SIZE near *NPSIZE;
typedef char near *NPSTR;
typedef TEXTMETRIC near *NPTEXTMETRIC;
typedef struct timecaps_tag near *NPTIMECAPS;
typedef struct waveformat_tag near *NPWAVEFORMAT;
typedef struct tWAVEFORMATEX near *NPWAVEFORMATEX;
typedef struct wavehdr_tag near *NPWAVEHDR;
typedef struct waveincaps_tag near *NPWAVEINCAPS;
typedef struct waveoutcaps_tag near *NPWAVEOUTCAPS;
...
typedef struct channel_caps_tag near *PCHANNEL_CAPS;
...
typedef struct videohdr_tag near *PVIDEOHDR;
...
typedef struct $12162CE22CDC56067DA0BB6E4AD54465 RWCTLCLASS;
typedef struct $6EEFECD5A0D572B8077FDFCD6CCD86DE RWCTLINFO;
typedef struct $3CA0C319F87D2D6479A928EE1D6E454C RWCTLSTYLE;
typedef struct $DFB5CCA608DB1B6F2D4767A059C3C570 RWCTLTYPE;
...
typedef void __pascal __far TIMECALLBACK(UINT uTimerID, UINT uMsg, DWORD dwUser, DWORD dw1, DWORD dw2);
...
typedef UINT (__pascal __far far *YIELDPROC)(MCIDEVICEID mciId, DWORD dwYieldData);
...
struct mmtime_tag {UINT wType;union mmtime_tag::$E89738907296235928D3FD1615E4E030 u;};
union mmtime_tag::$E89738907296235928D3FD1615E4E030 {DWORD ms;DWORD sample;DWORD cb;DWORD ticks;struct mmtime_tag::$E89738907296235928D3FD1615E4E030::$77546E6DA24DBEE74453C7AE7BAE240D smpte;struct mmtime_tag::$E89738907296235928D3FD1615E4E030::$B7A2B1CE967584EBB3840978181CF21D midi;};
struct mmtime_tag::$E89738907296235928D3FD1615E4E030::$77546E6DA24DBEE74453C7AE7BAE240D {BYTE hour;BYTE min;BYTE sec;BYTE frame;BYTE fps;BYTE dummy;};
struct mmtime_tag::$E89738907296235928D3FD1615E4E030::$B7A2B1CE967584EBB3840978181CF21D {DWORD songptrpos;};
...
struct tMIXERCONTROL {DWORD cbStruct;DWORD dwControlID;DWORD dwControlType;DWORD fdwControl;DWORD cMultipleItems;char szShortName[16];char szName[64];union tMIXERCONTROL::$A559D66DCD7A1BA00AE602A0A7AC983C Bounds;union tMIXERCONTROL::$AFA1D3B62FF5E28583F9FD43B125895E Metrics;};
union tMIXERCONTROL::$A559D66DCD7A1BA00AE602A0A7AC983C {struct tMIXERCONTROL::$A559D66DCD7A1BA00AE602A0A7AC983C::$D5AE507983131F2A7D73786D6C61051F s1;struct tMIXERCONTROL::$A559D66DCD7A1BA00AE602A0A7AC983C::$A8262751543F154F80C41ED2519FD13B s2;DWORD dwReserved[6];};
struct tMIXERCONTROL::$A559D66DCD7A1BA00AE602A0A7AC983C::$A8262751543F154F80C41ED2519FD13B {DWORD dwMinimum;DWORD dwMaximum;};
struct tMIXERCONTROL::$A559D66DCD7A1BA00AE602A0A7AC983C::$D5AE507983131F2A7D73786D6C61051F {__int32 lMinimum;__int32 lMaximum;};
union tMIXERCONTROL::$AFA1D3B62FF5E28583F9FD43B125895E {DWORD cSteps;DWORD cbCustomData;DWORD dwReserved[6];};
struct tMIXERCONTROLDETAILS {DWORD cbStruct;DWORD dwControlID;DWORD cChannels;union tMIXERCONTROLDETAILS::$6A354DB64043DD4C59D209C2C03EE69F u;DWORD cbDetails;LPVOID paDetails;};
union tMIXERCONTROLDETAILS::$6A354DB64043DD4C59D209C2C03EE69F {HWND hwndOwner;DWORD cMultipleItems;};
struct tMIXERCONTROLDETAILS_BOOLEAN {__int32 fValue;};
struct tMIXERCONTROLDETAILS_LISTTEXT {DWORD dwParam1;DWORD dwParam2;char szName[64];};
struct tMIXERCONTROLDETAILS_SIGNED {__int32 lValue;};
struct tMIXERCONTROLDETAILS_UNSIGNED {DWORD dwValue;};
struct tMIXERLINE {DWORD cbStruct;DWORD dwDestination;DWORD dwSource;DWORD dwLineID;DWORD fdwLine;DWORD dwUser;DWORD dwComponentType;DWORD cChannels;DWORD cConnections;DWORD cControls;char szShortName[16];char szName[64];struct tMIXERLINE::$603D61C4173A9E5D7ED836A8441A40C9 Target;};
struct tMIXERLINE::$603D61C4173A9E5D7ED836A8441A40C9 {DWORD dwType;DWORD dwDeviceID;WORD wMid;WORD wPid;VERSION vDriverVersion;char szPname[32];};
struct tMIXERLINECONTROLS {DWORD cbStruct;DWORD dwLineID;union {DWORD dwControlID;DWORD dwControlType;};DWORD cControls;DWORD cbmxctrl;LPMIXERCONTROL pamxctrl;};
union tMIXERLINECONTROLS::$DC43C2837E8C20184C3137B308FBE3E1 {DWORD dwControlID;DWORD dwControlType;};
...
struct tagMETHODDATA {char far *szName;PARAMDATA far *ppdata;DISPID dispid;unsigned int iMeth;CALLCONV cc;unsigned int cArgs;unsigned int wFlags;VARTYPE vtReturn;};
...
struct tagPARAMDATA {char far *szName;VARTYPE vt;};
...
struct tagTYPEATTR {GUID guid;LCID lcid;unsigned __int32 dwReserved;MEMBERID memidConstructor;MEMBERID memidDestructor;char far *lpstrSchema;unsigned __int32 cbSizeInstance;TYPEKIND typekind;unsigned int cFuncs;unsigned int cVars;unsigned int cImplTypes;unsigned int cbSizeVft;unsigned int cbAlignment;unsigned int wTypeFlags;unsigned int wMajorVerNum;unsigned int wMinorVerNum;TYPEDESC tdescAlias;IDLDESC idldescType;};
...
struct tagVARDESC {MEMBERID memid;char far *lpstrSchema;union {unsigned __int32 oInst;VARIANT far *lpvarValue;};ELEMDESC elemdescVar;unsigned int wVarFlags;VARKIND varkind;};
...
struct tagVARIANT {VARTYPE vt;unsigned int wReserved1;unsigned int wReserved2;unsigned int wReserved3;union {unsigned __int8 bVal;int iVal;__int32 lVal;float fltVal;double dblVal;VARIANT_BOOL _bool;SCODE scode;CY cyVal;DATE date;BSTR bstrVal;IUnknown far *punkVal;IDispatch far *pdispVal;SAFEARRAY far *parray;unsigned __int8 far *pbVal;int far *piVal;__int32 far *plVal;float far *pfltVal;double far *pdblVal;VARIANT_BOOL far *pbool;SCODE far *pscode;CY far *pcyVal;DATE far *pdate;BSTR far *pbstrVal;IUnknown far * far *ppunkVal;IDispatch far * far *ppdispVal;SAFEARRAY far * far *pparray;VARIANT far *pvarVal;void far *byref;};};
union tagVARIANT::$97E52095E85F5E8E7D59138FFD8EEF88 {unsigned __int8 bVal;int iVal;__int32 lVal;float fltVal;double dblVal;VARIANT_BOOL _bool;SCODE scode;CY cyVal;DATE date;BSTR bstrVal;IUnknown far *punkVal;IDispatch far *pdispVal;SAFEARRAY far *parray;unsigned __int8 far *pbVal;int far *piVal;__int32 far *plVal;float far *pfltVal;double far *pdblVal;VARIANT_BOOL far *pbool;SCODE far *pscode;CY far *pcyVal;DATE far *pdate;BSTR far *pbstrVal;IUnknown far * far *ppunkVal;IDispatch far * far *ppdispVal;SAFEARRAY far * far *pparray;VARIANT far *pvarVal;void far *byref;};
...
MACRO_ERRNO AUXCAPS_AUXIN;
MACRO_ERRNO AUXCAPS_CDAUDIO;
MACRO_ERRNO AUXCAPS_LRVOLUME;
MACRO_ERRNO AUXCAPS_VOLUME;
MMRESULT __pascal __far AUXGETDEVCAPS(UINT uDeviceID, LPAUXCAPS pac, UINT cbac);
UINT __pascal __far AUXGETNUMDEVS();
MMRESULT __pascal __far AUXGETVOLUME(UINT uDeviceID, LPDWORD pdwVolume);
DWORD __pascal __far AUXOUTMESSAGE(UINT uDeviceID, UINT uMsg, DWORD dw1, DWORD dw2);
MMRESULT __pascal __far AUXSETVOLUME(UINT uDeviceID, DWORD dwVolume);
MACRO_ERRNO AUX_MAPPER;
...
MACRO_BXS BXS_NONE;
MACRO_BXS BXS_RECT;
MACRO_ERRNO C1_ALPHA;
MACRO_ERRNO C1_BLANK;
MACRO_ERRNO C1_CNTRL;
MACRO_ERRNO C1_DIGIT;
MACRO_ERRNO C1_LOWER;
MACRO_ERRNO C1_PUNCT;
MACRO_ERRNO C1_SPACE;
MACRO_ERRNO C1_UPPER;
MACRO_ERRNO C1_XDIGIT;
MACRO_ERRNO C2_ARABICNUMBER;
MACRO_ERRNO C2_BLOCKSEPARATOR;
MACRO_ERRNO C2_COMMONSEPARATOR;
MACRO_ERRNO C2_EUROPENUMBER;
MACRO_ERRNO C2_EUROPESEPARATOR;
MACRO_ERRNO C2_EUROPETERMINATOR;
MACRO_ERRNO C2_LEFTTORIGHT;
MACRO_ERRNO C2_NOTAPPLICABLE;
MACRO_ERRNO C2_OTHERNEUTRAL;
MACRO_ERRNO C2_RIGHTTOLEFT;
MACRO_ERRNO C2_SEGMENTSEPARATOR;
MACRO_ERRNO C2_WHITESPACE;
MACRO_ERRNO C3_ALPHA;
MACRO_ERRNO C3_DIACRITIC;
MACRO_ERRNO C3_FULLWIDTH;
MACRO_ERRNO C3_HALFWIDTH;
MACRO_ERRNO C3_HIRAGANA;
MACRO_ERRNO C3_IDEOGRAPH;
MACRO_ERRNO C3_KASHIDA;
MACRO_ERRNO C3_KATAKANA;
MACRO_ERRNO C3_NONSPACING;
MACRO_ERRNO C3_NOTAPPLICABLE;
MACRO_ERRNO C3_SYMBOL;
MACRO_ERRNO C3_VOWELMARK;
text_modes C40;
text_modes C4350;
text_modes C80;
...
MACRO_ERRNO CALLBACK_FUNCTION;
MACRO_ERRNO CALLBACK_NULL;
MACRO_ERRNO CALLBACK_TASK;
MACRO_ERRNO CALLBACK_TYPEMASK;
MACRO_ERRNO CALLBACK_WINDOW;
...
MACRO_CO CO_S_FIRST;
MACRO_CO CO_S_LAST;
MACRO_CPEX CPEX_DEST_CDECL;
MACRO_CPEX CPEX_DEST_STDCALL;
MACRO_CPL CPL_DBLCLK;
MACRO_CPL CPL_DO_NETPRN_SETUP;
MACRO_CPL CPL_DO_PRINTER_SETUP;
MACRO_CPL CPL_EXIT;
...
HRESULT __pascal __far CREATEERRORINFO(ICreateErrorInfo far * far *pperrinfo);
...
HRESULT __pascal __far CREATETYPELIB(SYSKIND syskind, const char far *szFile, ICreateTypeLib far * far *ppctlib);
...
MACRO_CS CS_VREDRAW;
BOOL __pascal __far CTL3DAUTOSUBCLASS(HINSTANCE);
BOOL __pascal __far CTL3DAUTOSUBCLASSEX(HINSTANCE, DWORD);
BOOL __pascal __far CTL3DCOLORCHANGE();
HBRUSH __pascal __far CTL3DCTLCOLOR(HDC, __int32);
HBRUSH __pascal __far CTL3DCTLCOLOREX(UINT wm, WPARAM wParam, LPARAM lParam);
__int32 __pascal __far CTL3DDLGFRAMEPAINT(HWND, UINT, WPARAM, LPARAM);
BOOL __pascal __far CTL3DENABLED();
WORD __pascal __far CTL3DGETVER();
BOOL __pascal __far CTL3DISAUTOSUBCLASS();
BOOL __pascal __far CTL3DREGISTER(HINSTANCE);
BOOL __pascal __far CTL3DSUBCLASSCTL(HWND);
BOOL __pascal __far CTL3DSUBCLASSCTLEX(HWND, int);
BOOL __pascal __far CTL3DSUBCLASSDLG(HWND, WORD);
BOOL __pascal __far CTL3DSUBCLASSDLGEX(HWND, DWORD);
BOOL __pascal __far CTL3DUNAUTOSUBCLASS();
BOOL __pascal __far CTL3DUNREGISTER(HINSTANCE);
BOOL __pascal __far CTL3DUNSUBCLASSCTL(HWND);
void __pascal __far CTL3DWININICHANGE();
MACRO_CTL3D_CTLCOLOR CTL3D_3DCHECK;
MACRO_CTL3D CTL3D_ALL;
MACRO_CTL3D_NOBORDER CTL3D_BORDER;
MACRO_CTL3D CTL3D_BUTTONS;
MACRO_CTL3D CTL3D_BUTTON_CTL;
MACRO_CTL3D CTL3D_COMBOS;
MACRO_CTL3D CTL3D_COMBO_CTL;
MACRO_CTL3D_CTLCOLOR CTL3D_CTLCOLOR;
MACRO_CTL3D CTL3D_EDITS;
MACRO_CTL3D CTL3D_EDIT_CTL;
MACRO_CTL3D CTL3D_LISTBOXES;
MACRO_CTL3D CTL3D_LISTBOX_CTL;
MACRO_CTL3D_NOBORDER CTL3D_NOBORDER;
MACRO_CTL3D CTL3D_NODLGWINDOW;
MACRO_CTL3D_NOSUBCLASS CTL3D_NOSUBCLASS;
MACRO_CTL3D CTL3D_NOSUBCLASS_DYNCREATE;
MACRO_CTL3D CTL3D_STATICFRAMES;
MACRO_CTL3D CTL3D_STATICTEXTS;
MACRO_CTL3D CTL3D_STATIC_CTL;
MACRO_CTL3D_NOSUBCLASS CTL3D_SUBCLASS;
MACRO_CTL3D CTL3D_SUBCLASS_DYNCREATE;
...
MACRO_CTLDATALENGTH CTLDATALENGTH;
MACRO_CTLDESCR CTLDESCR;
MACRO_CTLMSGOFFSET CTLMSGOFFSET;
MACRO_CTLTITLE CTLTITLE;
MACRO_CTLTYPES CTLTYPES;
MACRO_ERRNO CTRY_AUSTRALIA;
MACRO_ERRNO CTRY_AUSTRIA;
MACRO_ERRNO CTRY_BELGIUM;
MACRO_ERRNO CTRY_BRAZIL;
MACRO_ERRNO CTRY_CANADA;
MACRO_ERRNO CTRY_DEFAULT;
MACRO_ERRNO CTRY_DENMARK;
MACRO_ERRNO CTRY_FINLAND;
MACRO_ERRNO CTRY_FRANCE;
MACRO_ERRNO CTRY_GERMANY;
MACRO_ERRNO CTRY_ICELAND;
MACRO_ERRNO CTRY_IRELAND;
MACRO_ERRNO CTRY_ITALY;
MACRO_ERRNO CTRY_JAPAN;
MACRO_ERRNO CTRY_MEXICO;
MACRO_ERRNO CTRY_NETHERLANDS;
MACRO_ERRNO CTRY_NEW_ZEALAND;
MACRO_ERRNO CTRY_NORWAY;
MACRO_ERRNO CTRY_PORTUGAL;
MACRO_ERRNO CTRY_PRCHINA;
MACRO_ERRNO CTRY_SOUTH_KOREA;
MACRO_ERRNO CTRY_SPAIN;
MACRO_ERRNO CTRY_SWEDEN;
MACRO_ERRNO CTRY_SWITZERLAND;
MACRO_ERRNO CTRY_TAIWAN;
MACRO_ERRNO CTRY_UNITED_KINGDOM;
MACRO_ERRNO CTRY_UNITED_STATES;
MACRO_ERRNO CT_CTYPE1;
MACRO_ERRNO CT_CTYPE2;
MACRO_ERRNO CT_CTYPE3;
...
HRESULT __pascal __far DISPGETIDSOFNAMES(ITypeInfo far *ptinfo, char far * far *rgszNames, unsigned int cNames, DISPID far *rgdispid);
...
MACRO_DRV DRV_LOAD;
MACRO_ERRNO DRV_MCI_FIRST;
MACRO_ERRNO DRV_MCI_LAST;
MACRO_ERRNO DRV_OK;
MACRO_DRV DRV_OPEN;
MACRO_DRV DRV_POWER;
...
MACRO_ERRNO DVM_CONFIGURE_END;
MACRO_ERRNO DVM_CONFIGURE_START;
MACRO_ERRNO DVM_DST_RECT;
MACRO_ERRNO DVM_FORMAT;
MACRO_ERRNO DVM_PALETTE;
MACRO_ERRNO DVM_PALETTERGB555;
MACRO_ERRNO DVM_SRC_RECT;
MACRO_ERRNO DVM_USER;
MACRO_ERRNO DV_ERR_13;
MACRO_ERRNO DV_ERR_ALLOCATED;
MACRO_ERRNO DV_ERR_BADDEVICEID;
MACRO_ERRNO DV_ERR_BADERRNUM;
MACRO_ERRNO DV_ERR_BADFORMAT;
MACRO_ERRNO DV_ERR_BADINSTALL;
MACRO_ERRNO DV_ERR_BASE;
MACRO_ERRNO DV_ERR_CONFIG1;
MACRO_ERRNO DV_ERR_CONFIG2;
MACRO_ERRNO DV_ERR_CREATEPALETTE;
MACRO_ERRNO DV_ERR_DMA_CONFLICT;
MACRO_ERRNO DV_ERR_FLAGS;
MACRO_ERRNO DV_ERR_INT_CONFLICT;
MACRO_ERRNO DV_ERR_INVALHANDLE;
MACRO_ERRNO DV_ERR_IO_CONFLICT;
MACRO_ERRNO DV_ERR_LASTERROR;
MACRO_ERRNO DV_ERR_MEM_CONFLICT;
MACRO_ERRNO DV_ERR_NOMEM;
MACRO_ERRNO DV_ERR_NONSPECIFIC;
MACRO_ERRNO DV_ERR_NOTDETECTED;
MACRO_ERRNO DV_ERR_NOTSUPPORTED;
MACRO_ERRNO DV_ERR_NO_BUFFERS;
MACRO_ERRNO DV_ERR_OK;
MACRO_ERRNO DV_ERR_PARAM1;
MACRO_ERRNO DV_ERR_PARAM2;
MACRO_ERRNO DV_ERR_PROTECT_ONLY;
MACRO_ERRNO DV_ERR_SIZEFIELD;
MACRO_ERRNO DV_ERR_STILLPLAYING;
MACRO_ERRNO DV_ERR_SYNC;
MACRO_ERRNO DV_ERR_TOOMANYCHANNELS;
MACRO_ERRNO DV_ERR_UNPREPARED;
MACRO_ERRNO DV_ERR_USER_MSG;
...
MACRO_DV DV_E_TYMED;
MACRO_ERRNO DV_VM_CLOSE;
MACRO_ERRNO DV_VM_DATA;
MACRO_ERRNO DV_VM_ERROR;
MACRO_ERRNO DV_VM_OPEN;
...
MACRO_ERRNO EROFS;
MACRO_ERROR ERROR;
MACRO_ERRNO ERROR_ACCESS_DENIED;
MACRO_ERRNO ERROR_BADDB;
MACRO_ERRNO ERROR_BADKEY;
MACRO_ERRNO ERROR_CANTOPEN;
MACRO_ERRNO ERROR_CANTREAD;
MACRO_ERRNO ERROR_CANTWRITE;
MACRO_ERRNO ERROR_INVALID_PARAMETER;
MACRO_ERRNO ERROR_OUTOFMEMORY;
MACRO_ERRNO ERROR_SUCCESS;
...
MACRO_ERRNO EXCHIVERB_FORWARD;
MACRO_ERRNO EXCHIVERB_OPEN;
MACRO_ERRNO EXCHIVERB_PRINT;
MACRO_ERRNO EXCHIVERB_REPLYTOALL;
MACRO_ERRNO EXCHIVERB_REPLYTOFOLDER;
MACRO_ERRNO EXCHIVERB_REPLYTOSENDER;
MACRO_ERRNO EXCHIVERB_RESERVED_COMPOSE;
MACRO_ERRNO EXCHIVERB_RESERVED_DELIVERY;
MACRO_ERRNO EXCHIVERB_RESERVED_OPEN;
MACRO_ERRNO EXCHIVERB_SAVEAS;
...
DWORD __pascal __far FREELIBRARY32W(DWORD hLibModule);
...
HRESULT __pascal __far GETERRORINFO(unsigned __int32 dwReserved, IErrorInfo far * far *pperrinfo);
...
int __pascal __far GETINSTANCEDATA(HINSTANCE, PBYTE, int);
...
DWORD __pascal __far GETPROCADDRESS32W(DWORD hModule, LPCSTR lpszProc);
...
DWORD __pascal __far GETVDMPOINTER32W(LPVOID vp, UINT fMode);
...
MACRO_ISOPROTO ISOPROTO_CLNP;
MACRO_ISOPROTO ISOPROTO_CLTP;
MACRO_ISOPROTO ISOPROTO_ESIS;
MACRO_ISOPROTO ISOPROTO_INACT_NL;
MACRO_ISOPROTO ISOPROTO_INTRAISIS;
MACRO_ISOPROTO ISOPROTO_TP;
MACRO_ISOPROTO ISOPROTO_TP0;
MACRO_ISOPROTO ISOPROTO_TP1;
MACRO_ISOPROTO ISOPROTO_TP2;
MACRO_ISOPROTO ISOPROTO_TP3;
MACRO_ISOPROTO ISOPROTO_TP4;
MACRO_ISOPROTO ISOPROTO_X25;
MACRO_ISO ISO_EXP_DATA_NUSE;
MACRO_ISO ISO_EXP_DATA_USE;
MACRO_ISO ISO_HIERARCHICAL;
MACRO_ISO ISO_MAX_ADDR_LENGTH;
MACRO_ISO ISO_NON_HIERARCHICAL;
...
MACRO_ERRNO JOYCAPS_HASPOV;
MACRO_ERRNO JOYCAPS_HASR;
MACRO_ERRNO JOYCAPS_HASU;
MACRO_ERRNO JOYCAPS_HASV;
MACRO_ERRNO JOYCAPS_HASZ;
MACRO_ERRNO JOYCAPS_POV4DIR;
MACRO_ERRNO JOYCAPS_POVCTS;
MACRO_ERRNO JOYERR_BASE;
MACRO_ERRNO JOYERR_NOCANDO;
MACRO_ERRNO JOYERR_NOERROR;
MACRO_ERRNO JOYERR_PARMS;
MACRO_ERRNO JOYERR_UNPLUGGED;
MMRESULT __pascal __far JOYGETDEVCAPS(UINT uJoyID, LPJOYCAPS pjc, UINT cbjc);
UINT __pascal __far JOYGETNUMDEVS();
MMRESULT __pascal __far JOYGETPOS(UINT uJoyID, LPJOYINFO pji);
MMRESULT __pascal __far JOYGETTHRESHOLD(UINT uJoyID, LPUINT puThreshold);
MMRESULT __pascal __far JOYRELEASECAPTURE(UINT uJoyID);
MMRESULT __pascal __far JOYSETCAPTURE(HWND hwnd, UINT uJoyID, UINT uPeriod, BOOL fChanged);
MMRESULT __pascal __far JOYSETTHRESHOLD(UINT uJoyID, UINT uThreshold);
MACRO_ERRNO JOYSTICKID1;
MACRO_ERRNO JOYSTICKID2;
MACRO_ERRNO JOY_BUTTON1;
MACRO_ERRNO JOY_BUTTON10;
MACRO_ERRNO JOY_BUTTON11;
MACRO_ERRNO JOY_BUTTON12;
MACRO_ERRNO JOY_BUTTON13;
MACRO_ERRNO JOY_BUTTON14;
MACRO_ERRNO JOY_BUTTON15;
MACRO_ERRNO JOY_BUTTON16;
MACRO_ERRNO JOY_BUTTON17;
MACRO_ERRNO JOY_BUTTON18;
MACRO_ERRNO JOY_BUTTON19;
MACRO_ERRNO JOY_BUTTON1CHG;
MACRO_ERRNO JOY_BUTTON2;
MACRO_ERRNO JOY_BUTTON20;
MACRO_ERRNO JOY_BUTTON21;
MACRO_ERRNO JOY_BUTTON22;
MACRO_ERRNO JOY_BUTTON23;
MACRO_ERRNO JOY_BUTTON24;
MACRO_ERRNO JOY_BUTTON25;
MACRO_ERRNO JOY_BUTTON26;
MACRO_ERRNO JOY_BUTTON27;
MACRO_ERRNO JOY_BUTTON28;
MACRO_ERRNO JOY_BUTTON29;
MACRO_ERRNO JOY_BUTTON2CHG;
MACRO_ERRNO JOY_BUTTON3;
MACRO_ERRNO JOY_BUTTON30;
MACRO_ERRNO JOY_BUTTON31;
MACRO_ERRNO JOY_BUTTON32;
MACRO_ERRNO JOY_BUTTON3CHG;
MACRO_ERRNO JOY_BUTTON4;
MACRO_ERRNO JOY_BUTTON4CHG;
MACRO_ERRNO JOY_BUTTON5;
MACRO_ERRNO JOY_BUTTON6;
MACRO_ERRNO JOY_BUTTON7;
MACRO_ERRNO JOY_BUTTON8;
MACRO_ERRNO JOY_BUTTON9;
MACRO_ERRNO JOY_CAL_READ3;
MACRO_ERRNO JOY_CAL_READ4;
MACRO_ERRNO JOY_CAL_READ5;
MACRO_ERRNO JOY_CAL_READ6;
MACRO_ERRNO JOY_CAL_READALWAYS;
MACRO_ERRNO JOY_CAL_READRONLY;
MACRO_ERRNO JOY_CAL_READUONLY;
MACRO_ERRNO JOY_CAL_READVONLY;
MACRO_ERRNO JOY_CAL_READXONLY;
MACRO_ERRNO JOY_CAL_READXYONLY;
MACRO_ERRNO JOY_CAL_READYONLY;
MACRO_ERRNO JOY_CAL_READZONLY;
MACRO_ERRNO JOY_POVBACKWARD;
MACRO_ERRNO JOY_POVCENTERED;
MACRO_ERRNO JOY_POVFORWARD;
MACRO_ERRNO JOY_POVLEFT;
MACRO_ERRNO JOY_POVRIGHT;
MACRO_ERRNO JOY_RETURNALL;
MACRO_ERRNO JOY_RETURNBUTTONS;
MACRO_ERRNO JOY_RETURNCENTERED;
MACRO_ERRNO JOY_RETURNPOV;
MACRO_ERRNO JOY_RETURNPOVCTS;
MACRO_ERRNO JOY_RETURNR;
MACRO_ERRNO JOY_RETURNRAWDATA;
MACRO_ERRNO JOY_RETURNU;
MACRO_ERRNO JOY_RETURNV;
MACRO_ERRNO JOY_RETURNX;
MACRO_ERRNO JOY_RETURNY;
MACRO_ERRNO JOY_RETURNZ;
MACRO_ERRNO JOY_USEDEADZONE;
MACRO_KF KF_ALTDOWN;
MACRO_KF KF_DLGMODE;
...
MACRO_ERRNO LANG_ALBANIAN;
MACRO_ERRNO LANG_ARABIC;
MACRO_ERRNO LANG_BAHASA;
MACRO_ERRNO LANG_BULGARIAN;
MACRO_ERRNO LANG_CATALAN;
MACRO_ERRNO LANG_CHINESE;
MACRO_ERRNO LANG_CZECH;
MACRO_ERRNO LANG_DANISH;
MACRO_ERRNO LANG_DUTCH;
MACRO_ERRNO LANG_ENGLISH;
MACRO_ERRNO LANG_FINNISH;
MACRO_ERRNO LANG_FRENCH;
MACRO_ERRNO LANG_GERMAN;
MACRO_ERRNO LANG_GREEK;
MACRO_ERRNO LANG_HEBREW;
MACRO_ERRNO LANG_HUNGARIAN;
MACRO_ERRNO LANG_ICELANDIC;
MACRO_ERRNO LANG_ITALIAN;
MACRO_ERRNO LANG_JAPANESE;
MACRO_ERRNO LANG_KOREAN;
MACRO_ERRNO LANG_NEUTRAL;
MACRO_ERRNO LANG_NORWEGIAN;
MACRO_ERRNO LANG_POLISH;
MACRO_ERRNO LANG_PORTUGUESE;
MACRO_ERRNO LANG_RHAETO_ROMAN;
MACRO_ERRNO LANG_ROMANIAN;
MACRO_ERRNO LANG_RUSSIAN;
MACRO_ERRNO LANG_SERBO_CROATIAN;
MACRO_ERRNO LANG_SLOVAK;
MACRO_ERRNO LANG_SPANISH;
MACRO_ERRNO LANG_SWEDISH;
MACRO_ERRNO LANG_SYSTEM_DEFAULT;
MACRO_ERRNO LANG_THAI;
MACRO_ERRNO LANG_TURKISH;
MACRO_ERRNO LANG_URDU;
MACRO_ERRNO LANG_USER_DEFAULT;
text_modes LASTMODE;
...
MACRO_ERRNO LCMAP_FULLWIDTH;
MACRO_ERRNO LCMAP_HALFWIDTH;
MACRO_ERRNO LCMAP_HIRAGANA;
MACRO_ERRNO LCMAP_KATAKANA;
MACRO_ERRNO LCMAP_LOWERCASE;
MACRO_ERRNO LCMAP_SORTKEY;
MACRO_ERRNO LCMAP_UPPERCASE;
MACRO_ERRNO LC_ALL;
...
unsigned __int32 __pascal __far LHASHVALOFNAMESYS(SYSKIND syskind, LCID lcid, const char far *szName);
MACRO_LHND LHND;
tagLIBFLAGS LIBFLAG_FCONTROL;
tagLIBFLAGS LIBFLAG_FHIDDEN;
tagLIBFLAGS LIBFLAG_FRESTRICTED;
int __pascal __far LIBMAIN(HANDLE, WORD, WORD, LPSTR);
COLORS LIGHTBLUE;
COLORS LIGHTCYAN;
COLORS LIGHTGRAY;
COLORS LIGHTGREEN;
...
DWORD __pascal __far LOADLIBRARYEX32W(LPCSTR lpszLibFile, DWORD hFile, DWORD dwFlags);
...
HRESULT __pascal __far LOADTYPELIB(const char far *szFile, ITypeLib far * far *pptlib);
HLOCAL __pascal __far LOCALALLOC(UINT, UINT);
UINT __pascal __far LOCALCOMPACT(UINT);
MACRO_ERRNO LOCALE_ICALENDARTYPE;
MACRO_ERRNO LOCALE_ICENTURY;
MACRO_ERRNO LOCALE_ICOUNTRY;
MACRO_ERRNO LOCALE_ICURRDIGITS;
MACRO_ERRNO LOCALE_ICURRENCY;
MACRO_ERRNO LOCALE_IDATE;
MACRO_ERRNO LOCALE_IDAYLZERO;
MACRO_ERRNO LOCALE_IDEFAULTANSICODEPAGE;
MACRO_ERRNO LOCALE_IDEFAULTCODEPAGE;
MACRO_ERRNO LOCALE_IDEFAULTCOUNTRY;
MACRO_ERRNO LOCALE_IDEFAULTLANGUAGE;
MACRO_ERRNO LOCALE_IDIGITS;
MACRO_ERRNO LOCALE_IFIRSTDAYOFWEEK;
MACRO_ERRNO LOCALE_IFIRSTWEEKOFYEAR;
MACRO_ERRNO LOCALE_IINTLCURRDIGITS;
MACRO_ERRNO LOCALE_ILANGUAGE;
MACRO_ERRNO LOCALE_ILDATE;
MACRO_ERRNO LOCALE_ILZERO;
MACRO_ERRNO LOCALE_IMEASURE;
MACRO_ERRNO LOCALE_IMONLZERO;
MACRO_ERRNO LOCALE_INEGCURR;
MACRO_ERRNO LOCALE_INEGNUMBER;
MACRO_ERRNO LOCALE_INEGSEPBYSPACE;
MACRO_ERRNO LOCALE_INEGSIGNPOSN;
MACRO_ERRNO LOCALE_INEGSYMPRECEDES;
MACRO_ERRNO LOCALE_IOPTIONALCALENDAR;
MACRO_ERRNO LOCALE_IPOSSEPBYSPACE;
MACRO_ERRNO LOCALE_IPOSSIGNPOSN;
MACRO_ERRNO LOCALE_IPOSSYMPRECEDES;
MACRO_ERRNO LOCALE_ITIME;
MACRO_ERRNO LOCALE_ITIMEMARKPOSN;
MACRO_ERRNO LOCALE_ITLZERO;
MACRO_ERRNO LOCALE_NOUSEROVERRIDE;
MACRO_ERRNO LOCALE_S1159;
MACRO_ERRNO LOCALE_S2359;
MACRO_ERRNO LOCALE_SABBREVCTRYNAME;
MACRO_ERRNO LOCALE_SABBREVDAYNAME1;
MACRO_ERRNO LOCALE_SABBREVDAYNAME2;
MACRO_ERRNO LOCALE_SABBREVDAYNAME3;
MACRO_ERRNO LOCALE_SABBREVDAYNAME4;
MACRO_ERRNO LOCALE_SABBREVDAYNAME5;
MACRO_ERRNO LOCALE_SABBREVDAYNAME6;
MACRO_ERRNO LOCALE_SABBREVDAYNAME7;
MACRO_ERRNO LOCALE_SABBREVLANGNAME;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME1;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME10;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME11;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME12;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME13;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME2;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME3;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME4;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME5;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME6;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME7;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME8;
MACRO_ERRNO LOCALE_SABBREVMONTHNAME9;
MACRO_ERRNO LOCALE_SCOUNTRY;
MACRO_ERRNO LOCALE_SCURRENCY;
MACRO_ERRNO LOCALE_SDATE;
MACRO_ERRNO LOCALE_SDAYNAME1;
MACRO_ERRNO LOCALE_SDAYNAME2;
MACRO_ERRNO LOCALE_SDAYNAME3;
MACRO_ERRNO LOCALE_SDAYNAME4;
MACRO_ERRNO LOCALE_SDAYNAME5;
MACRO_ERRNO LOCALE_SDAYNAME6;
MACRO_ERRNO LOCALE_SDAYNAME7;
MACRO_ERRNO LOCALE_SDECIMAL;
MACRO_ERRNO LOCALE_SENGCOUNTRY;
MACRO_ERRNO LOCALE_SENGLANGUAGE;
MACRO_ERRNO LOCALE_SGROUPING;
MACRO_ERRNO LOCALE_SINTLSYMBOL;
MACRO_ERRNO LOCALE_SLANGUAGE;
MACRO_ERRNO LOCALE_SLIST;
MACRO_ERRNO LOCALE_SLONGDATE;
MACRO_ERRNO LOCALE_SMONDECIMALSEP;
MACRO_ERRNO LOCALE_SMONGROUPING;
MACRO_ERRNO LOCALE_SMONTHNAME1;
MACRO_ERRNO LOCALE_SMONTHNAME10;
MACRO_ERRNO LOCALE_SMONTHNAME11;
MACRO_ERRNO LOCALE_SMONTHNAME12;
MACRO_ERRNO LOCALE_SMONTHNAME13;
MACRO_ERRNO LOCALE_SMONTHNAME2;
MACRO_ERRNO LOCALE_SMONTHNAME3;
MACRO_ERRNO LOCALE_SMONTHNAME4;
MACRO_ERRNO LOCALE_SMONTHNAME5;
MACRO_ERRNO LOCALE_SMONTHNAME6;
MACRO_ERRNO LOCALE_SMONTHNAME7;
MACRO_ERRNO LOCALE_SMONTHNAME8;
MACRO_ERRNO LOCALE_SMONTHNAME9;
MACRO_ERRNO LOCALE_SMONTHOUSANDSEP;
MACRO_ERRNO LOCALE_SNATIVECTRYNAME;
MACRO_ERRNO LOCALE_SNATIVEDIGITS;
MACRO_ERRNO LOCALE_SNATIVELANGNAME;
MACRO_ERRNO LOCALE_SNEGATIVESIGN;
MACRO_ERRNO LOCALE_SPOSITIVESIGN;
MACRO_ERRNO LOCALE_SSHORTDATE;
MACRO_ERRNO LOCALE_STHOUSAND;
MACRO_ERRNO LOCALE_STIME;
MACRO_ERRNO LOCALE_STIMEFORMAT;
MACRO_ERRNO LOCALE_SYSTEM_DEFAULT;
MACRO_ERRNO LOCALE_USER_DEFAULT;
...
void __pascal __far LONGJMP(struct __jmp_buf far *jmpb, int retval);
...
MACRO_ERRNO LZERROR_BADINHANDLE;
MACRO_ERRNO LZERROR_BADOUTHANDLE;
MACRO_ERRNO LZERROR_BADVALUE;
MACRO_ERRNO LZERROR_GLOBALLOC;
MACRO_ERRNO LZERROR_GLOBLOCK;
MACRO_ERRNO LZERROR_READ;
MACRO_ERRNO LZERROR_UNKNOWNALG;
MACRO_ERRNO LZERROR_WRITE;
...
MACRO_MAPI MAPI_E_ACCOUNT_DISABLED;
MACRO_MAPI MAPI_E_AMBIGUOUS_RECIP;
MACRO_MAPI MAPI_E_BAD_CHARWIDTH;
MACRO_MAPI MAPI_E_BAD_COLUMN;
MACRO_MAPI MAPI_E_BAD_VALUE;
MACRO_MAPI MAPI_E_BUSY;
MACRO_MAPI MAPI_E_CALL_FAILED;
MACRO_MAPI MAPI_E_CANCEL;
MACRO_MAPI MAPI_E_COLLISION;
MACRO_MAPI MAPI_E_COMPUTED;
MACRO_MAPI MAPI_E_CORRUPT_DATA;
MACRO_MAPI MAPI_E_CORRUPT_STORE;
MACRO_MAPI MAPI_E_DECLINE_COPY;
MACRO_MAPI MAPI_E_DISK_ERROR;
MACRO_MAPI MAPI_E_END_OF_SESSION;
MACRO_MAPI MAPI_E_EXTENDED_ERROR;
MACRO_MAPI MAPI_E_FAILONEPROVIDER;
MACRO_MAPI MAPI_E_FOLDER_CYCLE;
MACRO_MAPI MAPI_E_HAS_FOLDERS;
MACRO_MAPI MAPI_E_HAS_MESSAGES;
MACRO_MAPI MAPI_E_INTERFACE_NOT_SUPPORTED;
MACRO_MAPI MAPI_E_INVALID_ACCESS_TIME;
MACRO_MAPI MAPI_E_INVALID_BOOKMARK;
MACRO_MAPI MAPI_E_INVALID_ENTRYID;
MACRO_MAPI MAPI_E_INVALID_OBJECT;
MACRO_MAPI MAPI_E_INVALID_PARAMETER;
MACRO_MAPI MAPI_E_INVALID_TYPE;
MACRO_MAPI MAPI_E_INVALID_WORKSTATION_ACCOUNT;
MACRO_MAPI MAPI_E_LOGON_FAILED;
MACRO_MAPI MAPI_E_MISSING_REQUIRED_COLUMN;
MACRO_MAPI MAPI_E_NETWORK_ERROR;
MACRO_MAPI MAPI_E_NON_STANDARD;
MACRO_MAPI MAPI_E_NOT_ENOUGH_DISK;
MACRO_MAPI MAPI_E_NOT_ENOUGH_MEMORY;
MACRO_MAPI MAPI_E_NOT_ENOUGH_RESOURCES;
MACRO_MAPI MAPI_E_NOT_FOUND;
MACRO_MAPI MAPI_E_NOT_INITIALIZED;
MACRO_MAPI MAPI_E_NOT_IN_QUEUE;
MACRO_MAPI MAPI_E_NOT_ME;
MACRO_MAPI MAPI_E_NO_ACCESS;
MACRO_MAPI MAPI_E_NO_RECIPIENTS;
MACRO_MAPI MAPI_E_NO_SUPPORT;
MACRO_MAPI MAPI_E_NO_SUPPRESS;
MACRO_MAPI MAPI_E_OBJECT_CHANGED;
MACRO_MAPI MAPI_E_OBJECT_DELETED;
MACRO_MAPI MAPI_E_PASSWORD_CHANGE_REQUIRED;
MACRO_MAPI MAPI_E_PASSWORD_EXPIRED;
MACRO_MAPI MAPI_E_SESSION_LIMIT;
MACRO_MAPI MAPI_E_STRING_TOO_LONG;
MACRO_MAPI MAPI_E_SUBMITTED;
MACRO_MAPI MAPI_E_TABLE_EMPTY;
MACRO_MAPI MAPI_E_TABLE_TOO_BIG;
MACRO_MAPI MAPI_E_TIMEOUT;
MACRO_MAPI MAPI_E_TOO_BIG;
MACRO_MAPI MAPI_E_TOO_COMPLEX;
MACRO_MAPI MAPI_E_TYPE_NO_SUPPORT;
MACRO_MAPI MAPI_E_UNABLE_TO_ABORT;
MACRO_MAPI MAPI_E_UNABLE_TO_COMPLETE;
MACRO_MAPI MAPI_E_UNCONFIGURED;
MACRO_MAPI MAPI_E_UNEXPECTED_ID;
MACRO_MAPI MAPI_E_UNEXPECTED_TYPE;
MACRO_MAPI MAPI_E_UNKNOWN_CPID;
MACRO_MAPI MAPI_E_UNKNOWN_ENTRYID;
MACRO_MAPI MAPI_E_UNKNOWN_FLAGS;
MACRO_MAPI MAPI_E_UNKNOWN_LCID;
MACRO_MAPI MAPI_E_USER_CANCEL;
MACRO_MAPI MAPI_E_VERSION;
MACRO_MAPI MAPI_E_WAIT;
MACRO_MAPI MAPI_W_APPROX_COUNT;
MACRO_MAPI MAPI_W_CANCEL_MESSAGE;
MACRO_MAPI MAPI_W_ERRORS_RETURNED;
MACRO_MAPI MAPI_W_NO_SERVICE;
MACRO_MAPI MAPI_W_PARTIAL_COMPLETION;
MACRO_MAPI MAPI_W_POSITION_CHANGED;
...
MACRO_ERRNO MCIERR_BAD_CONSTANT;
MACRO_ERRNO MCIERR_BAD_INTEGER;
MACRO_ERRNO MCIERR_BAD_TIME_FORMAT;
MACRO_ERRNO MCIERR_BASE;
MACRO_ERRNO MCIERR_CANNOT_LOAD_DRIVER;
MACRO_ERRNO MCIERR_CANNOT_USE_ALL;
MACRO_ERRNO MCIERR_CREATEWINDOW;
MACRO_ERRNO MCIERR_CUSTOM_DRIVER_BASE;
MACRO_ERRNO MCIERR_DEVICE_LENGTH;
MACRO_ERRNO MCIERR_DEVICE_LOCKED;
MACRO_ERRNO MCIERR_DEVICE_NOT_INSTALLED;
MACRO_ERRNO MCIERR_DEVICE_NOT_READY;
MACRO_ERRNO MCIERR_DEVICE_OPEN;
MACRO_ERRNO MCIERR_DEVICE_ORD_LENGTH;
MACRO_ERRNO MCIERR_DEVICE_TYPE_REQUIRED;
MACRO_ERRNO MCIERR_DRIVER;
MACRO_ERRNO MCIERR_DRIVER_INTERNAL;
MACRO_ERRNO MCIERR_DUPLICATE_ALIAS;
MACRO_ERRNO MCIERR_DUPLICATE_FLAGS;
MACRO_ERRNO MCIERR_EXTENSION_NOT_FOUND;
MACRO_ERRNO MCIERR_EXTRA_CHARACTERS;
MACRO_ERRNO MCIERR_FILENAME_REQUIRED;
MACRO_ERRNO MCIERR_FILE_NOT_FOUND;
MACRO_ERRNO MCIERR_FILE_NOT_SAVED;
MACRO_ERRNO MCIERR_FILE_READ;
MACRO_ERRNO MCIERR_FILE_WRITE;
MACRO_ERRNO MCIERR_FLAGS_NOT_COMPATIBLE;
MACRO_ERRNO MCIERR_GET_CD;
MACRO_ERRNO MCIERR_HARDWARE;
MACRO_ERRNO MCIERR_ILLEGAL_FOR_AUTO_OPEN;
MACRO_ERRNO MCIERR_INTERNAL;
MACRO_ERRNO MCIERR_INVALID_DEVICE_ID;
MACRO_ERRNO MCIERR_INVALID_DEVICE_NAME;
MACRO_ERRNO MCIERR_INVALID_FILE;
MACRO_ERRNO MCIERR_MISSING_COMMAND_STRING;
MACRO_ERRNO MCIERR_MISSING_DEVICE_NAME;
MACRO_ERRNO MCIERR_MISSING_PARAMETER;
MACRO_ERRNO MCIERR_MISSING_STRING_ARGUMENT;
MACRO_ERRNO MCIERR_MULTIPLE;
MACRO_ERRNO MCIERR_MUST_USE_SHAREABLE;
MACRO_ERRNO MCIERR_NEW_REQUIRES_ALIAS;
MACRO_ERRNO MCIERR_NONAPPLICABLE_FUNCTION;
MACRO_ERRNO MCIERR_NOTIFY_ON_AUTO_OPEN;
MACRO_ERRNO MCIERR_NO_CLOSING_QUOTE;
MACRO_ERRNO MCIERR_NO_ELEMENT_ALLOWED;
MACRO_ERRNO MCIERR_NO_IDENTITY;
MACRO_ERRNO MCIERR_NO_INTEGER;
MACRO_ERRNO MCIERR_NO_WINDOW;
MACRO_ERRNO MCIERR_NULL_PARAMETER_BLOCK;
MACRO_ERRNO MCIERR_OUTOFRANGE;
MACRO_ERRNO MCIERR_OUT_OF_MEMORY;
MACRO_ERRNO MCIERR_PARAM_OVERFLOW;
MACRO_ERRNO MCIERR_PARSER_INTERNAL;
MACRO_ERRNO MCIERR_SEQ_DIV_INCOMPATIBLE;
MACRO_ERRNO MCIERR_SEQ_NOMIDIPRESENT;
MACRO_ERRNO MCIERR_SEQ_PORTUNSPECIFIED;
MACRO_ERRNO MCIERR_SEQ_PORT_INUSE;
MACRO_ERRNO MCIERR_SEQ_PORT_MAPNODEVICE;
MACRO_ERRNO MCIERR_SEQ_PORT_MISCERROR;
MACRO_ERRNO MCIERR_SEQ_PORT_NONEXISTENT;
MACRO_ERRNO MCIERR_SEQ_TIMER;
MACRO_ERRNO MCIERR_SET_CD;
MACRO_ERRNO MCIERR_SET_DRIVE;
MACRO_ERRNO MCIERR_UNNAMED_RESOURCE;
MACRO_ERRNO MCIERR_UNRECOGNIZED_COMMAND;
MACRO_ERRNO MCIERR_UNRECOGNIZED_KEYWORD;
MACRO_ERRNO MCIERR_UNSUPPORTED_FUNCTION;
MACRO_ERRNO MCIERR_WAVE_INPUTSINUSE;
MACRO_ERRNO MCIERR_WAVE_INPUTSUNSUITABLE;
MACRO_ERRNO MCIERR_WAVE_INPUTUNSPECIFIED;
MACRO_ERRNO MCIERR_WAVE_OUTPUTSINUSE;
MACRO_ERRNO MCIERR_WAVE_OUTPUTSUNSUITABLE;
MACRO_ERRNO MCIERR_WAVE_OUTPUTUNSPECIFIED;
MACRO_ERRNO MCIERR_WAVE_SETINPUTINUSE;
MACRO_ERRNO MCIERR_WAVE_SETINPUTUNSUITABLE;
MACRO_ERRNO MCIERR_WAVE_SETOUTPUTINUSE;
MACRO_ERRNO MCIERR_WAVE_SETOUTPUTUNSUITABLE;
HTASK __pascal __far MCIGETCREATORTASK(MCIDEVICEID mciId);
MCIDEVICEID __pascal __far MCIGETDEVICEID(LPCSTR pszDevice);
BOOL __pascal __far MCIGETERRORSTRING(MCIERROR mcierr, LPSTR pszText, UINT cchText);
YIELDPROC __pascal __far MCIGETYIELDPROC(MCIDEVICEID mciId, LPDWORD pdwYieldData);
MCIERROR __pascal __far MCISENDCOMMAND(MCIDEVICEID mciId, UINT uMsg, DWORD dwParam1, DWORD dwParam2);
MCIERROR __pascal __far MCISENDSTRING(LPCSTR lpstrCommand, LPSTR lpstrReturnString, UINT uReturnLength, HWND hwndCallback);
BOOL __pascal __far MCISETYIELDPROC(MCIDEVICEID mciId, YIELDPROC fpYieldProc, DWORD dwYieldData);
MACRO_ERRNO MCI_ALL_DEVICE_ID;
MACRO_ERRNO MCI_ANIM_GETDEVCAPS_CAN_REVERSE;
MACRO_ERRNO MCI_ANIM_GETDEVCAPS_CAN_STRETCH;
MACRO_ERRNO MCI_ANIM_GETDEVCAPS_FAST_RATE;
MACRO_ERRNO MCI_ANIM_GETDEVCAPS_MAX_WINDOWS;
MACRO_ERRNO MCI_ANIM_GETDEVCAPS_NORMAL_RATE;
MACRO_ERRNO MCI_ANIM_GETDEVCAPS_PALETTES;
MACRO_ERRNO MCI_ANIM_GETDEVCAPS_SLOW_RATE;
MACRO_ERRNO MCI_ANIM_INFO_TEXT;
MACRO_ERRNO MCI_ANIM_OPEN_NOSTATIC;
MACRO_ERRNO MCI_ANIM_OPEN_PARENT;
MACRO_ERRNO MCI_ANIM_OPEN_WS;
MACRO_ERRNO MCI_ANIM_PLAY_FAST;
MACRO_ERRNO MCI_ANIM_PLAY_REVERSE;
MACRO_ERRNO MCI_ANIM_PLAY_SCAN;
MACRO_ERRNO MCI_ANIM_PLAY_SLOW;
MACRO_ERRNO MCI_ANIM_PLAY_SPEED;
MACRO_ERRNO MCI_ANIM_PUT_DESTINATION;
MACRO_ERRNO MCI_ANIM_PUT_SOURCE;
MACRO_ERRNO MCI_ANIM_REALIZE_BKGD;
MACRO_ERRNO MCI_ANIM_REALIZE_NORM;
MACRO_ERRNO MCI_ANIM_RECT;
MACRO_ERRNO MCI_ANIM_STATUS_FORWARD;
MACRO_ERRNO MCI_ANIM_STATUS_HPAL;
MACRO_ERRNO MCI_ANIM_STATUS_HWND;
MACRO_ERRNO MCI_ANIM_STATUS_SPEED;
MACRO_ERRNO MCI_ANIM_STATUS_STRETCH;
MACRO_ERRNO MCI_ANIM_STEP_FRAMES;
MACRO_ERRNO MCI_ANIM_STEP_REVERSE;
MACRO_ERRNO MCI_ANIM_UPDATE_HDC;
MACRO_ERRNO MCI_ANIM_WHERE_DESTINATION;
MACRO_ERRNO MCI_ANIM_WHERE_SOURCE;
MACRO_ERRNO MCI_ANIM_WINDOW_DEFAULT;
MACRO_ERRNO MCI_ANIM_WINDOW_DISABLE_STRETCH;
MACRO_ERRNO MCI_ANIM_WINDOW_ENABLE_STRETCH;
MACRO_ERRNO MCI_ANIM_WINDOW_HWND;
MACRO_ERRNO MCI_ANIM_WINDOW_STATE;
MACRO_ERRNO MCI_ANIM_WINDOW_TEXT;
MACRO_ERRNO MCI_BREAK;
MACRO_ERRNO MCI_BREAK_HWND;
MACRO_ERRNO MCI_BREAK_KEY;
MACRO_ERRNO MCI_BREAK_OFF;
MACRO_ERRNO MCI_CDA_STATUS_TYPE_TRACK;
MACRO_ERRNO MCI_CDA_TRACK_AUDIO;
MACRO_ERRNO MCI_CDA_TRACK_OTHER;
MACRO_ERRNO MCI_CD_OFFSET;
MACRO_ERRNO MCI_CLOSE;
MACRO_ERRNO MCI_COPY;
MACRO_ERRNO MCI_CUE;
MACRO_ERRNO MCI_CUT;
MACRO_ERRNO MCI_DELETE;
MACRO_ERRNO MCI_DEVTYPE_ANIMATION;
MACRO_ERRNO MCI_DEVTYPE_CD_AUDIO;
MACRO_ERRNO MCI_DEVTYPE_DAT;
MACRO_ERRNO MCI_DEVTYPE_DIGITAL_VIDEO;
MACRO_ERRNO MCI_DEVTYPE_FIRST;
MACRO_ERRNO MCI_DEVTYPE_FIRST_USER;
MACRO_ERRNO MCI_DEVTYPE_LAST;
MACRO_ERRNO MCI_DEVTYPE_OTHER;
MACRO_ERRNO MCI_DEVTYPE_OVERLAY;
MACRO_ERRNO MCI_DEVTYPE_SCANNER;
MACRO_ERRNO MCI_DEVTYPE_SEQUENCER;
MACRO_ERRNO MCI_DEVTYPE_VCR;
MACRO_ERRNO MCI_DEVTYPE_VIDEODISC;
MACRO_ERRNO MCI_DEVTYPE_WAVEFORM_AUDIO;
MACRO_ERRNO MCI_ESCAPE;
MACRO_ERRNO MCI_FIRST;
MACRO_ERRNO MCI_FORMAT_BYTES;
MACRO_ERRNO MCI_FORMAT_FRAMES;
MACRO_ERRNO MCI_FORMAT_HMS;
MACRO_ERRNO MCI_FORMAT_MILLISECONDS;
MACRO_ERRNO MCI_FORMAT_MSF;
MACRO_ERRNO MCI_FORMAT_SAMPLES;
MACRO_ERRNO MCI_FORMAT_SMPTE_24;
MACRO_ERRNO MCI_FORMAT_SMPTE_25;
MACRO_ERRNO MCI_FORMAT_SMPTE_30;
MACRO_ERRNO MCI_FORMAT_SMPTE_30DROP;
MACRO_ERRNO MCI_FORMAT_TMSF;
MACRO_ERRNO MCI_FREEZE;
MACRO_ERRNO MCI_FROM;
MACRO_ERRNO MCI_GETDEVCAPS;
MACRO_ERRNO MCI_GETDEVCAPS_CAN_EJECT;
MACRO_ERRNO MCI_GETDEVCAPS_CAN_PLAY;
MACRO_ERRNO MCI_GETDEVCAPS_CAN_RECORD;
MACRO_ERRNO MCI_GETDEVCAPS_CAN_SAVE;
MACRO_ERRNO MCI_GETDEVCAPS_COMPOUND_DEVICE;
MACRO_ERRNO MCI_GETDEVCAPS_DEVICE_TYPE;
MACRO_ERRNO MCI_GETDEVCAPS_HAS_AUDIO;
MACRO_ERRNO MCI_GETDEVCAPS_HAS_VIDEO;
MACRO_ERRNO MCI_GETDEVCAPS_ITEM;
MACRO_ERRNO MCI_GETDEVCAPS_USES_FILES;
MACRO_ERRNO MCI_INFO;
MACRO_ERRNO MCI_INFO_COPYRIGHT;
MACRO_ERRNO MCI_INFO_FILE;
MACRO_ERRNO MCI_INFO_MEDIA_IDENTITY;
MACRO_ERRNO MCI_INFO_MEDIA_UPC;
MACRO_ERRNO MCI_INFO_NAME;
MACRO_ERRNO MCI_INFO_PRODUCT;
MACRO_ERRNO MCI_LAST;
MACRO_ERRNO MCI_LOAD;
MACRO_ERRNO MCI_LOAD_FILE;
MACRO_ERRNO MCI_MODE_NOT_READY;
MACRO_ERRNO MCI_MODE_OPEN;
MACRO_ERRNO MCI_MODE_PAUSE;
MACRO_ERRNO MCI_MODE_PLAY;
MACRO_ERRNO MCI_MODE_RECORD;
MACRO_ERRNO MCI_MODE_SEEK;
MACRO_ERRNO MCI_MODE_STOP;
MACRO_ERRNO MCI_NOTIFY;
MACRO_ERRNO MCI_NOTIFY_ABORTED;
MACRO_ERRNO MCI_NOTIFY_FAILURE;
MACRO_ERRNO MCI_NOTIFY_SUCCESSFUL;
MACRO_ERRNO MCI_NOTIFY_SUPERSEDED;
MACRO_ERRNO MCI_OPEN;
MACRO_ERRNO MCI_OPEN_ALIAS;
MACRO_ERRNO MCI_OPEN_ELEMENT;
MACRO_ERRNO MCI_OPEN_ELEMENT_ID;
MACRO_ERRNO MCI_OPEN_SHAREABLE;
MACRO_ERRNO MCI_OPEN_TYPE;
MACRO_ERRNO MCI_OPEN_TYPE_ID;
MACRO_ERRNO MCI_OVLY_GETDEVCAPS_CAN_FREEZE;
MACRO_ERRNO MCI_OVLY_GETDEVCAPS_CAN_STRETCH;
MACRO_ERRNO MCI_OVLY_GETDEVCAPS_MAX_WINDOWS;
MACRO_ERRNO MCI_OVLY_INFO_TEXT;
MACRO_ERRNO MCI_OVLY_OPEN_PARENT;
MACRO_ERRNO MCI_OVLY_OPEN_WS;
MACRO_ERRNO MCI_OVLY_PUT_DESTINATION;
MACRO_ERRNO MCI_OVLY_PUT_FRAME;
MACRO_ERRNO MCI_OVLY_PUT_SOURCE;
MACRO_ERRNO MCI_OVLY_PUT_VIDEO;
MACRO_ERRNO MCI_OVLY_RECT;
MACRO_ERRNO MCI_OVLY_STATUS_HWND;
MACRO_ERRNO MCI_OVLY_STATUS_STRETCH;
MACRO_ERRNO MCI_OVLY_WHERE_DESTINATION;
MACRO_ERRNO MCI_OVLY_WHERE_FRAME;
MACRO_ERRNO MCI_OVLY_WHERE_SOURCE;
MACRO_ERRNO MCI_OVLY_WHERE_VIDEO;
MACRO_ERRNO MCI_OVLY_WINDOW_DEFAULT;
MACRO_ERRNO MCI_OVLY_WINDOW_DISABLE_STRETCH;
MACRO_ERRNO MCI_OVLY_WINDOW_ENABLE_STRETCH;
MACRO_ERRNO MCI_OVLY_WINDOW_HWND;
MACRO_ERRNO MCI_OVLY_WINDOW_STATE;
MACRO_ERRNO MCI_OVLY_WINDOW_TEXT;
MACRO_ERRNO MCI_PASTE;
MACRO_ERRNO MCI_PAUSE;
MACRO_ERRNO MCI_PLAY;
MACRO_ERRNO MCI_PUT;
MACRO_ERRNO MCI_REALIZE;
MACRO_ERRNO MCI_RECORD;
MACRO_ERRNO MCI_RECORD_INSERT;
MACRO_ERRNO MCI_RECORD_OVERWRITE;
MACRO_ERRNO MCI_RESUME;
MACRO_ERRNO MCI_SAVE;
MACRO_ERRNO MCI_SAVE_FILE;
MACRO_ERRNO MCI_SEEK;
MACRO_ERRNO MCI_SEEK_TO_END;
MACRO_ERRNO MCI_SEEK_TO_START;
MACRO_ERRNO MCI_SEQ_DIV_PPQN;
MACRO_ERRNO MCI_SEQ_DIV_SMPTE_24;
MACRO_ERRNO MCI_SEQ_DIV_SMPTE_25;
MACRO_ERRNO MCI_SEQ_DIV_SMPTE_30;
MACRO_ERRNO MCI_SEQ_DIV_SMPTE_30DROP;
MACRO_ERRNO MCI_SEQ_FILE;
MACRO_ERRNO MCI_SEQ_FORMAT_SONGPTR;
MACRO_ERRNO MCI_SEQ_MAPPER;
MACRO_ERRNO MCI_SEQ_MIDI;
MACRO_ERRNO MCI_SEQ_NONE;
MACRO_ERRNO MCI_SEQ_OFFSET;
MACRO_ERRNO MCI_SEQ_SET_MASTER;
MACRO_ERRNO MCI_SEQ_SET_OFFSET;
MACRO_ERRNO MCI_SEQ_SET_PORT;
MACRO_ERRNO MCI_SEQ_SET_SLAVE;
MACRO_ERRNO MCI_SEQ_SET_TEMPO;
MACRO_ERRNO MCI_SEQ_SMPTE;
MACRO_ERRNO MCI_SEQ_STATUS_COPYRIGHT;
MACRO_ERRNO MCI_SEQ_STATUS_DIVTYPE;
MACRO_ERRNO MCI_SEQ_STATUS_MASTER;
MACRO_ERRNO MCI_SEQ_STATUS_NAME;
MACRO_ERRNO MCI_SEQ_STATUS_OFFSET;
MACRO_ERRNO MCI_SEQ_STATUS_PORT;
MACRO_ERRNO MCI_SEQ_STATUS_SLAVE;
MACRO_ERRNO MCI_SEQ_STATUS_TEMPO;
MACRO_ERRNO MCI_SET;
MACRO_ERRNO MCI_SET_AUDIO;
MACRO_ERRNO MCI_SET_AUDIO_ALL;
MACRO_ERRNO MCI_SET_AUDIO_LEFT;
MACRO_ERRNO MCI_SET_AUDIO_RIGHT;
MACRO_ERRNO MCI_SET_DOOR_CLOSED;
MACRO_ERRNO MCI_SET_DOOR_OPEN;
MACRO_ERRNO MCI_SET_OFF;
MACRO_ERRNO MCI_SET_ON;
MACRO_ERRNO MCI_SET_TIME_FORMAT;
MACRO_ERRNO MCI_SET_VIDEO;
MACRO_ERRNO MCI_SPIN;
MACRO_ERRNO MCI_STATUS;
MACRO_ERRNO MCI_STATUS_CURRENT_TRACK;
MACRO_ERRNO MCI_STATUS_ITEM;
MACRO_ERRNO MCI_STATUS_LENGTH;
MACRO_ERRNO MCI_STATUS_MEDIA_PRESENT;
MACRO_ERRNO MCI_STATUS_MODE;
MACRO_ERRNO MCI_STATUS_NUMBER_OF_TRACKS;
MACRO_ERRNO MCI_STATUS_POSITION;
MACRO_ERRNO MCI_STATUS_READY;
MACRO_ERRNO MCI_STATUS_START;
MACRO_ERRNO MCI_STATUS_TIME_FORMAT;
MACRO_ERRNO MCI_STEP;
MACRO_ERRNO MCI_STOP;
MACRO_ERRNO MCI_STRING_OFFSET;
MACRO_ERRNO MCI_SYSINFO;
MACRO_ERRNO MCI_SYSINFO_INSTALLNAME;
MACRO_ERRNO MCI_SYSINFO_NAME;
MACRO_ERRNO MCI_SYSINFO_OPEN;
MACRO_ERRNO MCI_SYSINFO_QUANTITY;
MACRO_ERRNO MCI_TO;
MACRO_ERRNO MCI_TRACK;
MACRO_ERRNO MCI_UNFREEZE;
MACRO_ERRNO MCI_UPDATE;
MACRO_ERRNO MCI_USER_MESSAGES;
MACRO_ERRNO MCI_VD_ESCAPE_STRING;
MACRO_ERRNO MCI_VD_FORMAT_TRACK;
MACRO_ERRNO MCI_VD_GETDEVCAPS_CAN_REVERSE;
MACRO_ERRNO MCI_VD_GETDEVCAPS_CAV;
MACRO_ERRNO MCI_VD_GETDEVCAPS_CLV;
MACRO_ERRNO MCI_VD_GETDEVCAPS_FAST_RATE;
MACRO_ERRNO MCI_VD_GETDEVCAPS_NORMAL_RATE;
MACRO_ERRNO MCI_VD_GETDEVCAPS_SLOW_RATE;
MACRO_ERRNO MCI_VD_MEDIA_CAV;
MACRO_ERRNO MCI_VD_MEDIA_CLV;
MACRO_ERRNO MCI_VD_MEDIA_OTHER;
MACRO_ERRNO MCI_VD_MODE_PARK;
MACRO_ERRNO MCI_VD_OFFSET;
MACRO_ERRNO MCI_VD_PLAY_FAST;
MACRO_ERRNO MCI_VD_PLAY_REVERSE;
MACRO_ERRNO MCI_VD_PLAY_SCAN;
MACRO_ERRNO MCI_VD_PLAY_SLOW;
MACRO_ERRNO MCI_VD_PLAY_SPEED;
MACRO_ERRNO MCI_VD_SEEK_REVERSE;
MACRO_ERRNO MCI_VD_SPIN_DOWN;
MACRO_ERRNO MCI_VD_SPIN_UP;
MACRO_ERRNO MCI_VD_STATUS_DISC_SIZE;
MACRO_ERRNO MCI_VD_STATUS_FORWARD;
MACRO_ERRNO MCI_VD_STATUS_MEDIA_TYPE;
MACRO_ERRNO MCI_VD_STATUS_SIDE;
MACRO_ERRNO MCI_VD_STATUS_SPEED;
MACRO_ERRNO MCI_VD_STEP_FRAMES;
MACRO_ERRNO MCI_VD_STEP_REVERSE;
MACRO_ERRNO MCI_WAIT;
MACRO_ERRNO MCI_WAVE_GETDEVCAPS_INPUTS;
MACRO_ERRNO MCI_WAVE_GETDEVCAPS_OUTPUTS;
MACRO_ERRNO MCI_WAVE_INPUT;
MACRO_ERRNO MCI_WAVE_MAPPER;
MACRO_ERRNO MCI_WAVE_OFFSET;
MACRO_ERRNO MCI_WAVE_OPEN_BUFFER;
MACRO_ERRNO MCI_WAVE_OUTPUT;
MACRO_ERRNO MCI_WAVE_PCM;
MACRO_ERRNO MCI_WAVE_SET_ANYINPUT;
MACRO_ERRNO MCI_WAVE_SET_ANYOUTPUT;
MACRO_ERRNO MCI_WAVE_SET_AVGBYTESPERSEC;
MACRO_ERRNO MCI_WAVE_SET_BITSPERSAMPLE;
MACRO_ERRNO MCI_WAVE_SET_BLOCKALIGN;
MACRO_ERRNO MCI_WAVE_SET_CHANNELS;
MACRO_ERRNO MCI_WAVE_SET_FORMATTAG;
MACRO_ERRNO MCI_WAVE_SET_SAMPLESPERSEC;
MACRO_ERRNO MCI_WAVE_STATUS_AVGBYTESPERSEC;
MACRO_ERRNO MCI_WAVE_STATUS_BITSPERSAMPLE;
MACRO_ERRNO MCI_WAVE_STATUS_BLOCKALIGN;
MACRO_ERRNO MCI_WAVE_STATUS_CHANNELS;
MACRO_ERRNO MCI_WAVE_STATUS_FORMATTAG;
MACRO_ERRNO MCI_WAVE_STATUS_LEVEL;
MACRO_ERRNO MCI_WAVE_STATUS_SAMPLESPERSEC;
MACRO_ERRNO MCI_WHERE;
MACRO_ERRNO MCI_WINDOW;
MACRO_ERRNO MCW_EM;
MACRO_ERRNO MCW_IC;
MACRO_ERRNO MCW_PC;
MACRO_ERRNO MCW_RC;
...
MACRO_ERRNO MHDR_DONE;
MACRO_ERRNO MHDR_INQUEUE;
MACRO_ERRNO MHDR_ISSTRM;
MACRO_ERRNO MHDR_PREPARED;
MACRO_MH MH_CLEANUP;
MACRO_MH MH_CREATE;
MACRO_MH MH_DELETE;
MACRO_MH MH_KEEP;
MACRO_ERRNO MIDICAPS_CACHE;
MACRO_ERRNO MIDICAPS_LRVOLUME;
MACRO_ERRNO MIDICAPS_VOLUME;
MACRO_ERRNO MIDIERR_BADOPENMODE;
MACRO_ERRNO MIDIERR_BASE;
MACRO_ERRNO MIDIERR_DONT_CONTINUE;
MACRO_ERRNO MIDIERR_INVALIDSETUP;
MACRO_ERRNO MIDIERR_LASTERROR;
MACRO_ERRNO MIDIERR_NODEVICE;
MACRO_ERRNO MIDIERR_NOMAP;
MACRO_ERRNO MIDIERR_NOTREADY;
MACRO_ERRNO MIDIERR_STILLPLAYING;
MACRO_ERRNO MIDIERR_UNPREPARED;
MMRESULT __pascal __far MIDIINADDBUFFER(HMIDIIN hmi, LPMIDIHDR pmh, UINT cbmh);
MMRESULT __pascal __far MIDIINCLOSE(HMIDIIN hmi);
MMRESULT __pascal __far MIDIINGETDEVCAPS(UINT uDeviceID, LPMIDIINCAPS pmic, UINT cbmic);
MMRESULT __pascal __far MIDIINGETERRORTEXT(MMRESULT mmrError, LPSTR pszText, UINT cchText);
MMRESULT __pascal __far MIDIINGETID(HMIDIIN hmi, LPUINT puDeviceID);
UINT __pascal __far MIDIINGETNUMDEVS();
DWORD __pascal __far MIDIINMESSAGE(HMIDIIN hmi, UINT uMsg, DWORD dw1, DWORD dw2);
MMRESULT __pascal __far MIDIINOPEN(LPHMIDIIN phmi, UINT uDeviceID, DWORD dwCallback, DWORD dwInstance, DWORD fdwOpen);
MMRESULT __pascal __far MIDIINPREPAREHEADER(HMIDIIN hmi, LPMIDIHDR pmh, UINT cbmh);
MMRESULT __pascal __far MIDIINRESET(HMIDIIN hmi);
MMRESULT __pascal __far MIDIINSTART(HMIDIIN hmi);
MMRESULT __pascal __far MIDIINSTOP(HMIDIIN hmi);
MMRESULT __pascal __far MIDIINUNPREPAREHEADER(HMIDIIN hmi, LPMIDIHDR pmh, UINT cbmh);
MACRO_ERRNO MIDIMAPPER;
MMRESULT __pascal __far MIDIOUTCACHEDRUMPATCHES(HMIDIOUT hmo, UINT uPatch, LPWORD pwkya, UINT fuCache);
MMRESULT __pascal __far MIDIOUTCACHEPATCHES(HMIDIOUT hmo, UINT uBank, LPWORD pwpa, UINT fuCache);
MMRESULT __pascal __far MIDIOUTCLOSE(HMIDIOUT hmo);
MMRESULT __pascal __far MIDIOUTGETDEVCAPS(UINT uDeviceID, LPMIDIOUTCAPS pmoc, UINT cbmoc);
MMRESULT __pascal __far MIDIOUTGETERRORTEXT(MMRESULT mmrError, LPSTR pszText, UINT cchText);
MMRESULT __pascal __far MIDIOUTGETID(HMIDIOUT hmo, LPUINT puDeviceID);
UINT __pascal __far MIDIOUTGETNUMDEVS();
MMRESULT __pascal __far MIDIOUTGETVOLUME(UINT uId, LPDWORD pdwVolume);
MMRESULT __pascal __far MIDIOUTLONGMSG(HMIDIOUT hmo, LPMIDIHDR pmh, UINT cbmh);
DWORD __pascal __far MIDIOUTMESSAGE(HMIDIOUT hmo, UINT uMsg, DWORD dw1, DWORD dw2);
MMRESULT __pascal __far MIDIOUTOPEN(LPHMIDIOUT phmo, UINT uDeviceID, DWORD dwCallback, DWORD dwInstance, DWORD fdwOpen);
MMRESULT __pascal __far MIDIOUTPREPAREHEADER(HMIDIOUT hmo, LPMIDIHDR pmh, UINT cbmh);
MMRESULT __pascal __far MIDIOUTRESET(HMIDIOUT hmo);
MMRESULT __pascal __far MIDIOUTSETVOLUME(UINT uId, DWORD dwVolume);
MMRESULT __pascal __far MIDIOUTSHORTMSG(HMIDIOUT hmo, DWORD dwMsg);
MMRESULT __pascal __far MIDIOUTUNPREPAREHEADER(HMIDIOUT hmo, LPMIDIHDR pmh, UINT cbmh);
MACRO_ERRNO MIDIPATCHSIZE;
MACRO_ERRNO MIDI_CACHE_ALL;
MACRO_ERRNO MIDI_CACHE_BESTFIT;
MACRO_ERRNO MIDI_CACHE_QUERY;
MACRO_ERRNO MIDI_MAPPER;
MACRO_ERRNO MIDI_UNCACHE;
MACRO_ERRNO MIM_CLOSE;
MACRO_ERRNO MIM_DATA;
MACRO_ERRNO MIM_ERROR;
MACRO_ERRNO MIM_LONGDATA;
MACRO_ERRNO MIM_LONGERROR;
MACRO_ERRNO MIM_OPEN;
MMRESULT __pascal __far MIXERCLOSE(HMIXER hmx);
MACRO_ERRNO MIXERCONTROL_CONTROLF_DISABLED;
MACRO_ERRNO MIXERCONTROL_CONTROLF_MULTIPLE;
MACRO_ERRNO MIXERCONTROL_CONTROLF_UNIFORM;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_BASS;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_BOOLEAN;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_BOOLEANMETER;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_BUTTON;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_CUSTOM;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_DECIBELS;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_EQUALIZER;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_FADER;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_LOUDNESS;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_MICROTIME;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_MILLITIME;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_MIXER;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_MONO;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_MULTIPLESELECT;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_MUTE;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_MUX;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_ONOFF;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_PAN;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_PEAKMETER;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_PERCENT;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_QSOUNDPAN;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_SIGNED;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_SIGNEDMETER;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_SINGLESELECT;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_SLIDER;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_STEREOENH;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_TREBLE;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_UNSIGNED;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_UNSIGNEDMETER;
MACRO_ERRNO MIXERCONTROL_CONTROLTYPE_VOLUME;
MACRO_ERRNO MIXERCONTROL_CT_CLASS_CUSTOM;
MACRO_ERRNO MIXERCONTROL_CT_CLASS_FADER;
MACRO_ERRNO MIXERCONTROL_CT_CLASS_LIST;
MACRO_ERRNO MIXERCONTROL_CT_CLASS_MASK;
MACRO_ERRNO MIXERCONTROL_CT_CLASS_METER;
MACRO_ERRNO MIXERCONTROL_CT_CLASS_NUMBER;
MACRO_ERRNO MIXERCONTROL_CT_CLASS_SLIDER;
MACRO_ERRNO MIXERCONTROL_CT_CLASS_SWITCH;
MACRO_ERRNO MIXERCONTROL_CT_CLASS_TIME;
MACRO_ERRNO MIXERCONTROL_CT_SC_LIST_MULTIPLE;
MACRO_ERRNO MIXERCONTROL_CT_SC_LIST_SINGLE;
MACRO_ERRNO MIXERCONTROL_CT_SC_METER_POLLED;
MACRO_ERRNO MIXERCONTROL_CT_SC_SWITCH_BOOLEAN;
MACRO_ERRNO MIXERCONTROL_CT_SC_SWITCH_BUTTON;
MACRO_ERRNO MIXERCONTROL_CT_SC_TIME_MICROSECS;
MACRO_ERRNO MIXERCONTROL_CT_SC_TIME_MILLISECS;
MACRO_ERRNO MIXERCONTROL_CT_SUBCLASS_MASK;
MACRO_ERRNO MIXERCONTROL_CT_UNITS_BOOLEAN;
MACRO_ERRNO MIXERCONTROL_CT_UNITS_CUSTOM;
MACRO_ERRNO MIXERCONTROL_CT_UNITS_DECIBELS;
MACRO_ERRNO MIXERCONTROL_CT_UNITS_MASK;
MACRO_ERRNO MIXERCONTROL_CT_UNITS_PERCENT;
MACRO_ERRNO MIXERCONTROL_CT_UNITS_SIGNED;
MACRO_ERRNO MIXERCONTROL_CT_UNITS_UNSIGNED;
MMRESULT __pascal __far MIXERGETCONTROLDETAILS(HMIXEROBJ hmxobj, LPMIXERCONTROLDETAILS pmxcd, DWORD fdwDetails);
MMRESULT __pascal __far MIXERGETDEVCAPS(UINT uMxId, LPMIXERCAPS pmxcaps, UINT cbmxcaps);
MMRESULT __pascal __far MIXERGETID(HMIXEROBJ hmxobj, UINT far *puMxId, DWORD fdwId);
MMRESULT __pascal __far MIXERGETLINECONTROLS(HMIXEROBJ hmxobj, LPMIXERLINECONTROLS pmxlc, DWORD fdwControls);
MMRESULT __pascal __far MIXERGETLINEINFO(HMIXEROBJ hmxobj, LPMIXERLINE pmxl, DWORD fdwInfo);
UINT __pascal __far MIXERGETNUMDEVS();
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_DIGITAL;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_FIRST;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_HEADPHONES;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_LAST;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_LINE;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_MONITOR;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_SPEAKERS;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_TELEPHONE;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_UNDEFINED;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_VOICEIN;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_DST_WAVEIN;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_ANALOG;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_AUXILIARY;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_COMPACTDISC;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_DIGITAL;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_FIRST;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_LAST;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_LINE;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_MICROPHONE;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_PCSPEAKER;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_SYNTHESIZER;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_TELEPHONE;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_UNDEFINED;
MACRO_ERRNO MIXERLINE_COMPONENTTYPE_SRC_WAVEOUT;
MACRO_ERRNO MIXERLINE_LINEF_ACTIVE;
MACRO_ERRNO MIXERLINE_LINEF_DISCONNECTED;
MACRO_ERRNO MIXERLINE_LINEF_SOURCE;
MACRO_ERRNO MIXERLINE_TARGETTYPE_AUX;
MACRO_ERRNO MIXERLINE_TARGETTYPE_MIDIIN;
MACRO_ERRNO MIXERLINE_TARGETTYPE_MIDIOUT;
MACRO_ERRNO MIXERLINE_TARGETTYPE_UNDEFINED;
MACRO_ERRNO MIXERLINE_TARGETTYPE_WAVEIN;
MACRO_ERRNO MIXERLINE_TARGETTYPE_WAVEOUT;
DWORD __pascal __far MIXERMESSAGE(HMIXER hmx, UINT uMsg, DWORD dwParam1, DWORD dwParam2);
MMRESULT __pascal __far MIXEROPEN(LPHMIXER phmx, UINT uMxId, DWORD dwCallback, DWORD dwInstance, DWORD fdwOpen);
MACRO_ERRNO MIXERR_BASE;
MACRO_ERRNO MIXERR_INVALCONTROL;
MACRO_ERRNO MIXERR_INVALLINE;
MACRO_ERRNO MIXERR_INVALVALUE;
MACRO_ERRNO MIXERR_LASTERROR;
MMRESULT __pascal __far MIXERSETCONTROLDETAILS(HMIXEROBJ hmxobj, LPMIXERCONTROLDETAILS pmxcd, DWORD fdwDetails);
MACRO_ERRNO MIXER_GETCONTROLDETAILSF_LISTTEXT;
MACRO_ERRNO MIXER_GETCONTROLDETAILSF_QUERYMASK;
MACRO_ERRNO MIXER_GETCONTROLDETAILSF_VALUE;
MACRO_ERRNO MIXER_GETLINECONTROLSF_ALL;
MACRO_ERRNO MIXER_GETLINECONTROLSF_ONEBYID;
MACRO_ERRNO MIXER_GETLINECONTROLSF_ONEBYTYPE;
MACRO_ERRNO MIXER_GETLINECONTROLSF_QUERYMASK;
MACRO_ERRNO MIXER_GETLINEINFOF_COMPONENTTYPE;
MACRO_ERRNO MIXER_GETLINEINFOF_DESTINATION;
MACRO_ERRNO MIXER_GETLINEINFOF_LINEID;
MACRO_ERRNO MIXER_GETLINEINFOF_QUERYMASK;
MACRO_ERRNO MIXER_GETLINEINFOF_SOURCE;
MACRO_ERRNO MIXER_GETLINEINFOF_TARGETTYPE;
MACRO_ERRNO MIXER_LONG_NAME_CHARS;
MACRO_ERRNO MIXER_OBJECTF_AUX;
MACRO_ERRNO MIXER_OBJECTF_HANDLE;
MACRO_ERRNO MIXER_OBJECTF_HMIDIIN;
MACRO_ERRNO MIXER_OBJECTF_HMIDIOUT;
MACRO_ERRNO MIXER_OBJECTF_HMIXER;
MACRO_ERRNO MIXER_OBJECTF_HWAVEIN;
MACRO_ERRNO MIXER_OBJECTF_HWAVEOUT;
MACRO_ERRNO MIXER_OBJECTF_MIDIIN;
MACRO_ERRNO MIXER_OBJECTF_MIDIOUT;
MACRO_ERRNO MIXER_OBJECTF_MIXER;
MACRO_ERRNO MIXER_OBJECTF_WAVEIN;
MACRO_ERRNO MIXER_OBJECTF_WAVEOUT;
MACRO_ERRNO MIXER_SETCONTROLDETAILSF_CUSTOM;
MACRO_ERRNO MIXER_SETCONTROLDETAILSF_QUERYMASK;
MACRO_ERRNO MIXER_SETCONTROLDETAILSF_VALUE;
MACRO_ERRNO MIXER_SHORT_NAME_CHARS;
...
MMRESULT __pascal __far MMIOADVANCE(HMMIO hmmio, LPMMIOINFO pmmioinfo, UINT fuAdvance);
MMRESULT __pascal __far MMIOASCEND(HMMIO hmmio, LPMMCKINFO pmmcki, UINT fuAscend);
MMRESULT __pascal __far MMIOCLOSE(HMMIO hmmio, UINT fuClose);
MMRESULT __pascal __far MMIOCREATECHUNK(HMMIO hmmio, LPMMCKINFO pmmcki, UINT fuCreate);
MMRESULT __pascal __far MMIODESCEND(HMMIO hmmio, LPMMCKINFO pmmcki, const MMCKINFO far *pmmckiParent, UINT fuDescend);
MACRO_ERRNO MMIOERR_ACCESSDENIED;
MACRO_ERRNO MMIOERR_BASE;
MACRO_ERRNO MMIOERR_CANNOTCLOSE;
MACRO_ERRNO MMIOERR_CANNOTEXPAND;
MACRO_ERRNO MMIOERR_CANNOTOPEN;
MACRO_ERRNO MMIOERR_CANNOTREAD;
MACRO_ERRNO MMIOERR_CANNOTSEEK;
MACRO_ERRNO MMIOERR_CANNOTWRITE;
MACRO_ERRNO MMIOERR_CHUNKNOTFOUND;
MACRO_ERRNO MMIOERR_FILENOTFOUND;
MACRO_ERRNO MMIOERR_INVALIDFILE;
MACRO_ERRNO MMIOERR_NETWORKERROR;
MACRO_ERRNO MMIOERR_OUTOFMEMORY;
MACRO_ERRNO MMIOERR_PATHNOTFOUND;
MACRO_ERRNO MMIOERR_SHARINGVIOLATION;
MACRO_ERRNO MMIOERR_TOOMANYOPENFILES;
MACRO_ERRNO MMIOERR_UNBUFFERED;
MMRESULT __pascal __far MMIOFLUSH(HMMIO hmmio, UINT fuFlush);
MMRESULT __pascal __far MMIOGETINFO(HMMIO hmmio, LPMMIOINFO pmmioinfo, UINT fuInfo);
LPMMIOPROC __pascal __far MMIOINSTALLIOPROC(FOURCC fccIOProc, LPMMIOPROC pIOProc, DWORD dwFlags);
MACRO_ERRNO MMIOM_CLOSE;
MACRO_ERRNO MMIOM_OPEN;
MACRO_ERRNO MMIOM_READ;
MACRO_ERRNO MMIOM_RENAME;
MACRO_ERRNO MMIOM_SEEK;
MACRO_ERRNO MMIOM_USER;
MACRO_ERRNO MMIOM_WRITE;
MACRO_ERRNO MMIOM_WRITEFLUSH;
HMMIO __pascal __far MMIOOPEN(LPSTR pszFileName, LPMMIOINFO pmmioinfo, DWORD fdwOpen);
__int32 __pascal __far MMIOREAD(HMMIO hmmio, HPSTR pch, __int32 cch);
MMRESULT __pascal __far MMIORENAME(LPCSTR pszFileName, LPCSTR pszNewFileName, const MMIOINFO far *pmmioinfo, DWORD fdwRename);
__int32 __pascal __far MMIOSEEK(HMMIO hmmio, __int32 lOffset, int iOrigin);
LRESULT __pascal __far MMIOSENDMESSAGE(HMMIO hmmio, UINT uMsg, LPARAM lParam1, LPARAM lParam2);
MMRESULT __pascal __far MMIOSETBUFFER(HMMIO hmmio, LPSTR pchBuffer, __int32 cchBuffer, UINT fuBuffer);
MMRESULT __pascal __far MMIOSETINFO(HMMIO hmmio, LPCMMIOINFO pmmioinfo, UINT fuInfo);
...
MACRO_ERRNO MMIO_ALLOCBUF;
MACRO_ERRNO MMIO_COMPAT;
MACRO_ERRNO MMIO_CREATE;
MACRO_ERRNO MMIO_CREATELIST;
MACRO_ERRNO MMIO_CREATERIFF;
MACRO_ERRNO MMIO_DEFAULTBUFFER;
MACRO_ERRNO MMIO_DELETE;
MACRO_ERRNO MMIO_DENYNONE;
MACRO_ERRNO MMIO_DENYREAD;
MACRO_ERRNO MMIO_DENYWRITE;
MACRO_ERRNO MMIO_DIRTY;
MACRO_ERRNO MMIO_EMPTYBUF;
MACRO_ERRNO MMIO_EXCLUSIVE;
MACRO_ERRNO MMIO_EXIST;
MACRO_ERRNO MMIO_FHOPEN;
MACRO_ERRNO MMIO_FINDCHUNK;
MACRO_ERRNO MMIO_FINDLIST;
MACRO_ERRNO MMIO_FINDPROC;
MACRO_ERRNO MMIO_FINDRIFF;
MACRO_ERRNO MMIO_GETTEMP;
MACRO_ERRNO MMIO_GLOBALPROC;
MACRO_ERRNO MMIO_INSTALLPROC;
MACRO_ERRNO MMIO_PARSE;
MACRO_ERRNO MMIO_READ;
MACRO_ERRNO MMIO_READWRITE;
MACRO_ERRNO MMIO_REMOVEPROC;
MACRO_ERRNO MMIO_RWMODE;
MACRO_ERRNO MMIO_SHAREMODE;
MACRO_ERRNO MMIO_TOUPPER;
MACRO_ERRNO MMIO_UNICODEPROC;
MACRO_ERRNO MMIO_WRITE;
MACRO_ERRNO MMSYSERR_ALLOCATED;
MACRO_ERRNO MMSYSERR_BADDB;
MACRO_ERRNO MMSYSERR_BADDEVICEID;
MACRO_ERRNO MMSYSERR_BADERRNUM;
MACRO_ERRNO MMSYSERR_BASE;
MACRO_ERRNO MMSYSERR_DELETEERROR;
MACRO_ERRNO MMSYSERR_ERROR;
MACRO_ERRNO MMSYSERR_HANDLEBUSY;
MACRO_ERRNO MMSYSERR_INVALFLAG;
MACRO_ERRNO MMSYSERR_INVALHANDLE;
MACRO_ERRNO MMSYSERR_INVALIDALIAS;
MACRO_ERRNO MMSYSERR_INVALPARAM;
MACRO_ERRNO MMSYSERR_KEYNOTFOUND;
MACRO_ERRNO MMSYSERR_LASTERROR;
MACRO_ERRNO MMSYSERR_NODRIVER;
MACRO_ERRNO MMSYSERR_NODRIVERCB;
MACRO_ERRNO MMSYSERR_NOERROR;
MACRO_ERRNO MMSYSERR_NOMEM;
MACRO_ERRNO MMSYSERR_NOTENABLED;
MACRO_ERRNO MMSYSERR_NOTSUPPORTED;
MACRO_ERRNO MMSYSERR_READERROR;
MACRO_ERRNO MMSYSERR_VALNOTFOUND;
MACRO_ERRNO MMSYSERR_WRITEERROR;
UINT __pascal __far MMSYSTEMGETVERSION();
MACRO_ERRNO MM_ADLIB;
MACRO_MM MM_ANISOTROPIC;
MACRO_ERRNO MM_DRVM_CLOSE;
MACRO_ERRNO MM_DRVM_DATA;
MACRO_ERRNO MM_DRVM_ERROR;
MACRO_ERRNO MM_DRVM_OPEN;
MACRO_MM MM_HIENGLISH;
MACRO_MM MM_HIMETRIC;
MACRO_MM MM_ISOTROPIC;
MACRO_ERRNO MM_JOY1BUTTONDOWN;
MACRO_ERRNO MM_JOY1BUTTONUP;
MACRO_ERRNO MM_JOY1MOVE;
MACRO_ERRNO MM_JOY1ZMOVE;
MACRO_ERRNO MM_JOY2BUTTONDOWN;
MACRO_ERRNO MM_JOY2BUTTONUP;
MACRO_ERRNO MM_JOY2MOVE;
MACRO_ERRNO MM_JOY2ZMOVE;
MACRO_MM MM_LOENGLISH;
MACRO_MM MM_LOMETRIC;
MACRO_ERRNO MM_MCINOTIFY;
MACRO_ERRNO MM_MICROSOFT;
MACRO_ERRNO MM_MIDI_MAPPER;
MACRO_ERRNO MM_MIM_CLOSE;
MACRO_ERRNO MM_MIM_DATA;
MACRO_ERRNO MM_MIM_ERROR;
MACRO_ERRNO MM_MIM_LONGDATA;
MACRO_ERRNO MM_MIM_LONGERROR;
MACRO_ERRNO MM_MIM_OPEN;
MACRO_ERRNO MM_MIXM_CONTROL_CHANGE;
MACRO_ERRNO MM_MIXM_LINE_CHANGE;
MACRO_ERRNO MM_MOM_CLOSE;
MACRO_ERRNO MM_MOM_DONE;
MACRO_ERRNO MM_MOM_OPEN;
MACRO_ERRNO MM_MPU401_MIDIIN;
MACRO_ERRNO MM_MPU401_MIDIOUT;
MACRO_ERRNO MM_PC_JOYSTICK;
MACRO_ERRNO MM_SNDBLST_MIDIIN;
MACRO_ERRNO MM_SNDBLST_MIDIOUT;
MACRO_ERRNO MM_SNDBLST_SYNTH;
MACRO_ERRNO MM_SNDBLST_WAVEIN;
MACRO_ERRNO MM_SNDBLST_WAVEOUT;
MACRO_ERRNO MM_STREAM_CLOSE;
MACRO_ERRNO MM_STREAM_DONE;
MACRO_ERRNO MM_STREAM_ERROR;
MACRO_ERRNO MM_STREAM_OPEN;
MACRO_MM MM_TEXT;
MACRO_MM MM_TWIPS;
MACRO_ERRNO MM_WAVE_MAPPER;
MACRO_ERRNO MM_WIM_CLOSE;
MACRO_ERRNO MM_WIM_DATA;
MACRO_ERRNO MM_WIM_OPEN;
MACRO_ERRNO MM_WOM_CLOSE;
MACRO_ERRNO MM_WOM_DONE;
MACRO_ERRNO MM_WOM_OPEN;
int __pascal __far MNLS_COMPARESTRINGA(LCID Locale, DWORD dwCmpFlags, LPCSTR lpString1, int cchCount1, LPCSTR lpString2, int cchCount2);
int __pascal __far MNLS_COMPARESTRINGW(LCID Locale, DWORD dwCmpFlags, LPCWSTR lpString1, int cchCount1, LPCWSTR lpString2, int cchCount2);
UINT __pascal __far MNLS_GETACP();
LCID __pascal __far MNLS_GETUSERDEFAULTLCID();
BOOL __pascal __far MNLS_ISBADSTRINGPTRW(LPCWSTR lpsz, UINT ucchMax);
int __pascal __far MNLS_LSTRCMPW(LPCWSTR lpString1, LPCWSTR lpString2);
LPWSTR __pascal __far MNLS_LSTRCPYW(LPWSTR lpString1, LPCWSTR lpString2);
int __pascal __far MNLS_LSTRLENW(LPCWSTR lpString);
int __pascal __far MNLS_MULTIBYTETOWIDECHAR(UINT uCodePage, DWORD dwFlags, LPCSTR lpMultiByteStr, int cchMultiByte, LPWSTR lpWideCharStr, int cchWideChar);
int __pascal __far MNLS_WIDECHARTOMULTIBYTE(UINT uCodePage, DWORD dwFlags, LPCWSTR lpWideCharStr, int cchWideChar, LPSTR lpMultiByteStr, int cchMultiByte, LPCSTR lpDefaultChar, BOOL far *lpfUsedDefaultChar);
...
MACRO_ERRNO MOD_FMSYNTH;
MACRO_ERRNO MOD_MAPPER;
MACRO_ERRNO MOD_MIDIPORT;
MACRO_ERRNO MOD_SQSYNTH;
MACRO_ERRNO MOD_SYNTH;
MACRO_ERRNO MOM_CLOSE;
MACRO_ERRNO MOM_DONE;
MACRO_ERRNO MOM_OPEN;
...
MACRO_NETBIOS NETBIOS_GROUP_NAME;
MACRO_NETBIOS NETBIOS_NAME_LENGTH;
MACRO_NETBIOS NETBIOS_TYPE_QUICK_GROUP;
MACRO_NETBIOS NETBIOS_TYPE_QUICK_UNIQUE;
MACRO_NETBIOS NETBIOS_UNIQUE_NAME;
MACRO_NEWFRAME NEWFRAME;
MACRO_ERRNO NEWTRANSPARENT;
...
MACRO_ERRNO NORM_IGNOREKASHIDA;
...
unsigned __int32 __pascal __far OABUILDVERSION();
MACRO_OBJ OBJ_BRUSH;
MACRO_OBJ OBJ_PEN;
...
MACRO_PF PF_SNA;
MACRO_PF PF_UNIX;
MACRO_PF PF_UNKNOWN1;
MACRO_PF PF_UNSPEC;
MACRO_PF PF_VOICEVIEW;
...
BOOL __pascal __far PLAYSOUND(LPCSTR pszSound, HMODULE hmod, DWORD fdwSound);
...
HRESULT __pascal __far REGISTERACTIVEOBJECT(IUnknown far *punk, const CLSID far *const rclsid, unsigned __int32 dwFlags, unsigned __int32 far *pdwRegister);
...
HRESULT __pascal __far REGISTERTYPELIB(ITypeLib far *ptlib, char far *szFullPath, char far *szHelpDir);
...
HRESULT __pascal __far SAFEARRAYPTROFINDEX(SAFEARRAY far *psa, __int32 far *rgIndices, void far * far *ppvData);
...
HRESULT __pascal __far SETERRORINFO(unsigned __int32 dwReserved, IErrorInfo far *perrinfo);
...
int __pascal __far SETJMP(struct __jmp_buf far *jmpb);
...
MACRO_ERRNO SE_ERR_ASSOCINCOMPLETE;
MACRO_ERRNO SE_ERR_DDEBUSY;
MACRO_ERRNO SE_ERR_DDEFAIL;
MACRO_ERRNO SE_ERR_DDETIMEOUT;
MACRO_ERRNO SE_ERR_NOASSOC;
MACRO_ERRNO SE_ERR_SHARE;
...
BOOL __pascal __far SNDPLAYSOUND(LPCSTR pszSound, UINT fuSound);
MACRO_ERRNO SND_ALIAS;
MACRO_ERRNO SND_ALIAS_ID;
MACRO_ERRNO SND_ALIAS_START;
MACRO_ERRNO SND_ASYNC;
MACRO_ERRNO SND_FILENAME;
MACRO_ERRNO SND_LOOP;
MACRO_ERRNO SND_MEMORY;
MACRO_ERRNO SND_NODEFAULT;
MACRO_ERRNO SND_NOSTOP;
MACRO_ERRNO SND_NOWAIT;
MACRO_ERRNO SND_RESOURCE;
MACRO_ERRNO SND_SYNC;
...
MACRO_SO SO_TYPE;
MACRO_SO SO_UPDATE_ACCEPT_CONTEXT;
...
MACRO_ERRNO SUBLANG_CHINESE_SIMPLIFIED;
MACRO_ERRNO SUBLANG_CHINESE_TRADITIONAL;
MACRO_ERRNO SUBLANG_DEFAULT;
MACRO_ERRNO SUBLANG_DUTCH;
MACRO_ERRNO SUBLANG_DUTCH_BELGIAN;
MACRO_ERRNO SUBLANG_ENGLISH_AUS;
MACRO_ERRNO SUBLANG_ENGLISH_CAN;
MACRO_ERRNO SUBLANG_ENGLISH_EIRE;
MACRO_ERRNO SUBLANG_ENGLISH_NZ;
MACRO_ERRNO SUBLANG_ENGLISH_UK;
MACRO_ERRNO SUBLANG_ENGLISH_US;
MACRO_ERRNO SUBLANG_FRENCH;
MACRO_ERRNO SUBLANG_FRENCH_BELGIAN;
MACRO_ERRNO SUBLANG_FRENCH_CANADIAN;
MACRO_ERRNO SUBLANG_FRENCH_SWISS;
MACRO_ERRNO SUBLANG_GERMAN;
MACRO_ERRNO SUBLANG_GERMAN_AUSTRIAN;
MACRO_ERRNO SUBLANG_GERMAN_SWISS;
MACRO_ERRNO SUBLANG_ITALIAN;
MACRO_ERRNO SUBLANG_ITALIAN_SWISS;
MACRO_ERRNO SUBLANG_NEUTRAL;
MACRO_ERRNO SUBLANG_NORWEGIAN_BOKMAL;
MACRO_ERRNO SUBLANG_NORWEGIAN_NYNORSK;
MACRO_ERRNO SUBLANG_PORTUGUESE;
MACRO_ERRNO SUBLANG_PORTUGUESE_BRAZILIAN;
MACRO_ERRNO SUBLANG_SERBO_CROATIAN_CYRILLIC;
MACRO_ERRNO SUBLANG_SERBO_CROATIAN_LATIN;
MACRO_ERRNO SUBLANG_SPANISH;
MACRO_ERRNO SUBLANG_SPANISH_MEXICAN;
MACRO_ERRNO SUBLANG_SPANISH_MODERN;
MACRO_ERRNO SUBLANG_SYS_DEFAULT;
...
BSTR __pascal __far SYSALLOCSTRING(const char far *);
BSTR __pascal __far SYSALLOCSTRINGLEN(const char far *, unsigned int);
void __pascal __far SYSFREESTRING(BSTR);
MACRO_SYSPAL SYSPAL_NOSTATIC;
MACRO_SYSPAL SYSPAL_STATIC;
int __pascal __far SYSREALLOCSTRING(BSTR far *, const char far *);
int __pascal __far SYSREALLOCSTRINGLEN(BSTR far *, const char far *, unsigned int);
...
MMRESULT __pascal __far TIMEBEGINPERIOD(UINT uPeriod);
MMRESULT __pascal __far TIMEENDPERIOD(UINT uPeriod);
MMRESULT __pascal __far TIMEGETDEVCAPS(LPTIMECAPS ptc, UINT cbtc);
MMRESULT __pascal __far TIMEGETSYSTEMTIME(LPMMTIME pmmt, UINT cbmmt);
DWORD __pascal __far TIMEGETTIME();
MMRESULT __pascal __far TIMEKILLEVENT(UINT uTimerID);
MACRO_TIMEOUT TIMEOUT_ASYNC;
BOOL __pascal __far TIMERCOUNT(TIMERINFO far *lpTimer);
MACRO_ERRNO TIMERR_BASE;
MACRO_ERRNO TIMERR_NOCANDO;
MACRO_ERRNO TIMERR_NOERROR;
MACRO_ERRNO TIMERR_STRUCT;
MMRESULT __pascal __far TIMESETEVENT(UINT uDelay, UINT uResolution, LPTIMECALLBACK fptc, DWORD dwUser, UINT fuEvent);
MACRO_ERRNO TIME_BYTES;
MACRO_ERRNO TIME_MIDI;
MACRO_ERRNO TIME_MS;
MACRO_ERRNO TIME_ONESHOT;
MACRO_ERRNO TIME_PERIODIC;
MACRO_ERRNO TIME_SAMPLES;
MACRO_ERRNO TIME_SMPTE;
MACRO_ERRNO TIME_TICKS;
...
HRESULT __pascal __far VARBOOLFROMSTR(char far *strIn, LCID lcid, unsigned __int32 dwFlags, VARIANT_BOOL far *pboolOut);
HRESULT __pascal __far VARBOOLFROMUI1(unsigned __int8 bIn, VARIANT_BOOL far *pboolOut);
...
HRESULT __pascal __far VARBSTRFROMUI1(unsigned __int8 bVal, LCID lcid, unsigned __int32 dwFlags, BSTR far *pbstrOut);
...
HRESULT __pascal __far VARCYFROMSTR(char far *strIn, LCID lcid, unsigned __int32 dwFlags, CY far *pcyOut);
HRESULT __pascal __far VARCYFROMUI1(unsigned __int8 bIn, CY far *pcyOut);
...
HRESULT __pascal __far VARDATEFROMSTR(char far *strIn, LCID lcid, unsigned __int32 dwFlags, DATE far *pdateOut);
HRESULT __pascal __far VARDATEFROMUI1(unsigned __int8 bIn, DATE far *pdateOut);
...
HRESULT __pascal __far VARI2FROMSTR(char far *strIn, LCID lcid, unsigned __int32 dwFlags, int far *psOut);
HRESULT __pascal __far VARI2FROMUI1(unsigned __int8 bIn, int far *psOut);
...
HRESULT __pascal __far VARI4FROMSTR(char far *strIn, LCID lcid, unsigned __int32 dwFlags, __int32 far *plOut);
HRESULT __pascal __far VARI4FROMUI1(unsigned __int8 bIn, __int32 far *plOut);
...
HRESULT __pascal __far VARR4FROMSTR(char far *strIn, LCID lcid, unsigned __int32 dwFlags, float far *pfltOut);
HRESULT __pascal __far VARR4FROMUI1(unsigned __int8 bIn, float far *pfltOut);
...
HRESULT __pascal __far VARR8FROMSTR(char far *strIn, LCID lcid, unsigned __int32 dwFlags, double far *pdblOut);
HRESULT __pascal __far VARR8FROMUI1(unsigned __int8 bIn, double far *pdblOut);
HRESULT __pascal __far VARUI1FROMBOOL(VARIANT_BOOL boolIn, unsigned __int8 far *pbOut);
HRESULT __pascal __far VARUI1FROMCY(CY cyIn, unsigned __int8 far *pbOut);
HRESULT __pascal __far VARUI1FROMDATE(DATE dateIn, unsigned __int8 far *pbOut);
HRESULT __pascal __far VARUI1FROMDISP(IDispatch far *pdispIn, LCID lcid, unsigned __int8 far *pbOut);
HRESULT __pascal __far VARUI1FROMI2(int sIn, unsigned __int8 far *pbOut);
HRESULT __pascal __far VARUI1FROMI4(__int32 lIn, unsigned __int8 far *pbOut);
HRESULT __pascal __far VARUI1FROMR4(float fltIn, unsigned __int8 far *pbOut);
HRESULT __pascal __far VARUI1FROMR8(double dblIn, unsigned __int8 far *pbOut);
HRESULT __pascal __far VARUI1FROMSTR(char far *strIn, LCID lcid, unsigned __int32 dwFlags, unsigned __int8 far *pbOut);
...
MACRO_ERRNO VCAPS_CAN_SCALE;
MACRO_ERRNO VCAPS_DST_CAN_CLIP;
MACRO_ERRNO VCAPS_OVERLAY;
MACRO_ERRNO VCAPS_SRC_CAN_CLIP;
...
MACRO_VFT VFT_VXD;
MACRO_ERRNO VHDR_DONE;
MACRO_ERRNO VHDR_INQUEUE;
MACRO_ERRNO VHDR_KEYFRAME;
MACRO_ERRNO VHDR_PREPARED;
DWORD __pascal __far VIDEOCLOSE(HVIDEO hVideo);
DWORD __pascal __far VIDEOCONFIGURE(HVIDEO hVideo, UINT msg, DWORD dwFlags, LPDWORD lpdwReturn, LPVOID lpData1, DWORD dwSize1, LPVOID lpData2, DWORD dwSize2);
DWORD __pascal __far VIDEOCONFIGURESTORAGEA(HVIDEO hVideo, LPSTR lpstrIdent, DWORD dwFlags);
DWORD __pascal __far VIDEOCONFIGURESTORAGEW(HVIDEO hVideo, LPWSTR lpstrIdent, DWORD dwFlags);
DWORD __pascal __far VIDEODIALOG(HVIDEO hVideo, HWND hWndParent, DWORD dwFlags);
DWORD __pascal __far VIDEOFORWINDOWSVERSION();
DWORD __pascal __far VIDEOFRAME(HVIDEO hVideo, LPVIDEOHDR lpVHdr);
DWORD __pascal __far VIDEOGETCHANNELCAPS(HVIDEO hVideo, LPCHANNEL_CAPS lpChannelCaps, DWORD dwSize);
DWORD __pascal __far VIDEOGETERRORTEXTA(HVIDEO hVideo, UINT wError, LPSTR lpText, UINT wSize);
DWORD __pascal __far VIDEOGETERRORTEXTW(HVIDEO hVideo, UINT wError, LPWSTR lpText, UINT wSize);
DWORD __pascal __far VIDEOGETNUMDEVS();
DWORD __pascal __far VIDEOMESSAGE(HVIDEO hVideo, UINT msg, DWORD dwP1, DWORD dwP2);
DWORD __pascal __far VIDEOOPEN(LPHVIDEO lphVideo, DWORD dwDevice, DWORD dwFlags);
DWORD __pascal __far VIDEOSTREAMADDBUFFER(HVIDEO hVideo, LPVIDEOHDR lpVHdr, DWORD dwSize);
DWORD __pascal __far VIDEOSTREAMALLOCHDRANDBUFFER(HVIDEO hVideo, LPVIDEOHDR far *plpVHdr, DWORD dwSize);
DWORD __pascal __far VIDEOSTREAMFINI(HVIDEO hVideo);
DWORD __pascal __far VIDEOSTREAMFREEHDRANDBUFFER(HVIDEO hVideo, LPVIDEOHDR lpVHdr);
DWORD __pascal __far VIDEOSTREAMGETERROR(HVIDEO hVideo, LPDWORD lpdwErrorFirst, LPDWORD lpdwErrorLast);
DWORD __pascal __far VIDEOSTREAMGETPOSITION(HVIDEO hVideo, MMTIME far *lpInfo, DWORD dwSize);
DWORD __pascal __far VIDEOSTREAMINIT(HVIDEO hVideo, DWORD dwMicroSecPerFrame, DWORD dwCallback, DWORD dwCallbackInst, DWORD dwFlags);
DWORD __pascal __far VIDEOSTREAMPREPAREHEADER(HVIDEO hVideo, LPVIDEOHDR lpVHdr, DWORD dwSize);
DWORD __pascal __far VIDEOSTREAMRESET(HVIDEO hVideo);
DWORD __pascal __far VIDEOSTREAMSTART(HVIDEO hVideo);
DWORD __pascal __far VIDEOSTREAMSTOP(HVIDEO hVideo);
DWORD __pascal __far VIDEOSTREAMUNPREPAREHEADER(HVIDEO hVideo, LPVIDEOHDR lpVHdr, DWORD dwSize);
DWORD __pascal __far VIDEOUPDATE(HVIDEO hVideo, HWND hWnd, HDC hDC);
MACRO_ERRNO VIDEO_CONFIGURE_CURRENT;
MACRO_ERRNO VIDEO_CONFIGURE_GET;
MACRO_ERRNO VIDEO_CONFIGURE_MAX;
MACRO_ERRNO VIDEO_CONFIGURE_MIN;
MACRO_ERRNO VIDEO_CONFIGURE_NOMINAL;
MACRO_ERRNO VIDEO_CONFIGURE_QUERY;
MACRO_ERRNO VIDEO_CONFIGURE_QUERYSIZE;
MACRO_ERRNO VIDEO_CONFIGURE_SET;
MACRO_ERRNO VIDEO_DLG_QUERY;
MACRO_ERRNO VIDEO_EXTERNALIN;
MACRO_ERRNO VIDEO_EXTERNALOUT;
MACRO_ERRNO VIDEO_IN;
MACRO_ERRNO VIDEO_OUT;
...
MACRO_VK VK_TAB;
MACRO_VK VK_UP;
MACRO_VNSPROTO VNSPROTO_IPC;
MACRO_VNSPROTO VNSPROTO_RELIABLE_IPC;
MACRO_VNSPROTO VNSPROTO_SPP;
MACRO_VOS VOS_DOS;
...
MACRO_ERRNO WAVECAPS_DIRECTSOUND;
MACRO_ERRNO WAVECAPS_LRVOLUME;
MACRO_ERRNO WAVECAPS_PITCH;
MACRO_ERRNO WAVECAPS_PLAYBACKRATE;
MACRO_ERRNO WAVECAPS_SAMPLEACCURATE;
MACRO_ERRNO WAVECAPS_SYNC;
MACRO_ERRNO WAVECAPS_VOLUME;
MMRESULT __pascal __far WAVEINADDBUFFER(HWAVEIN hwi, LPWAVEHDR pwh, UINT cbwh);
MMRESULT __pascal __far WAVEINCLOSE(HWAVEIN hwi);
MMRESULT __pascal __far WAVEINGETDEVCAPS(UINT uDeviceID, LPWAVEINCAPS pwic, UINT cbwic);
MMRESULT __pascal __far WAVEINGETERRORTEXT(MMRESULT mmrError, LPSTR pszText, UINT cchText);
MMRESULT __pascal __far WAVEINGETID(HWAVEIN hwi, LPUINT puDeviceID);
UINT __pascal __far WAVEINGETNUMDEVS();
MMRESULT __pascal __far WAVEINGETPOSITION(HWAVEIN hwi, LPMMTIME pmmt, UINT cbmmt);
DWORD __pascal __far WAVEINMESSAGE(HWAVEIN hwi, UINT uMsg, DWORD dw1, DWORD dw2);
MMRESULT __pascal __far WAVEINOPEN(LPHWAVEIN phwi, UINT uDeviceID, LPCWAVEFORMATEX pwfx, DWORD dwCallback, DWORD dwInstance, DWORD fdwOpen);
MMRESULT __pascal __far WAVEINPREPAREHEADER(HWAVEIN hwi, LPWAVEHDR pwh, UINT cbwh);
MMRESULT __pascal __far WAVEINRESET(HWAVEIN hwi);
MMRESULT __pascal __far WAVEINSTART(HWAVEIN hwi);
MMRESULT __pascal __far WAVEINSTOP(HWAVEIN hwi);
MMRESULT __pascal __far WAVEINUNPREPAREHEADER(HWAVEIN hwi, LPWAVEHDR pwh, UINT cbwh);
MMRESULT __pascal __far WAVEOUTBREAKLOOP(HWAVEOUT hwo);
MMRESULT __pascal __far WAVEOUTCLOSE(HWAVEOUT hwo);
MMRESULT __pascal __far WAVEOUTGETDEVCAPS(UINT uDeviceID, LPWAVEOUTCAPS pwoc, UINT cbwoc);
MMRESULT __pascal __far WAVEOUTGETERRORTEXT(MMRESULT mmrError, LPSTR pszText, UINT cchText);
MMRESULT __pascal __far WAVEOUTGETID(HWAVEOUT hwo, LPUINT puDeviceID);
UINT __pascal __far WAVEOUTGETNUMDEVS();
MMRESULT __pascal __far WAVEOUTGETPITCH(HWAVEOUT hwo, LPDWORD pdwPitch);
MMRESULT __pascal __far WAVEOUTGETPLAYBACKRATE(HWAVEOUT hwo, LPDWORD pdwRate);
MMRESULT __pascal __far WAVEOUTGETPOSITION(HWAVEOUT hwo, LPMMTIME pmmt, UINT cbmmt);
MMRESULT __pascal __far WAVEOUTGETVOLUME(UINT uId, LPDWORD pdwVolume);
DWORD __pascal __far WAVEOUTMESSAGE(HWAVEOUT hwo, UINT uMsg, DWORD dw1, DWORD dw2);
MMRESULT __pascal __far WAVEOUTOPEN(LPHWAVEOUT phwo, UINT uDeviceID, LPCWAVEFORMATEX pwfx, DWORD dwCallback, DWORD dwInstance, DWORD fdwOpen);
MMRESULT __pascal __far WAVEOUTPAUSE(HWAVEOUT hwo);
MMRESULT __pascal __far WAVEOUTPREPAREHEADER(HWAVEOUT hwo, LPWAVEHDR pwh, UINT cbwh);
MMRESULT __pascal __far WAVEOUTRESET(HWAVEOUT hwo);
MMRESULT __pascal __far WAVEOUTRESTART(HWAVEOUT hwo);
MMRESULT __pascal __far WAVEOUTSETPITCH(HWAVEOUT hwo, DWORD dwPitch);
MMRESULT __pascal __far WAVEOUTSETPLAYBACKRATE(HWAVEOUT hwo, DWORD dwRate);
MMRESULT __pascal __far WAVEOUTSETVOLUME(UINT uId, DWORD dwVolume);
MMRESULT __pascal __far WAVEOUTUNPREPAREHEADER(HWAVEOUT hwo, LPWAVEHDR pwh, UINT cbwh);
MMRESULT __pascal __far WAVEOUTWRITE(HWAVEOUT hwo, LPWAVEHDR pwh, UINT cbwh);
MACRO_ERRNO WAVERR_BADFORMAT;
MACRO_ERRNO WAVERR_BASE;
MACRO_ERRNO WAVERR_LASTERROR;
MACRO_ERRNO WAVERR_STILLPLAYING;
MACRO_ERRNO WAVERR_SYNC;
MACRO_ERRNO WAVERR_UNPREPARED;
MACRO_ERRNO WAVE_ALLOWSYNC;
MACRO_ERRNO WAVE_FORMAT_1M08;
MACRO_ERRNO WAVE_FORMAT_1M16;
MACRO_ERRNO WAVE_FORMAT_1S08;
MACRO_ERRNO WAVE_FORMAT_1S16;
MACRO_ERRNO WAVE_FORMAT_2M08;
MACRO_ERRNO WAVE_FORMAT_2M16;
MACRO_ERRNO WAVE_FORMAT_2S08;
MACRO_ERRNO WAVE_FORMAT_2S16;
MACRO_ERRNO WAVE_FORMAT_4M08;
MACRO_ERRNO WAVE_FORMAT_4M16;
MACRO_ERRNO WAVE_FORMAT_4S08;
MACRO_ERRNO WAVE_FORMAT_4S16;
MACRO_ERRNO WAVE_FORMAT_PCM;
MACRO_ERRNO WAVE_FORMAT_QUERY;
MACRO_ERRNO WAVE_INVALIDFORMAT;
MACRO_ERRNO WAVE_MAPPER;
MACRO_WA WA_ACTIVE;
...
MACRO_WF WF_WIN386;
MACRO_WF WF_WLO;
MACRO_ERRNO WHDR_BEGINLOOP;
MACRO_ERRNO WHDR_DONE;
MACRO_ERRNO WHDR_ENDLOOP;
MACRO_ERRNO WHDR_INQUEUE;
MACRO_ERRNO WHDR_PREPARED;
COLORS WHITE;
...
MACRO_ERRNO WIM_CLOSE;
MACRO_ERRNO WIM_DATA;
MACRO_ERRNO WIM_OPEN;
MACRO_ALTERNATE WINDING;
HWND __pascal __far WINDOWFROMPOINT(POINT);
UINT __pascal __far WINEXEC(LPCSTR, UINT);
BOOL __pascal __far WINGBITBLT(HDC hdcDest, int nXOriginDest, int nYOriginDest, int nWidthDest, int nHeightDest, HDC hdcSrc, int nXOriginSrc, int nYOriginSrc);
HBITMAP __pascal __far WINGCREATEBITMAP(HDC WinGDC, const BITMAPINFO far *pHeader, void far * far *ppBits);
HDC __pascal __far WINGCREATEDC();
HBRUSH __pascal __far WINGCREATEHALFTONEBRUSH(HDC Context, COLORREF crColor, WING_DITHER_TYPE DitherType);
HPALETTE __pascal __far WINGCREATEHALFTONEPALETTE();
UINT __pascal __far WINGGETDIBCOLORTABLE(HDC WinGDC, UINT StartIndex, UINT NumberOfEntries, RGBQUAD far *pColors);
void far *__pascal __far WINGGETDIBPOINTER(HBITMAP WinGBitmap, BITMAPINFO far *pHeader);
BOOL __pascal __far WINGRECOMMENDDIBFORMAT(BITMAPINFO far *pFormat);
UINT __pascal __far WINGSETDIBCOLORTABLE(HDC WinGDC, UINT StartIndex, UINT NumberOfEntries, const RGBQUAD far *pColors);
BOOL __pascal __far WINGSTRETCHBLT(HDC hdcDest, int nXOriginDest, int nYOriginDest, int nWidthDest, int nHeightDest, HDC hdcSrc, int nXOriginSrc, int nYOriginSrc, int nWidthSrc, int nHeightSrc);
WING_DITHER_TYPE WING_CLUSTERED_4x4;
WING_DITHER_TYPE WING_DISPERSED_4x4;
WING_DITHER_TYPE WING_DISPERSED_8x8;
BOOL __pascal __far WINHELP(HWND hwndMain, LPCSTR lpszHelp, UINT usCommand, DWORD ulData);
int __pascal WINMAIN(HANDLE, HANDLE, LPSTR, int);
MACRO_WINVER WINVER;
...
MACRO_WM_CTLCOLORMSGBOX WM_CTLCOLORBTN;
MACRO_WM_CTLCOLORMSGBOX WM_CTLCOLORDLG;
MACRO_WM_CTLCOLORMSGBOX WM_CTLCOLOREDIT;
MACRO_WM_CTLCOLORMSGBOX WM_CTLCOLORLISTBOX;
MACRO_WM_CTLCOLORMSGBOX WM_CTLCOLORMSGBOX;
MACRO_WM_CTLCOLORMSGBOX WM_CTLCOLORSCROLLBAR;
MACRO_WM_CTLCOLORMSGBOX WM_CTLCOLORSTATIC;
MACRO_WM_CUT WM_CUT;
...
MACRO_WM_DLGBORDER WM_DLGBORDER;
MACRO_WM_DLGSUBCLASS WM_DLGSUBCLASS;
...
MACRO_ERRNO WOM_CLOSE;
MACRO_ERRNO WOM_DONE;
MACRO_ERRNO WOM_OPEN;
...
const GUID CLSID_AmiProDocument;
const GUID CLSID_BibRef;
const GUID CLSID_CDraw;
const GUID CLSID_CShow;
const GUID CLSID_CharPres_30;
const GUID CLSID_Charisma;
const GUID CLSID_Charisma_30;
const GUID CLSID_ClTest;
const GUID CLSID_CorelChart;
const GUID CLSID_CoromandelIntegra;
const GUID CLSID_CoromandelObjServer;
const GUID CLSID_DGraphCHART;
const GUID CLSID_DGraphDATA;
const GUID CLSID_Designer_40;
const GUID CLSID_Draw;
const GUID CLSID_Equation;
const GUID CLSID_ExcelChart;
const GUID CLSID_ExcelMacrosheet;
const GUID CLSID_ExcelWorksheet;
const GUID CLSID_FYI;
const GUID CLSID_FYIView;
const GUID CLSID_HJWIN1_0;
const GUID CLSID_HierarchyList;
const GUID CLSID_ImportServer;
const GUID CLSID_MPlayer;
const GUID CLSID_MSDraw;
const GUID CLSID_MSGraph;
const GUID CLSID_MSPowerPoint;
const GUID CLSID_MSPowerPointSho;
const GUID CLSID_MSProject;
const GUID CLSID_MSWorksChart;
const GUID CLSID_MSWorksSpreadsheet;
const GUID CLSID_MS_ClipArt_Gallery;
const GUID CLSID_MinSvr;
const GUID CLSID_MinSvrMI;
const GUID CLSID_Note_It;
const GUID CLSID_ObjMakerOLE;
const GUID CLSID_OleDemo;
const GUID CLSID_PBrush;
const GUID CLSID_Package;
const GUID CLSID_PhotoPaint;
const GUID CLSID_Picture_Dib;
const GUID CLSID_Picture_Metafile;
const GUID CLSID_ServerDemo;
const GUID CLSID_ShapewareVISIO10;
const GUID CLSID_SoundRec;
const GUID CLSID_SrtInv;
const GUID CLSID_Srtest;
const GUID CLSID_SrvrTest;
const GUID CLSID_StanfordGraphics;
const GUID CLSID_StdMarshal;
const GUID CLSID_Stickynote;
const GUID CLSID_TestServ;
const GUID CLSID_WPCharts;
const GUID CLSID_WPGraphics;
const GUID CLSID_WordArt;
const GUID CLSID_WordDocument;
DWORD __far CallProcEx32W(DWORD, DWORD, DWORD, ...);
void __cdecl DBGMEM_CheckMemFn(void *pmalloc, int fReportOrphans);
void *__cdecl DBGMEM_EncapsulateFn(void *pmalloc, char *pszSubsys, int fCheckOften);
void __cdecl DBGMEM_NoLeakDetectFn(void *pmalloc, void *pv);
void __cdecl DBGMEM_SetFailureAtFn(void *pmalloc, ULONG ulFailureAt);
void __cdecl DBGMEM_ShutdownFn(void *pmalloc);
void __far DEBUGOUTPUT(UINT flags, LPCSTR lpsz, ...);
int DebugTraceFn(char *pszFormat, ...);
void __cdecl DebugTraceProblemsFn(char *sz, void *rgprob);
int DebugTrapFn(int fFatal, char *pszFile, int iLine, char *pszFormat, ...);
...
const GUID PS_EXCHFORM;
MACRO__NOCURSOR _SOLIDCURSOR;
SCODE __cdecl ScCheckScFn(SCODE, SCODE *, char *, char *, int);
SCODE __cdecl ScodeFromSzFn(char *psz);
char *__cdecl SzDecodeScodeFn(SCODE sc);
char *__cdecl SzDecodeUlPropTagFn(unsigned __int32 ulPropTag);
char *__cdecl SzDecodeUlPropTypeFn(unsigned __int32 ulPropType);
MACRO__FREEENTRY _USEDENTRY;
unsigned __int32 __cdecl UlPropTagFromSzFn(char *psz);
void *__cdecl VMAlloc(ULONG);
void *__cdecl VMAllocEx(ULONG, ULONG);
void __cdecl VMFree(void *);
void __cdecl VMFreeEx(void *, ULONG);
ULONG __cdecl VMGetSize(void *);
ULONG __cdecl VMGetSizeEx(void *, ULONG);
void *__cdecl VMRealloc(void *, ULONG);
void *__cdecl VMReallocEx(void *, ULONG, ULONG);
...
MACRO_ERRNO chOpMapByClient;
MACRO_ERRNO chOpMapByForm;
MACRO_ERRNO chOpMapDisable;
MACRO_chx1 chx1;
MACRO_chx10 chx10;
MACRO_chx11 chx11;
MACRO_chx12 chx12;
...
MACRO_ERRNO ichOpMapForward;
MACRO_ERRNO ichOpMapOpen;
MACRO_ERRNO ichOpMapPrint;
MACRO_ERRNO ichOpMapReplyToAll;
MACRO_ERRNO ichOpMapReplyToFolder;
MACRO_ERRNO ichOpMapReplyToSender;
MACRO_ERRNO ichOpMapReservedCompose;
MACRO_ERRNO ichOpMapReservedDelivery;
MACRO_ERRNO ichOpMapSaveAs;
MACRO_ico1 ico1;
MACRO_ico2 ico2;
MACRO_ico3 ico3;
MACRO_ico4 ico4;
MACRO_ERRNO lidOpMap;
MACRO_lst1 lst1;
MACRO_lst10 lst10;
MACRO_lst11 lst11;
MACRO_lst12 lst12;
