...
enum MACRO_SIDD {SIDD_UBYTE_OPS = 0x0,SIDD_UWORD_OPS = 0x1,SIDD_SBYTE_OPS = 0x2,SIDD_SWORD_OPS = 0x3,SIDD_CMP_EQUAL_ANY = 0x0,SIDD_CMP_RANGES = 0x4,SIDD_CMP_EQUAL_EACH = 0x8,SIDD_CMP_EQUAL_ORDERED = 0xC,SIDD_POSITIVE_POLARITY = 0x0,SIDD_NEGATIVE_POLARITY = 0x10,SIDD_MASKED_POSITIVE_POLARITY = 0x20,SIDD_MASKED_NEGATIVE_POLARITY = 0x30,SIDD_LEAST_SIGNIFICANT = 0x0,SIDD_MOST_SIGNIFICANT = 0x40,SIDD_BIT_MASK = 0x0,SIDD_UNIT_MASK = 0x40,};
...
enum MACRO__CPPLIB {_CPPLIB_VER = 503,};
...
enum MACRO__CRTWRN {_CRTWRN_WNUMBER__VCCLRIT_DEPRECATED = 1001,_CRTWRN_WNUMBER__EXPLICIT_KEYWORD = 1002,_CRTWRN_WNUMBER__NO_32BIT_TIME_T = 1003,_CRTWRN_WNUMBER__NO_SPECIAL_TRANSFER = 1004,_CRTWRN_WNUMBER__NO_ITERATOR_DEBUGGING = 1005,_CRTWRN_WNUMBER__CLR_AND_STATIC_CPPLIB = 1006,};
...
enum MACRO__HAS {_HAS_EXCEPTIONS = 1,_HAS_NAMESPACE = 1,_HAS_IMMUTABLE_SETS = 0,_HAS_STRICT_CONFORMANCE = 0,_HAS_TRADITIONAL_STL = 0,};
...
enum MACRO__MM_DENORMALS {_MM_DENORMALS_ZERO_MASK = 0x40,_MM_DENORMALS_ZERO_ON = 0x40,_MM_DENORMALS_ZERO_OFF = 0x0,};
enum MACRO__MM_FROUND {_MM_FROUND_TO_NEAREST_INT = 0x0,_MM_FROUND_TO_NEG_INF = 0x1,_MM_FROUND_TO_POS_INF = 0x2,_MM_FROUND_TO_ZERO = 0x3,_MM_FROUND_CUR_DIRECTION = 0x4,_MM_FROUND_RAISE_EXC = 0x0,_MM_FROUND_NO_EXC = 0x8,_MM_FROUND_NINT = 0x0,_MM_FROUND_FLOOR = 0x1,_MM_FROUND_CEIL = 0x2,_MM_FROUND_TRUNC = 0x3,_MM_FROUND_RINT = 0x4,_MM_FROUND_NEARBYINT = 0xC,};
...
enum MACRO__SECURE {_SECURE_SCL = 1,_SECURE_SCL_DEPRECATE = 1,_SECURE_SCL_THROWS = 0,};
...
enum MACRO__USE {_USE_DECLSPECS_FOR_SAL = 0,};
enum MACRO__USE_ATTRIBUTES {_USE_ATTRIBUTES_FOR_SAL = 0,};
enum MACRO__VC6SP2 {_VC6SP2 = 0,};
...
MACRO_SH SH_DENYRW;
MACRO_SH SH_DENYWR;
MACRO_SIDD SIDD_BIT_MASK;
MACRO_SIDD SIDD_CMP_EQUAL_ANY;
MACRO_SIDD SIDD_CMP_EQUAL_EACH;
MACRO_SIDD SIDD_CMP_EQUAL_ORDERED;
MACRO_SIDD SIDD_CMP_RANGES;
MACRO_SIDD SIDD_LEAST_SIGNIFICANT;
MACRO_SIDD SIDD_MASKED_NEGATIVE_POLARITY;
MACRO_SIDD SIDD_MASKED_POSITIVE_POLARITY;
MACRO_SIDD SIDD_MOST_SIGNIFICANT;
MACRO_SIDD SIDD_NEGATIVE_POLARITY;
MACRO_SIDD SIDD_POSITIVE_POLARITY;
MACRO_SIDD SIDD_SBYTE_OPS;
MACRO_SIDD SIDD_SWORD_OPS;
MACRO_SIDD SIDD_UBYTE_OPS;
MACRO_SIDD SIDD_UNIT_MASK;
MACRO_SIDD SIDD_UWORD_OPS;
...
MACRO__CRTWRN _CRTWRN_WNUMBER__EXPLICIT_KEYWORD;
MACRO__CRTWRN _CRTWRN_WNUMBER__NO_32BIT_TIME_T;
MACRO__CRTWRN _CRTWRN_WNUMBER__NO_ITERATOR_DEBUGGING;
...
MACRO__HAS _HAS_EXCEPTIONS;
MACRO__HAS HAS_IMMUTABLE_SETS;
MACRO__HAS_ITERATOR HAS_ITERATOR_DEBUGGING;
MACRO__HAS _HAS_NAMESPACE;
MACRO__HAS HAS_STRICT_CONFORMANCE;
MACRO__HAS HAS_TRADITIONAL_STL;
...
MACRO__MM_FROUND _MM_FROUND_CEIL;
MACRO__MM_FROUND _MM_FROUND_CUR_DIRECTION;
MACRO__MM_FROUND _MM_FROUND_FLOOR;
MACRO__MM_FROUND _MM_FROUND_NEARBYINT;
MACRO__MM_FROUND MM_FROUND_NINT;
MACRO__MM_FROUND _MM_FROUND_NO_EXC;
MACRO__MM_FROUND MM_FROUND_RAISE_EXC;
MACRO__MM_FROUND _MM_FROUND_RINT;
MACRO__MM_FROUND MM_FROUND_TO_NEAREST_INT;
MACRO__MM_FROUND _MM_FROUND_TO_NEG_INF;
MACRO__MM_FROUND _MM_FROUND_TO_POS_INF;
MACRO__MM_FROUND _MM_FROUND_TO_ZERO;
MACRO__MM_FROUND _MM_FROUND_TRUNC;
...
MACRO__SECURE _SECURE_SCL;
MACRO__SECURE _SECURE_SCL_DEPRECATE;
MACRO__SECURE SECURE_SCL_THROWS;
...
MACRO__USE_ATTRIBUTES USE_ATTRIBUTES_FOR_SAL;
MACRO__USE USE_DECLSPECS_FOR_SAL;
MACRO__VC6SP2 VC6SP2;
...
errno_t __cdecl _get_amblksiz(size_t *Value);
...
void _mm_monitor(const void *, unsigned int, unsigned int);
...
errno_t __cdecl _set_amblksiz(size_t Value);
...
char *__cdecl strcat(char *, const char *Source);
...
char *__cdecl strcpy(char *, const char *Source);
